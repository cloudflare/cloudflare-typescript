...
- `client.zeroTrust.casb.applications.setupFlows.list()`
...
- `client.zeroTrust.dlp.sensitivityGroups.get()`
- `client.zeroTrust.dlp.sensitivityGroups.levels.create()`
- `client.zeroTrust.dlp.sensitivityGroups.levels.update()`
- `client.zeroTrust.dlp.sensitivityGroups.levels.list()`
- `client.zeroTrust.dlp.sensitivityGroups.levels.delete()`
- `client.zeroTrust.dlp.sensitivityGroups.levels.get()`
- `client.zeroTrust.dlp.sensitivityGroups.levels.order.update()`
- `client.zeroTrust.dlp.sensitivityGroups.levels.order.get()`
- `client.zeroTrust.dlp.dataTagCategories.update()`
- `client.zeroTrust.dlp.dataTagCategories.delete()`
- `client.zeroTrust.dlp.dataTagCategories.get()`
- `client.zeroTrust.dlp.dataTagCategories.dataTags.create()`
- `client.zeroTrust.dlp.dataTagCategories.dataTags.update()`
- `client.zeroTrust.dlp.dataTagCategories.dataTags.list()`
- `client.zeroTrust.dlp.dataTagCategories.dataTags.delete()`
- `client.zeroTrust.dlp.dataTagCategories.dataTags.get()`
- `client.zeroTrust.dlp.dataClasses.update()`
- `client.zeroTrust.dlp.dataClasses.delete()`
