...
export class Analytics extends APIResource {
   ...
   */
  list(params: AnalyticsListParams, options?: RequestOptions): APIPromise<Schema> {
    const { account_id, ...query } = params;
    return (
      this._client.get(path`/accounts/${account_id}/storage/analytics`, { query, ...options }) as APIPromise<{
        result: Schema;
      }>
   ...
   */
  stored(params: AnalyticsStoredParams, options?: RequestOptions): APIPromise<Components> {
    const { account_id, ...query } = params;
    return (
      this._client.get(path`/accounts/${account_id}/storage/analytics/stored`, {
        query,
        ...options,
      }) as APIPromise<{ result: Components }>
    )._thenUnwrap((obj) => obj.result);
  }
}
