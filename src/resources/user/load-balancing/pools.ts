...
export class Pools extends APIResource {
   ...
   * Create a new pool.
   */
  create(body: PoolCreateParams, options?: Core.RequestOptions): Core.APIPromise<PoolsAPI.Pool> {
    return (
      this._client.post('/user/load_balancers/pools', { body, ...options }) as Core.APIPromise<{
        result: PoolsAPI.Pool;
      }>
  ...
  list(
    ...
    options?: Core.RequestOptions,
  ): Core.PagePromise<PoolsSinglePage, PoolsAPI.Pool>;
  list(options?: Core.RequestOptions): Core.PagePromise<PoolsSinglePage, PoolsAPI.Pool>;
  list(
   ...
   */
  edit(poolId: string, body: PoolEditParams, options?: Core.RequestOptions): Core.APIPromise<PoolsAPI.Pool> {
    return (
   ...
   */
  get(poolId: string, options?: Core.RequestOptions): Core.APIPromise<PoolsAPI.Pool> {
    return (
