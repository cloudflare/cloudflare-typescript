...
import * as HoldAPI from 'cloudflare/resources/hold';
...
export class Hold extends APIResource {
  ...
  retrieve(zoneId: string, options?: Core.RequestOptions): Core.APIPromise<HoldRetrieveResponse> {
    return (
      this._client.get(`/zones/${zoneId}/hold`, options) as Core.APIPromise<{ result: HoldRetrieveResponse }>
...
export namespace Hold {
  export import HoldRetrieveResponse = HoldAPI.HoldRetrieveResponse;
