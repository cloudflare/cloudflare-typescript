...
export class Spoof extends APIResource {
  ...
  get(
    ...
    query: SpoofGetParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<SpoofGetResponse> {
    return (
      this._client.get(path`/radar/email/security/top/tlds/spoof/${spoof}`, {
        query,
        ...options,
      }) as APIPromise<{ result: SpoofGetResponse }>
