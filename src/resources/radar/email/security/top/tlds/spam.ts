...
export class Spam extends APIResource {
  ...
  get(
    spam: 'SPAM' | 'NOT_SPAM',
    query: SpamGetParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<SpamGetResponse> {
    return (
      this._client.get(path`/radar/email/security/top/tlds/spam/${spam}`, {
        query,
        ...options,
      }) as APIPromise<{ result: SpamGetResponse }>
