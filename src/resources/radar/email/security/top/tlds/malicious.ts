...
export class Malicious extends APIResource {
  ...
  get(
    ...
    query: MaliciousGetParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<MaliciousGetResponse> {
    return (
      this._client.get(path`/radar/email/security/top/tlds/malicious/${malicious}`, {
        query,
        ...options,
      }) as APIPromise<{ result: MaliciousGetResponse }>
