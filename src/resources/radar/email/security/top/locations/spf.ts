...
export class SPF extends APIResource {
  ...
  ): Core.APIPromise<SPFGetResponse>;
  get(spf: 'PASS' | 'NONE' | 'FAIL', options?: Core.RequestOptions): Core.APIPromise<SPFGetResponse>;
  get(
    spf: 'PASS' | 'NONE' | 'FAIL',
    ...
    return (
      this._client.get(`/radar/email/security/top/locations/spf/${spf}`, {
        query,
        ...options,
...
export interface SPFGetResponse {
  ...
  top_0: Array<SPFGetResponse.Top0>;
}
