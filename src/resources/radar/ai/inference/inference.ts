...
export class Inference extends APIResource {
  ...
  summaryV2(
    ...
    query: InferenceSummaryV2Params | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<InferenceSummaryV2Response> {
    return (
      this._client.get(path`/radar/ai/inference/summary/${dimension}`, { query, ...options }) as APIPromise<{
  ...
  timeseriesGroupsV2(
    dimension: 'MODEL' | 'TASK',
    query: InferenceTimeseriesGroupsV2Params | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<InferenceTimeseriesGroupsV2Response> {
    return (
      this._client.get(path`/radar/ai/inference/timeseries_groups/${dimension}`, {
        query,
        ...options,
