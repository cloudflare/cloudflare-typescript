...
export class BaseMarkdownForAgents extends APIResource {
   ...
   */
  summary(
    query: MarkdownForAgentSummaryParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<MarkdownForAgentSummaryResponse> {
    return (
      this._client.get('/radar/ai/markdown_for_agents/summary', { query, ...options }) as APIPromise<{
   ...
   */
  timeseries(
    query: MarkdownForAgentTimeseriesParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<MarkdownForAgentTimeseriesResponse> {
    return (
      this._client.get('/radar/ai/markdown_for_agents/timeseries', { query, ...options }) as APIPromise<{
