...
export class Summary extends APIResource {
  ...
  summary(
    ...
    query: SummarySummaryParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<SummarySummaryResponse> {
    return (
   ...
   */
  timeseries(
    query: SummaryTimeseriesParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<SummaryTimeseriesResponse> {
    return (
  ...
  timeseriesGroups(
    dimension: 'USER_AGENT' | 'CRAWL_PURPOSE',
    query: SummaryTimeseriesGroupsParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<SummaryTimeseriesGroupsResponse> {
    return (
      this._client.get(path`/radar/ai/bots/timeseries_groups/${dimension}`, {
        query,
        ...options,
      }) as APIPromise<{ result: SummaryTimeseriesGroupsResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
}
