...
export class TimeseriesGroups extends APIResource {
  ...
  summary(
    ...
    return (
      this._client.get(path`/radar/ai/bots/summary/${dimension}`, { query, ...options }) as APIPromise<{
   ...
   */
  timeseries(
    query: TimeseriesGroupTimeseriesParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<TimeseriesGroupTimeseriesResponse> {
    return (
      this._client.get('/radar/ai/bots/timeseries', { query, ...options }) as APIPromise<{
  ...
  timeseriesGroups(
    ...
    return (
      this._client.get(path`/radar/ai/bots/timeseries_groups/${dimension}`, {
        query,
        ...options,
      }) as APIPromise<{ result: TimeseriesGroupTimeseriesGroupsResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  userAgent(
    ...
    options?: RequestOptions,
  ): APIPromise<TimeseriesGroupUserAgentResponse> {
    return (
      this._client.get('/radar/ai/bots/timeseries_groups/user_agent', { query, ...options }) as APIPromise<{
        result: TimeseriesGroupUserAgentResponse;
      }>
    )._thenUnwrap((obj) => obj.result);
  }
}
