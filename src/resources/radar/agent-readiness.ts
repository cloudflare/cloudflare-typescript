...
export class AgentReadiness extends APIResource {
  ...
  summary(
    dimension: 'CHECK',
    query: AgentReadinessSummaryParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<AgentReadinessSummaryResponse> {
    return (
      this._client.get(path`/radar/agent_readiness/summary/${dimension}`, {
        query,
        ...options,
      }) as APIPromise<{ result: AgentReadinessSummaryResponse }>
