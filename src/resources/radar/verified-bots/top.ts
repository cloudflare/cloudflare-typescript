...
export class Top extends APIResource {
  ...
  bots(query: TopBotsParams | null | undefined = {}, options?: RequestOptions): APIPromise<TopBotsResponse> {
    return (
      this._client.get('/radar/verified_bots/top/bots', { query, ...options }) as APIPromise<{
  ...
  ): APIPromise<TopCategoriesResponse> {
    return (
      this._client.get('/radar/verified_bots/top/categories', { query, ...options }) as APIPromise<{
