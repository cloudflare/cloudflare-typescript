...
export class BaseTimeseriesGroups extends APIResource {
  static override readonly _key: readonly ['radar', 'dns', 'timeseriesGroups'] = Object.freeze([
    'radar',
    'dns',
    'timeseriesGroups',
  ] as const);
  ...
  ): APIPromise<TimeseriesGroupCacheHitResponse> {
    return (
      this._client.get('/radar/dns/timeseries_groups/cache_hit', { query, ...options }) as APIPromise<{
  ...
  dnssec(
    ...
    return (
      this._client.get('/radar/dns/timeseries_groups/dnssec', { query, ...options }) as APIPromise<{
  ...
  dnssecAware(
    ...
    options?: RequestOptions,
  ): APIPromise<TimeseriesGroupDNSSECAwareResponse> {
    return (
      this._client.get('/radar/dns/timeseries_groups/dnssec_aware', { query, ...options }) as APIPromise<{
        result: TimeseriesGroupDNSSECAwareResponse;
      }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  dnssecE2E(
    ...
    options?: RequestOptions,
  ): APIPromise<TimeseriesGroupDNSSECE2EResponse> {
    return (
      this._client.get('/radar/dns/timeseries_groups/dnssec_e2e', { query, ...options }) as APIPromise<{
  ...
  ipVersion(
    ...
    return (
      this._client.get('/radar/dns/timeseries_groups/ip_version', { query, ...options }) as APIPromise<{
  ...
  matchingAnswer(
    ...
    options?: RequestOptions,
  ): APIPromise<TimeseriesGroupMatchingAnswerResponse> {
    return (
      this._client.get('/radar/dns/timeseries_groups/matching_answer', { query, ...options }) as APIPromise<{
        result: TimeseriesGroupMatchingAnswerResponse;
      }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  protocol(
    ...
    return (
      this._client.get('/radar/dns/timeseries_groups/protocol', { query, ...options }) as APIPromise<{
  ...
  queryType(
    ...
    return (
      this._client.get('/radar/dns/timeseries_groups/query_type', { query, ...options }) as APIPromise<{
  ...
  responseCode(
    ...
    options?: RequestOptions,
  ): APIPromise<TimeseriesGroupResponseCodeResponse> {
    return (
      this._client.get('/radar/dns/timeseries_groups/response_code', { query, ...options }) as APIPromise<{
        result: TimeseriesGroupResponseCodeResponse;
      }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  responseTTL(
    ...
    options?: RequestOptions,
  ): APIPromise<TimeseriesGroupResponseTTLResponse> {
    return (
      this._client.get('/radar/dns/timeseries_groups/response_ttl', { query, ...options }) as APIPromise<{
        result: TimeseriesGroupResponseTTLResponse;
      }>
    )._thenUnwrap((obj) => obj.result);
  }
}
