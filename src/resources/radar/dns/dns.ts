...
export class DNS extends APIResource {
  ...
  summaryV2(
    dimension:
      ...
      | 'TLD'
      | 'TLD_DNS_MAGNITUDE',
    query: DNSSummaryV2Params | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<DNSSummaryV2Response> {
    return (
      this._client.get(path`/radar/dns/summary/${dimension}`, { query, ...options }) as APIPromise<{
   ...
   */
  timeseries(
    query: DNSTimeseriesParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<DNSTimeseriesResponse> {
    return (
      this._client.get('/radar/dns/timeseries', { query, ...options }) as APIPromise<{
  ...
  timeseriesGroupsV2(
    dimension:
      ...
      | 'RESPONSE_TTL'
      | 'TLD',
    query: DNSTimeseriesGroupsV2Params | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<DNSTimeseriesGroupsV2Response> {
    return (
      this._client.get(path`/radar/dns/timeseries_groups/${dimension}`, { query, ...options }) as APIPromise<{
        result: DNSTimeseriesGroupsV2Response;
      }>
    )._thenUnwrap((obj) => obj.result);
  }
}
