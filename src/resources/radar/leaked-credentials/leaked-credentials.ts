...
export class LeakedCredentials extends APIResource {
  ...
  summaryV2(
    ...
    query: LeakedCredentialSummaryV2Params | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<LeakedCredentialSummaryV2Response> {
    return (
      this._client.get(path`/radar/leaked_credential_checks/summary/${dimension}`, {
        query,
        ...options,
      }) as APIPromise<{ result: LeakedCredentialSummaryV2Response }>
  ...
  timeseriesGroupsV2(
    dimension: 'COMPROMISED' | 'BOT_CLASS',
    query: LeakedCredentialTimeseriesGroupsV2Params | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<LeakedCredentialTimeseriesGroupsV2Response> {
    return (
      this._client.get(path`/radar/leaked_credential_checks/timeseries_groups/${dimension}`, {
        query,
        ...options,
