...
export class HTTPProtocol extends APIResource {
  ...
  get(httpProtocol: 'HTTP' | 'HTTPS', query: HTTPProtocolGetParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<HTTPProtocolGetResponse> {
    ...
    return (this._client.get(`/radar/http/top/ases/http_protocol/${httpProtocol}`, { query, ...options }) as Core.APIPromise<{ result: HTTPProtocolGetResponse }>)._thenUnwrap((obj) => obj.result);
  }
}
