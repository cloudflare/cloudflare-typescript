...
export class HTTPMethod extends APIResource {
  ...
  get(httpVersion: 'HTTPv1' | 'HTTPv2' | 'HTTPv3', query: HTTPMethodGetParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<HTTPMethodGetResponse> {
    ...
    return (this._client.get(`/radar/http/top/locations/http_version/${httpVersion}`, { query, ...options }) as Core.APIPromise<{ result: HTTPMethodGetResponse }>)._thenUnwrap((obj) => obj.result);
  }
}
