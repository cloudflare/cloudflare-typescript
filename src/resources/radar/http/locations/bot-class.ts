...
export class BotClass extends APIResource {
  ...
  get(
    ...
    query: BotClassGetParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<BotClassGetResponse> {
    return (
      this._client.get(path`/radar/http/top/locations/bot_class/${botClass}`, {
        query,
        ...options,
      }) as APIPromise<{ result: BotClassGetResponse }>
