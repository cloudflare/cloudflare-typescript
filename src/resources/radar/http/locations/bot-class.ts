...
export class BotClass extends APIResource {
  ...
  get(botClass: 'LIKELY_AUTOMATED' | 'LIKELY_HUMAN', query: BotClassGetParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<BotClassGetResponse> {
    ...
    return (this._client.get(`/radar/http/top/locations/bot_class/${botClass}`, { query, ...options }) as Core.APIPromise<{ result: BotClassGetResponse }>)._thenUnwrap((obj) => obj.result);
  }
}
