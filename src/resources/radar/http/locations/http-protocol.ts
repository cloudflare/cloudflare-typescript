...
export class HTTPProtocol extends APIResource {
  ...
  get(
    ...
    query: HTTPProtocolGetParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<HTTPProtocolGetResponse> {
    return (
      this._client.get(path`/radar/http/top/locations/http_protocol/${httpProtocol}`, {
        query,
        ...options,
      }) as APIPromise<{ result: HTTPProtocolGetResponse }>
