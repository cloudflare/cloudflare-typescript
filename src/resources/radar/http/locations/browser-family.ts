...
export class BrowserFamily extends APIResource {
  ...
  get(
    ...
    query: BrowserFamilyGetParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<BrowserFamilyGetResponse> {
    return (
      this._client.get(path`/radar/http/top/locations/browser_family/${browserFamily}`, {
        query,
        ...options,
      }) as APIPromise<{ result: BrowserFamilyGetResponse }>
