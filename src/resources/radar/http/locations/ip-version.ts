...
export class IPVersion extends APIResource {
  ...
  get(ipVersion: 'IPv4' | 'IPv6', query: IPVersionGetParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<IPVersionGetResponse> {
    ...
    return (this._client.get(`/radar/http/top/locations/ip_version/${ipVersion}`, { query, ...options }) as Core.APIPromise<{ result: IPVersionGetResponse }>)._thenUnwrap((obj) => obj.result);
  }
}
