...
export class IPVersion extends APIResource {
  ...
  get(
    ipVersion: 'IPv4' | 'IPv6',
    query: IPVersionGetParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<IPVersionGetResponse> {
    return (
      this._client.get(path`/radar/http/top/locations/ip_version/${ipVersion}`, {
        query,
        ...options,
      }) as APIPromise<{ result: IPVersionGetResponse }>
