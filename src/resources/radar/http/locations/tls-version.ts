...
export class TLSVersion extends APIResource {
  ...
  get(
    ...
    query: TLSVersionGetParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<TLSVersionGetResponse> {
    return (
      this._client.get(path`/radar/http/top/locations/tls_version/${tlsVersion}`, {
        query,
        ...options,
      }) as APIPromise<{ result: TLSVersionGetResponse }>
