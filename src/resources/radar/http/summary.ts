...
export class Summary extends APIResource {
  ...
  botClass(query: SummaryBotClassParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<SummaryBotClassResponse> {
    if (isRequestOptions(query)) {
      return this.botClass({}, query);
    }
    return (this._client.get('/radar/http/summary/bot_class', { query, ...options }) as Core.APIPromise<{ result: SummaryBotClassResponse }>)._thenUnwrap((obj) => obj.result);
  }
  ...
  deviceType(query: SummaryDeviceTypeParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<SummaryDeviceTypeResponse> {
    if (isRequestOptions(query)) {
      return this.deviceType({}, query);
    }
    return (this._client.get('/radar/http/summary/device_type', { query, ...options }) as Core.APIPromise<{ result: SummaryDeviceTypeResponse }>)._thenUnwrap((obj) => obj.result);
  }
  ...
  httpProtocol(query: SummaryHTTPProtocolParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<SummaryHTTPProtocolResponse> {
    if (isRequestOptions(query)) {
      return this.httpProtocol({}, query);
    }
    return (this._client.get('/radar/http/summary/http_protocol', { query, ...options }) as Core.APIPromise<{ result: SummaryHTTPProtocolResponse }>)._thenUnwrap((obj) => obj.result);
  }
  ...
  httpVersion(query: SummaryHTTPVersionParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<SummaryHTTPVersionResponse> {
    ...
    return (this._client.get('/radar/http/summary/http_version', { query, ...options }) as Core.APIPromise<{ result: SummaryHTTPVersionResponse }>)._thenUnwrap((obj) => obj.result);
  }
  ...
  ipVersion(query: SummaryIPVersionParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<SummaryIPVersionResponse> {
    ...
    return (this._client.get('/radar/http/summary/ip_version', { query, ...options }) as Core.APIPromise<{ result: SummaryIPVersionResponse }>)._thenUnwrap((obj) => obj.result);
  }
  ...
  os(query: SummaryOSParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<SummaryOSResponse> {
    if (isRequestOptions(query)) {
      return this.os({}, query);
    }
    return (this._client.get('/radar/http/summary/os', { query, ...options }) as Core.APIPromise<{ result: SummaryOSResponse }>)._thenUnwrap((obj) => obj.result);
  }
  ...
  postQuantum(query: SummaryPostQuantumParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<SummaryPostQuantumResponse> {
    if (isRequestOptions(query)) {
      return this.postQuantum({}, query);
    }
    return (this._client.get('/radar/http/summary/post_quantum', { query, ...options }) as Core.APIPromise<{ result: SummaryPostQuantumResponse }>)._thenUnwrap((obj) => obj.result);
  }
  ...
  tlsVersion(query: SummaryTLSVersionParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<SummaryTLSVersionResponse> {
    ...
    return (this._client.get('/radar/http/summary/tls_version', { query, ...options }) as Core.APIPromise<{ result: SummaryTLSVersionResponse }>)._thenUnwrap((obj) => obj.result);
  }
}
