...
export class HTTP extends APIResource {
  ...
  summaryV2(
    dimension:
      ...
      | 'POST_QUANTUM'
      | 'TLS_VERSION',
    query: HTTPSummaryV2Params | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<HTTPSummaryV2Response> {
    return (
      this._client.get(path`/radar/http/summary/${dimension}`, { query, ...options }) as APIPromise<{
   ...
   */
  timeseries(
    query: HTTPTimeseriesParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<HTTPTimeseriesResponse> {
    return (
      this._client.get('/radar/http/timeseries', { query, ...options }) as APIPromise<{
  ...
  timeseriesGroupsV2(
    dimension:
      ...
      | 'POST_QUANTUM'
      | 'TLS_VERSION',
    query: HTTPTimeseriesGroupsV2Params | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<HTTPTimeseriesGroupsV2Response> {
    return (
      this._client.get(path`/radar/http/timeseries_groups/${dimension}`, {
        query,
        ...options,
