...
export class TimeseriesGroups extends APIResource {
  ...
  botClass(
    ...
    return (
      this._client.get('/radar/http/timeseries_groups/bot_class', { query, ...options }) as APIPromise<{
  ...
  browser(
    ...
    options?: RequestOptions,
  ): APIPromise<TimeseriesGroupBrowserResponse> {
    return (
      this._client.get('/radar/http/timeseries_groups/browser', { query, ...options }) as APIPromise<{
  ...
  browserFamily(
    ...
    options?: RequestOptions,
  ): APIPromise<TimeseriesGroupBrowserFamilyResponse> {
    return (
      this._client.get('/radar/http/timeseries_groups/browser_family', { query, ...options }) as APIPromise<{
        result: TimeseriesGroupBrowserFamilyResponse;
      }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  deviceType(
    ...
    options?: RequestOptions,
  ): APIPromise<TimeseriesGroupDeviceTypeResponse> {
    return (
      this._client.get('/radar/http/timeseries_groups/device_type', { query, ...options }) as APIPromise<{
        result: TimeseriesGroupDeviceTypeResponse;
      }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  httpProtocol(
    ...
    options?: RequestOptions,
  ): APIPromise<TimeseriesGroupHTTPProtocolResponse> {
    return (
      this._client.get('/radar/http/timeseries_groups/http_protocol', { query, ...options }) as APIPromise<{
        result: TimeseriesGroupHTTPProtocolResponse;
      }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  httpVersion(
    ...
    return (
      this._client.get('/radar/http/timeseries_groups/http_version', { query, ...options }) as APIPromise<{
        result: TimeseriesGroupHTTPVersionResponse;
      }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  ipVersion(
    ...
    return (
      this._client.get('/radar/http/timeseries_groups/ip_version', { query, ...options }) as APIPromise<{
  ...
  os(
    ...
    options?: RequestOptions,
  ): APIPromise<TimeseriesGroupOSResponse> {
    return (
      this._client.get('/radar/http/timeseries_groups/os', { query, ...options }) as APIPromise<{
  ...
  postQuantum(
    ...
    options?: RequestOptions,
  ): APIPromise<TimeseriesGroupPostQuantumResponse> {
    return (
      this._client.get('/radar/http/timeseries_groups/post_quantum', { query, ...options }) as APIPromise<{
        result: TimeseriesGroupPostQuantumResponse;
      }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  tlsVersion(
    ...
    return (
      this._client.get('/radar/http/timeseries_groups/tls_version', { query, ...options }) as APIPromise<{
        result: TimeseriesGroupTLSVersionResponse;
      }>
    )._thenUnwrap((obj) => obj.result);
  }
}
