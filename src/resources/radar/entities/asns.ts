...
export class BaseASNs extends APIResource {
  ...
  asSet(
    asn: number,
    query: ASNAsSetParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ASNAsSetResponse> {
    return (
      this._client.get(path`/radar/entities/asns/${asn}/as_set`, { query, ...options }) as APIPromise<{
   ...
   */
  botnetThreatFeed(
    query: ASNBotnetThreatFeedParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ASNBotnetThreatFeedResponse> {
    return (
      this._client.get('/radar/entities/asns/botnet_threat_feed', { query, ...options }) as APIPromise<{
