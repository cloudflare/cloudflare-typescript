...
export class Bots extends APIResource {
   ...
   * ```
   */
  list(query: BotListParams | null | undefined = {}, options?: RequestOptions): APIPromise<BotListResponse> {
    return (
      this._client.get('/radar/bots', { query, ...options }) as APIPromise<{ result: BotListResponse }>
  ...
  get(
    botSlug: string,
    query: BotGetParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<BotGetResponse> {
    return (
      this._client.get(path`/radar/bots/${botSlug}`, { query, ...options }) as APIPromise<{
  ...
  summary(
    ...
    return (
      this._client.get(path`/radar/bots/summary/${dimension}`, { query, ...options }) as APIPromise<{
   ...
   */
  timeseries(
    query: BotTimeseriesParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<BotTimeseriesResponse> {
    return (
      this._client.get('/radar/bots/timeseries', { query, ...options }) as APIPromise<{
  ...
  timeseriesGroups(
    ...
    return (
      this._client.get(path`/radar/bots/timeseries_groups/${dimension}`, {
        query,
        ...options,
