...
import { BasePaths, PathListParams, PathListResponse, Paths } from './paths';
import * as UpstreamsAPI from './upstreams';
import { BaseUpstreams, UpstreamTimeseriesParams, UpstreamTimeseriesResponse, Upstreams } from './upstreams';
...
export class BaseRoutes extends APIResource {
  ...
  ): APIPromise<RouteAsesResponse> {
    return (
      this._client.get('/radar/bgp/routes/ases', { query, ...options }) as APIPromise<{
  ...
  moas(
    ...
    options?: RequestOptions,
  ): APIPromise<RouteMoasResponse> {
    return (
      this._client.get('/radar/bgp/routes/moas', { query, ...options }) as APIPromise<{
  ...
  pfx2as(
    ...
    options?: RequestOptions,
  ): APIPromise<RoutePfx2asResponse> {
    return (
      this._client.get('/radar/bgp/routes/pfx2as', { query, ...options }) as APIPromise<{
  ...
  realtime(
    ...
    options?: RequestOptions,
  ): APIPromise<RouteRealtimeResponse> {
    return (
      this._client.get('/radar/bgp/routes/realtime', { query, ...options }) as APIPromise<{
  ...
  stats(
    ...
    options?: RequestOptions,
  ): APIPromise<RouteStatsResponse> {
    return (
      this._client.get('/radar/bgp/routes/stats', { query, ...options }) as APIPromise<{
...
export class Routes extends BaseRoutes {
  upstreams: UpstreamsAPI.Upstreams = new UpstreamsAPI.Upstreams(this._client);
...
Routes.Upstreams = Upstreams;
Routes.BaseUpstreams = BaseUpstreams;
Routes.Paths = Paths;
Routes.BasePaths = BasePaths;
...
export declare namespace Routes {
  ...
  export {
    ...
    BaseUpstreams as BaseUpstreams,
  ...
  export {
    Paths as Paths,
    BasePaths as BasePaths,
    type PathListResponse as PathListResponse,
    type PathListParams as PathListParams,
  };
}
