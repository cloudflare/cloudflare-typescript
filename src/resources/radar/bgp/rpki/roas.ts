...
export class BaseRoas extends APIResource {
  static override readonly _key: readonly ['radar', 'bgp', 'rpki', 'roas'] = Object.freeze([
    'radar',
    'bgp',
    'rpki',
    'roas',
   ...
   */
  timeseries(
    query: RoaTimeseriesParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<RoaTimeseriesResponse> {
    return (
      this._client.get('/radar/bgp/rpki/roas/timeseries', { query, ...options }) as APIPromise<{
        result: RoaTimeseriesResponse;
      }>
    )._thenUnwrap((obj) => obj.result);
  }
}
export class Roas extends BaseRoas {}
