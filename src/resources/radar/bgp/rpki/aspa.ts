...
export class ASPA extends APIResource {
   ...
   */
  changes(
    query: ASPAChangesParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ASPAChangesResponse> {
    return (
      this._client.get('/radar/bgp/rpki/aspa/changes', { query, ...options }) as APIPromise<{
   ...
   */
  snapshot(
    query: ASPASnapshotParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ASPASnapshotResponse> {
    return (
      this._client.get('/radar/bgp/rpki/aspa/snapshot', { query, ...options }) as APIPromise<{
   ...
   */
  timeseries(
    query: ASPATimeseriesParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ASPATimeseriesResponse> {
    return (
      this._client.get('/radar/bgp/rpki/aspa/timeseries', { query, ...options }) as APIPromise<{
