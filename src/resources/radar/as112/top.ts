...
export class Top extends APIResource {
  ...
  dnssec(dnssec: 'SUPPORTED' | 'NOT_SUPPORTED', query: TopDNSSECParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<TopDNSSECResponse> {
    if (isRequestOptions(query)) {
      return this.dnssec(dnssec, {}, query);
    }
    return (this._client.get(`/radar/as112/top/locations/dnssec/${dnssec}`, { query, ...options }) as Core.APIPromise<{ result: TopDNSSECResponse }>)._thenUnwrap((obj) => obj.result);
  }
  ...
  edns(edns: 'SUPPORTED' | 'NOT_SUPPORTED', query: TopEdnsParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<TopEdnsResponse> {
    if (isRequestOptions(query)) {
      return this.edns(edns, {}, query);
    }
    return (this._client.get(`/radar/as112/top/locations/edns/${edns}`, { query, ...options }) as Core.APIPromise<{ result: TopEdnsResponse }>)._thenUnwrap((obj) => obj.result);
  }
  ...
  ipVersion(ipVersion: 'IPv4' | 'IPv6', query: TopIPVersionParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<TopIPVersionResponse> {
    if (isRequestOptions(query)) {
      return this.ipVersion(ipVersion, {}, query);
    }
    return (this._client.get(`/radar/as112/top/locations/ip_version/${ipVersion}`, { query, ...options }) as Core.APIPromise<{ result: TopIPVersionResponse }>)._thenUnwrap((obj) => obj.result);
  }
  ...
  locations(query: TopLocationsParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<TopLocationsResponse> {
    ...
    return (this._client.get('/radar/as112/top/locations', { query, ...options }) as Core.APIPromise<{ result: TopLocationsResponse }>)._thenUnwrap((obj) => obj.result);
  }
}
