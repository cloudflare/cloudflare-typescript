...
export class Locations extends APIResource {
  ...
  origin(
    ...
    return (
      this._client.get('/radar/attacks/layer3/top/locations/origin', { query, ...options }) as APIPromise<{
  ...
  target(
    ...
    return (
      this._client.get('/radar/attacks/layer3/top/locations/target', { query, ...options }) as APIPromise<{
