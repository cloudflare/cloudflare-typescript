...
export class Top extends APIResource {
  ...
  attacks(
    ...
    return (
      this._client.get('/radar/attacks/layer3/top/attacks', { query, ...options }) as APIPromise<{
  ...
  industry(
    ...
    return (
      this._client.get('/radar/attacks/layer3/top/industry', { query, ...options }) as APIPromise<{
  ...
  vertical(
    ...
    return (
      this._client.get('/radar/attacks/layer3/top/vertical', { query, ...options }) as APIPromise<{
