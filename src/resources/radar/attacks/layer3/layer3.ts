...
export class Layer3 extends APIResource {
  ...
  summaryV2(
    ...
    query: Layer3SummaryV2Params | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<Layer3SummaryV2Response> {
    return (
      this._client.get(path`/radar/attacks/layer3/summary/${dimension}`, {
        query,
        ...options,
      }) as APIPromise<{ result: Layer3SummaryV2Response }>
   ...
   */
  timeseries(
    query: Layer3TimeseriesParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<Layer3TimeseriesResponse> {
    return (
      this._client.get('/radar/attacks/layer3/timeseries', { query, ...options }) as APIPromise<{
  ...
  timeseriesGroupsV2(
    dimension: 'PROTOCOL' | 'IP_VERSION' | 'VECTOR' | 'DURATION' | 'BITRATE' | 'VERTICAL' | 'INDUSTRY',
    query: Layer3TimeseriesGroupsV2Params | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<Layer3TimeseriesGroupsV2Response> {
    return (
      this._client.get(path`/radar/attacks/layer3/timeseries_groups/${dimension}`, {
        query,
        ...options,
