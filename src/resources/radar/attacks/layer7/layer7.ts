...
export class Layer7 extends APIResource {
  ...
  summaryV2(
    dimension:
      ...
      | 'VERTICAL'
      | 'INDUSTRY',
    query?: Layer7SummaryV2Params,
    options?: Core.RequestOptions,
  ): Core.APIPromise<Layer7SummaryV2Response>;
  summaryV2(
    dimension:
      | 'HTTP_METHOD'
      | 'HTTP_VERSION'
  ...
  summaryV2(
    dimension:
      ...
      | 'VERTICAL'
      | 'INDUSTRY',
    query: Layer7SummaryV2Params | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<Layer7SummaryV2Response> {
    ...
    return (
      this._client.get(`/radar/attacks/layer7/summary/${dimension}`, {
        query,
        ...options,
      }) as Core.APIPromise<{ result: Layer7SummaryV2Response }>
  ...
  timeseriesGroupsV2(
    dimension:
      ...
      | 'VERTICAL'
      | 'INDUSTRY',
    query?: Layer7TimeseriesGroupsV2Params,
    options?: Core.RequestOptions,
  ): Core.APIPromise<Layer7TimeseriesGroupsV2Response>;
  timeseriesGroupsV2(
    dimension:
      | 'HTTP_METHOD'
      | 'HTTP_VERSION'
  ...
  timeseriesGroupsV2(
    dimension:
      ...
      | 'VERTICAL'
      | 'INDUSTRY',
    query: Layer7TimeseriesGroupsV2Params | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<Layer7TimeseriesGroupsV2Response> {
    if (isRequestOptions(query)) {
    ...
    return (
      this._client.get(`/radar/attacks/layer7/timeseries_groups/${dimension}`, {
        query,
        ...options,
      }) as Core.APIPromise<{ result: Layer7TimeseriesGroupsV2Response }>
    )._thenUnwrap((obj) => obj.result);
  }
}
