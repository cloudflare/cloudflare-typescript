...
export class Top extends APIResource {
   ...
   */
  attacks(
    query: TopAttacksParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<TopAttacksResponse> {
    return (
      this._client.get('/radar/attacks/layer7/top/attacks', { query, ...options }) as APIPromise<{
  ...
  industry(
    ...
    options?: RequestOptions,
  ): APIPromise<TopIndustryResponse> {
    return (
      this._client.get('/radar/attacks/layer7/top/industry', { query, ...options }) as APIPromise<{
  ...
  vertical(
    ...
    options?: RequestOptions,
  ): APIPromise<TopVerticalResponse> {
    return (
      this._client.get('/radar/attacks/layer7/top/vertical', { query, ...options }) as APIPromise<{
