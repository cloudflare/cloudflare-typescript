...
export class Summary extends APIResource {
  ...
  industry(
    ...
    return (
      this._client.get('/radar/attacks/layer7/summary/industry', { query, ...options }) as APIPromise<{
  ...
  vertical(
    ...
    return (
      this._client.get('/radar/attacks/layer7/summary/vertical', { query, ...options }) as APIPromise<{
