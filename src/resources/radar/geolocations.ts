...
export class Geolocations extends APIResource {
   ...
   */
  list(
    query: GeolocationListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<GeolocationListResponse> {
    return (
      this._client.get('/radar/geolocations', { query, ...options }) as APIPromise<{
  ...
  get(
    geoID: string,
    query: GeolocationGetParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<GeolocationGetResponse> {
    return (
      this._client.get(path`/radar/geolocations/${geoID}`, { query, ...options }) as APIPromise<{
