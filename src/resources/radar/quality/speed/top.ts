...
export class Top extends APIResource {
  ...
  ases(query: TopAsesParams | null | undefined = {}, options?: RequestOptions): APIPromise<TopAsesResponse> {
    return (
      this._client.get('/radar/quality/speed/top/ases', { query, ...options }) as APIPromise<{
  ...
  locations(
    ...
    return (
      this._client.get('/radar/quality/speed/top/locations', { query, ...options }) as APIPromise<{
