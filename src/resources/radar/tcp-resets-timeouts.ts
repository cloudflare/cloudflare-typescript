...
export class TCPResetsTimeouts extends APIResource {
  ...
  ): APIPromise<TCPResetsTimeoutSummaryResponse> {
    return (
      this._client.get('/radar/tcp_resets_timeouts/summary', { query, ...options }) as APIPromise<{
  ...
  timeseriesGroups(
    ...
    options?: RequestOptions,
  ): APIPromise<TCPResetsTimeoutTimeseriesGroupsResponse> {
    return (
      this._client.get('/radar/tcp_resets_timeouts/timeseries_groups', { query, ...options }) as APIPromise<{
        result: TCPResetsTimeoutTimeseriesGroupsResponse;
      }>
    )._thenUnwrap((obj) => obj.result);
  }
}
