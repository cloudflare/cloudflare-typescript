...
export class BaseOrigin extends APIResource {
  ...
  summary(
    ...
    query: OriginSummaryParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<OriginSummaryResponse> {
    return (
      this._client.get(path`/radar/post_quantum/origin/summary/${dimension}`, {
        query,
        ...options,
      }) as APIPromise<{ result: OriginSummaryResponse }>
  ...
  timeseriesGroups(
    dimension: 'KEY_AGREEMENT',
    query: OriginTimeseriesGroupsParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<OriginTimeseriesGroupsResponse> {
    return (
      this._client.get(path`/radar/post_quantum/origin/timeseries_groups/${dimension}`, {
        query,
        ...options,
      }) as APIPromise<{ result: OriginTimeseriesGroupsResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
}
