...
export class UserAgents extends APIResource {
  ...
  ): APIPromise<UserAgentDirectiveResponse> {
    return (
      this._client.get('/radar/robots_txt/top/user_agents/directive', { query, ...options }) as APIPromise<{
        result: UserAgentDirectiveResponse;
      }>
