...
export class BaseOAuthClients extends APIResource {
   ...
   * ```
   */
  create(params: OAuthClientCreateParams, options?: RequestOptions): APIPromise<OAuthClientCreateResponse> {
    const { account_id, ...body } = params;
    return (
      this._client.post(path`/accounts/${account_id}/oauth_clients`, { body, ...options }) as APIPromise<{
  ...
  update(
    ...
    const { account_id, ...body } = params;
    return (
      this._client.patch(path`/accounts/${account_id}/oauth_clients/${oauthClientID}`, {
        body,
        ...options,
      }) as APIPromise<{ result: OAuthClientUpdateResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  list(
    ...
    options?: RequestOptions,
  ): PagePromise<OAuthClientListResponsesSinglePage, OAuthClientListResponse> {
    const { account_id } = params;
    return this._client.getAPIList(
      path`/accounts/${account_id}/oauth_clients`,
      SinglePage<OAuthClientListResponse>,
      options,
    );
  }
  ...
  delete(
    ...
    options?: RequestOptions,
  ): APIPromise<OAuthClientDeleteResponse | null> {
    const { account_id } = params;
    return (
      this._client.delete(
        path`/accounts/${account_id}/oauth_clients/${oauthClientID}`,
        options,
      ) as APIPromise<{ result: OAuthClientDeleteResponse | null }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  deleteRotatedSecret(
    ...
    options?: RequestOptions,
  ): APIPromise<OAuthClientDeleteRotatedSecretResponse | null> {
    const { account_id } = params;
    return (
      this._client.delete(
        path`/accounts/${account_id}/oauth_clients/${oauthClientID}/rotate_secret`,
        options,
      ) as APIPromise<{ result: OAuthClientDeleteRotatedSecretResponse | null }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  get(
    ...
    options?: RequestOptions,
  ): APIPromise<OAuthClientGetResponse> {
    const { account_id } = params;
    return (
      this._client.get(path`/accounts/${account_id}/oauth_clients/${oauthClientID}`, options) as APIPromise<{
  ...
  rotateSecret(
    ...
    options?: RequestOptions,
  ): APIPromise<OAuthClientRotateSecretResponse> {
    const { account_id } = params;
    return (
      this._client.post(
        path`/accounts/${account_id}/oauth_clients/${oauthClientID}/rotate_secret`,
        options,
      ) as APIPromise<{ result: OAuthClientRotateSecretResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
}
export class OAuthClients extends BaseOAuthClients {}

export type OAuthClientListResponsesSinglePage = SinglePage<OAuthClientListResponse>;
