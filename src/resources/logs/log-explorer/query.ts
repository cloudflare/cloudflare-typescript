...
export class BaseQuery extends APIResource {
  static override readonly _key: readonly ['logs', 'logExplorer', 'query'] = Object.freeze([
    'logs',
    'logExplorer',
    'query',
  ] as const);
  ...
  sql(
  ...
  ): PagePromise<QuerySqlResponsesSinglePage, QuerySqlResponse> {
    ...
    return this._client.getAPIList(
      path`/${accountOrZone}/${accountOrZoneId}/logs/explorer/query/sql`,
      SinglePage<QuerySqlResponse>,
      {
        body: body,
        method: 'post',
        ...options,
...
export type QuerySqlResponsesSinglePage = SinglePage<QuerySqlResponse>;
