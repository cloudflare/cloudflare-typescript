...
export class Settings extends APIResource {
  ...
  edit(params: SettingEditParams, options?: RequestOptions): APIPromise<SettingEditResponse> {
    ...
    return (
      this._client.patch(path`/${accountOrZone}/${accountOrZoneId}/dns_settings`, {
        body,
        ...options,
  ...
  get(
    ...
    return (
      this._client.get(path`/${accountOrZone}/${accountOrZoneId}/dns_settings`, options) as APIPromise<{
