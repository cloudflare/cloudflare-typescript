...
import * as ZskAPI from './zsk';
import { BaseZsk, Zsk, ZskListParams, ZskListResponse, ZskListResponsesSinglePage } from './zsk';
...
export class DNSSECResource extends BaseDNSSECResource {
  zsk: ZskAPI.Zsk = new ZskAPI.Zsk(this._client);
}
...
DNSSECResource.Zsk = Zsk;
DNSSECResource.BaseZsk = BaseZsk;
