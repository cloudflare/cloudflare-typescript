...
export class BaseIPSECTunnels extends APIResource {
  ...
  create(params: IPSECTunnelCreateParams, options?: RequestOptions): APIPromise<IPSECTunnelCreateResponse> {
    ...
    return (
      ...
      }) as APIPromise<{ result: IPSECTunnelCreateResponse }>
  ...
  update(
    ...
    return (
      ...
      }) as APIPromise<{ result: IPSECTunnelUpdateResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  list(params: IPSECTunnelListParams, options?: RequestOptions): APIPromise<IPSECTunnelListResponse> {
    ...
    return (
      ...
      }) as APIPromise<{ result: IPSECTunnelListResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  delete(
    ...
    return (
      ...
      }) as APIPromise<{ result: IPSECTunnelDeleteResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  bulkUpdate(
    ...
    return (
      ...
      }) as APIPromise<{ result: IPSECTunnelBulkUpdateResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  get(
    ...
    return (
      ...
      }) as APIPromise<{ result: IPSECTunnelGetResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
   ...
   * ```
   */
  pskSet(params: IPSECTunnelPSKSetParams, options?: RequestOptions): APIPromise<IPSECTunnelPSKSetResponse> {
    const { account_id, validate_only, ...body } = params;
    return (
      this._client.post(path`/accounts/${account_id}/magic/ipsec_tunnels/psk`, {
        query: { validate_only },
        body,
        ...options,
      }) as APIPromise<{ result: IPSECTunnelPSKSetResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
}
