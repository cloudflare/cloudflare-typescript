...
export type SettingGetResponse = Array<
  | SettingGetResponse.Zones0rtt
  | SettingGetResponse.ZonesAdvancedDDOS
  | SettingGetResponse.ZonesAlwaysOnline
  | SettingGetResponse.ZonesAlwaysUseHTTPS
  | SettingGetResponse.ZonesAutomaticHTTPSRewrites
  | SettingGetResponse.ZonesBrotli
  | SettingGetResponse.ZonesBrowserCacheTTL
  | SettingGetResponse.ZonesBrowserCheck
  | SettingGetResponse.ZonesCacheLevel
  | SettingGetResponse.ZonesChallengeTTL
  | SettingGetResponse.ZonesCiphers
  | SettingGetResponse.ZonesCnameFlattening
  | SettingGetResponse.ZonesDevelopmentMode
  | SettingGetResponse.ZonesEarlyHints
  | SettingGetResponse.ZonesEdgeCacheTTL
  | SettingGetResponse.ZonesEmailObfuscation
  | SettingGetResponse.ZonesH2Prioritization
  | SettingGetResponse.ZonesHotlinkProtection
  | SettingGetResponse.ZonesHTTP2
  | SettingGetResponse.ZonesHTTP3
  | SettingGetResponse.ZonesImageResizing
  | SettingGetResponse.ZonesIPGeolocation
  | SettingGetResponse.ZonesIPV6
  | SettingGetResponse.ZonesMaxUpload
  | SettingGetResponse.ZonesMinTLSVersion
  | SettingGetResponse.ZonesMinify
  | SettingGetResponse.ZonesMirage
  | SettingGetResponse.ZonesMobileRedirect
  | SettingGetResponse.ZonesNEL
  | SettingGetResponse.ZonesOpportunisticEncryption
  | SettingGetResponse.ZonesOpportunisticOnion
  | SettingGetResponse.ZonesOrangeToOrange
  | SettingGetResponse.ZonesOriginErrorPagePassThru
  | SettingGetResponse.ZonesPolish
  | SettingGetResponse.ZonesPrefetchPreload
  | SettingGetResponse.ZonesProxyReadTimeout
  | SettingGetResponse.ZonesPseudoIPV4
  | SettingGetResponse.ZonesResponseBuffering
  | SettingGetResponse.ZonesRocketLoader
  | SettingGetResponse.ZonesSchemasAutomaticPlatformOptimization
  | SettingGetResponse.ZonesSecurityHeader
  | SettingGetResponse.ZonesSecurityLevel
  | SettingGetResponse.ZonesServerSideExclude
  | SettingGetResponse.ZonesSha1Support
  | SettingGetResponse.ZonesSortQueryStringForCache
  | SettingGetResponse.ZonesSSL
  | SettingGetResponse.ZonesSSLRecommender
  | SettingGetResponse.ZonesTLS1_2Only
  | SettingGetResponse.ZonesTLS1_3
  | SettingGetResponse.ZonesTLSClientAuth
  | SettingGetResponse.ZonesTrueClientIPHeader
  | SettingGetResponse.ZonesWAF
  | SettingGetResponse.ZonesWebp
  | SettingGetResponse.ZonesWebsockets
>;
