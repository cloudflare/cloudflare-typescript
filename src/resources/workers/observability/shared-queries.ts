...
export class BaseSharedQueries extends APIResource {
  static override readonly _key: readonly ['workers', 'observability', 'sharedQueries'] = Object.freeze([
    'workers',
    'observability',
    'sharedQueries',
  ] as const);
   ...
   * ```
   */
  create(params: SharedQueryCreateParams, options?: RequestOptions): APIPromise<SharedQueryCreateResponse> {
    const { account_id, ...body } = params;
    return (
      this._client.post(path`/accounts/${account_id}/workers/observability/shared/query`, {
        body,
        ...options,
      }) as APIPromise<{ result: SharedQueryCreateResponse }>
  ...
  ): APIPromise<SharedQueryGetResponse> {
    const { account_id, ...query } = params;
    return (
      this._client.get(path`/accounts/${account_id}/workers/observability/shared/query/${id}`, {
        query,
        ...options,
      }) as APIPromise<{ result: SharedQueryGetResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
}
export class SharedQueries extends BaseSharedQueries {}
