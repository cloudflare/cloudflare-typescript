...
export class BaseTelemetry extends APIResource {
   ...
   * ```
   */
  liveTail(params: TelemetryLiveTailParams, options?: RequestOptions): APIPromise<TelemetryLiveTailResponse> {
    const { account_id, ...body } = params;
    return (
      this._client.post(path`/accounts/${account_id}/workers/observability/telemetry/live-tail`, {
        body,
        ...options,
      }) as APIPromise<{ result: TelemetryLiveTailResponse }>
  ...
  liveTailHeartbeat(
    ...
    options?: RequestOptions,
  ): APIPromise<TelemetryLiveTailHeartbeatResponse> {
    const { account_id, ...body } = params;
    return (
      this._client.post(path`/accounts/${account_id}/workers/observability/telemetry/live-tail/heartbeat`, {
        body,
        ...options,
      }) as APIPromise<{ result: TelemetryLiveTailHeartbeatResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  query(params: TelemetryQueryParams, options?: RequestOptions): APIPromise<TelemetryQueryResponse> {
    ...
    return (
      this._client.post(path`/accounts/${account_id}/workers/observability/telemetry/query`, {
        body,
        ...options,
      }) as APIPromise<{ result: TelemetryQueryResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
...
export type TelemetryValuesResponsesSinglePage = SinglePage<TelemetryValuesResponse>;
...
export interface TelemetryQueryResponse {
   ...
   * 'distribution'.
   */
  distribution?: TelemetryQueryResponse.Distribution;
