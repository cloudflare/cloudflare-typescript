...
export interface QueryCreateResponse {
   ...
   */
  statistics: QueryCreateResponse.Statistics;

  calculations?: Array<QueryCreateResponse.Calculation>;

  compare?: Array<QueryCreateResponse.Compare>;

  events?: QueryCreateResponse.Events;

  invocations?: Record<string, Array<QueryCreateResponse.Invocation>>;

  patterns?: Array<QueryCreateResponse.Pattern>;
}
...
export interface QueryCreateParams {
   ...
   * Body param:
   */
  timeframe: QueryCreateParams.Timeframe;
