...
export class BaseScriptAndVersionSettings extends APIResource {
  ...
  edit(
    ...
    return (
      ...
      ) as APIPromise<{ result: ScriptAndVersionSettingEditResponse }>
  ...
  get(
    ...
    return (
      this._client.get(
        path`/accounts/${account_id}/workers/scripts/${scriptName}/settings`,
        options,
      ) as APIPromise<{ result: ScriptAndVersionSettingGetResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
}
...
export interface ScriptAndVersionSettingEditResponse {
   ...
   * this summary.
   */
  exports_reconciliation?: ScriptAndVersionSettingEditResponse.ExportsReconciliation;
...
export interface ScriptAndVersionSettingGetResponse {
   ...
   * this summary.
   */
  exports_reconciliation?: ScriptAndVersionSettingGetResponse.ExportsReconciliation;
