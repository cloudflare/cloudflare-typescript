...
export class Scripts extends APIResource {
  ...
  update(
    ...
    return (
      ...
      ) as APIPromise<{ result: ScriptUpdateResponse }>
...
export interface ScriptUpdateParams {
   ...
   * configuration.
   */
  metadata: ScriptUpdateParams.UnionMember0 | ScriptUpdateParams.UnionMember1;
...
export namespace ScriptUpdateParams {
  export interface UnionMember0 {
     ...
     */
    bindings?: Array<
      | UnionMember0.WorkersBindingKindAI
      | UnionMember0.WorkersBindingKindAnalyticsEngine
      | UnionMember0.WorkersBindingKindAssets
      | UnionMember0.WorkersBindingKindBrowser
      | UnionMember0.WorkersBindingKindD1
      | UnionMember0.WorkersBindingKindDispatchNamespace
      | UnionMember0.WorkersBindingKindDurableObjectNamespace
      | UnionMember0.WorkersBindingKindHyperdrive
      | UnionMember0.WorkersBindingKindJson
      | UnionMember0.WorkersBindingKindKVNamespace
      | UnionMember0.WorkersBindingKindMTLSCertificate
      | UnionMember0.WorkersBindingKindPlainText
      | UnionMember0.WorkersBindingKindPipelines
      | UnionMember0.WorkersBindingKindQueue
      | UnionMember0.WorkersBindingKindR2Bucket
      | UnionMember0.WorkersBindingKindSecretText
      | UnionMember0.WorkersBindingKindService
      | UnionMember0.WorkersBindingKindTailConsumer
      | UnionMember0.WorkersBindingKindVectorize
      | UnionMember0.WorkersBindingKindVersionMetadata
      | UnionMember0.WorkersBindingKindSecretsStoreSecret
      | UnionMember0.WorkersBindingKindSecretKey
      | UnionMember0.WorkersBindingKindWorkflow
    >;
     ...
     */
    migrations?: WorkersAPI.SingleStepMigrationParam | UnionMember0.WorkersMultipleStepMigrations;

    /**
     * Observability settings for the Worker.
     */
    observability?: UnionMember0.Observability;

    /**
     * Configuration for
     * [Smart Placement](https://developers.cloudflare.com/workers/configuration/smart-placement).
     */
    placement?: UnionMember0.Placement;
  ...
  export interface UnionMember1 {
     ...
     */
    bindings?: Array<
      | UnionMember1.WorkersBindingKindAI
      | UnionMember1.WorkersBindingKindAnalyticsEngine
      | UnionMember1.WorkersBindingKindAssets
      | UnionMember1.WorkersBindingKindBrowser
      | UnionMember1.WorkersBindingKindD1
      | UnionMember1.WorkersBindingKindDispatchNamespace
      | UnionMember1.WorkersBindingKindDurableObjectNamespace
      | UnionMember1.WorkersBindingKindHyperdrive
      | UnionMember1.WorkersBindingKindJson
      | UnionMember1.WorkersBindingKindKVNamespace
      | UnionMember1.WorkersBindingKindMTLSCertificate
      | UnionMember1.WorkersBindingKindPlainText
      | UnionMember1.WorkersBindingKindPipelines
      | UnionMember1.WorkersBindingKindQueue
      | UnionMember1.WorkersBindingKindR2Bucket
      | UnionMember1.WorkersBindingKindSecretText
      | UnionMember1.WorkersBindingKindService
      | UnionMember1.WorkersBindingKindTailConsumer
      | UnionMember1.WorkersBindingKindVectorize
      | UnionMember1.WorkersBindingKindVersionMetadata
      | UnionMember1.WorkersBindingKindSecretsStoreSecret
      | UnionMember1.WorkersBindingKindSecretKey
      | UnionMember1.WorkersBindingKindWorkflow
    >;
     ...
     * Migrations to apply for Durable Objects associated with this Worker.
     */
    migrations?: WorkersAPI.SingleStepMigrationParam | UnionMember1.WorkersMultipleStepMigrations;

    /**
     * Observability settings for the Worker.
     */
    observability?: UnionMember1.Observability;

    /**
     * Configuration for
     * [Smart Placement](https://developers.cloudflare.com/workers/configuration/smart-placement).
     */
    placement?: UnionMember1.Placement;
