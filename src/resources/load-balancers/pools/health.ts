...
export class Health extends APIResource {
  ...
  create(poolId: string, params: HealthCreateParams, options?: Core.RequestOptions): Core.APIPromise<HealthCreateResponse> {
    ...
    return (this._client.post(`/accounts/${account_id}/load_balancers/pools/${poolId}/preview`, { body, ...options }) as Core.APIPromise<{ result: HealthCreateResponse }>)._thenUnwrap((obj) => obj.result);
  }
  ...
  get(poolId: string, params: HealthGetParams, options?: Core.RequestOptions): Core.APIPromise<HealthGetResponse> {
    ...
    return (this._client.get(`/accounts/${account_id}/load_balancers/pools/${poolId}/health`, options) as Core.APIPromise<{ result: HealthGetResponse }>)._thenUnwrap((obj) => obj.result);
  }
}
