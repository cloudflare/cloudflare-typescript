...
export class Monitors extends APIResource {
  ...
  create(
    accountId: string,
    body: MonitorCreateParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<MonitorCreateResponse> {
    return (
      this._client.post(`/accounts/${accountId}/load_balancers/monitors`, {
        body,
        ...options,
  ...
  update(
    ...
    return (
      this._client.put(`/accounts/${accountId}/load_balancers/monitors/${monitorId}`, {
        body,
        ...options,
   ...
   */
  list(accountId: string, options?: Core.RequestOptions): Core.APIPromise<MonitorListResponse | null> {
    return (
      this._client.get(`/accounts/${accountId}/load_balancers/monitors`, options) as Core.APIPromise<{
  ...
  edit(
    ...
    return (
      this._client.patch(`/accounts/${accountId}/load_balancers/monitors/${monitorId}`, {
        body,
        ...options,
