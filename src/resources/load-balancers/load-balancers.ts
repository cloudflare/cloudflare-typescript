...
export class LoadBalancers extends APIResource {
  ...
  create(
    ...
    return (
      this._client.post(`/zones/${identifier}/load_balancers`, { body, ...options }) as Core.APIPromise<{
  ...
  retrieve(
    ...
    identifier: string,
    options?: Core.RequestOptions,
  ): Core.APIPromise<LoadBalancerRetrieveResponse> {
    return (
      this._client.get(`/zones/${identifier1}/load_balancers/${identifier}`, options) as Core.APIPromise<{
        result: LoadBalancerRetrieveResponse;
      }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  update(
    ...
    return (
      this._client.put(`/zones/${identifier1}/load_balancers/${identifier}`, {
        body,
        ...options,
   ...
   */
  list(identifier: string, options?: Core.RequestOptions): Core.APIPromise<LoadBalancerListResponse | null> {
    return (
      this._client.get(`/zones/${identifier}/load_balancers`, options) as Core.APIPromise<{
  ...
  delete(
    ...
    return (
      this._client.delete(`/zones/${identifier1}/load_balancers/${identifier}`, options) as Core.APIPromise<{
...
export interface LoadBalancerRetrieveResponse {
   ...
   * is retried once against this alternate origin.
   */
  adaptive_routing?: LoadBalancerRetrieveResponse.AdaptiveRouting;
   ...
   * to learn how steering is affected.
   */
  location_strategy?: LoadBalancerRetrieveResponse.LocationStrategy;
   ...
   *   open connections.
   */
  random_steering?: LoadBalancerRetrieveResponse.RandomSteering;
   ...
   * execute.
   */
  rules?: Array<LoadBalancerRetrieveResponse.Rule>;
   ...
   * Configures attributes for session affinity.
   */
  session_affinity_attributes?: LoadBalancerRetrieveResponse.SessionAffinityAttributes;
...
export interface LoadBalancerUpdateResponse {
   ...
   * is retried once against this alternate origin.
   */
  adaptive_routing?: LoadBalancerUpdateResponse.AdaptiveRouting;
   ...
   * to learn how steering is affected.
   */
  location_strategy?: LoadBalancerUpdateResponse.LocationStrategy;
   ...
   *   open connections.
   */
  random_steering?: LoadBalancerUpdateResponse.RandomSteering;
   ...
   * execute.
   */
  rules?: Array<LoadBalancerUpdateResponse.Rule>;
   ...
   * Configures attributes for session affinity.
   */
  session_affinity_attributes?: LoadBalancerUpdateResponse.SessionAffinityAttributes;
...
export namespace LoadBalancers {
  ...
  export import LoadBalancerRetrieveResponse = LoadBalancersAPI.LoadBalancerRetrieveResponse;
