...
export interface UnnamedSchemaRef06ba14ec7860c091efc98fd9af30f382 {
  id?: string;
   ...
   * is retried once against this alternate origin.
   */
  adaptive_routing?: UnnamedSchemaRef06ba14ec7860c091efc98fd9af30f382.AdaptiveRouting;
   ...
   * to learn how steering is affected.
   */
  location_strategy?: UnnamedSchemaRef06ba14ec7860c091efc98fd9af30f382.LocationStrategy;
   ...
   *   open connections.
   */
  random_steering?: UnnamedSchemaRef06ba14ec7860c091efc98fd9af30f382.RandomSteering;
   ...
   * execute.
   */
  rules?: Array<UnnamedSchemaRef06ba14ec7860c091efc98fd9af30f382.Rule>;
   ...
   * Configures attributes for session affinity.
   */
  session_affinity_attributes?: UnnamedSchemaRef06ba14ec7860c091efc98fd9af30f382.SessionAffinityAttributes;
...
export namespace UnnamedSchemaRef06ba14ec7860c091efc98fd9af30f382 {
  /**
   * Controls features that modify the routing of requests to pools and origins in
   * response to dynamic conditions, such as during the interval between active
   * health monitoring requests. For example, zero-downtime failover occurs
...
export namespace LoadBalancers {
  ...
  export import UnnamedSchemaRef06ba14ec7860c091efc98fd9af30f382 = LoadBalancersAPI.UnnamedSchemaRef06ba14ec7860c091efc98fd9af30f382;
