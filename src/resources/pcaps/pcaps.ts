...
export type PcapGetResponse =
  | PcapGetResponse.NiUlIPbzPcapsResponseSimple
  | PcapGetResponse.NiUlIPbzPcapsResponseFull;

export namespace PcapGetResponse {
  export interface NiUlIPbzPcapsResponseSimple {
    /**
     ...
     */
    filter_v1?: NiUlIPbzPcapsResponseSimple.FilterV1;
  ...
  export namespace NiUlIPbzPcapsResponseSimple {
    /**
     * The packet capture filter. When this field is empty, all packets are captured.
     */
  ...
  export interface NiUlIPbzPcapsResponseFull {
    /**
     * The ID for the packet capture.
     */
    id?: string;
     ...
     * The packet capture filter. When this field is empty, all packets are captured.
     */
    filter_v1?: NiUlIPbzPcapsResponseFull.FilterV1;
  ...
  export namespace NiUlIPbzPcapsResponseFull {
    /**
     * The packet capture filter. When this field is empty, all packets are captured.
     */
    export interface FilterV1 {
...
export type PcapMagicPcapCollectionCreatePcapRequestResponse =
  | PcapMagicPcapCollectionCreatePcapRequestResponse.NiUlIPbzPcapsResponseSimple
  | PcapMagicPcapCollectionCreatePcapRequestResponse.NiUlIPbzPcapsResponseFull;
...
export type PcapMagicPcapCollectionListPacketCaptureRequestsResponse = Array<
  | PcapMagicPcapCollectionListPacketCaptureRequestsResponse.NiUlIPbzPcapsResponseSimple
  | PcapMagicPcapCollectionListPacketCaptureRequestsResponse.NiUlIPbzPcapsResponseFull
>;
...
export type PcapMagicPcapCollectionCreatePcapRequestParams =
  | PcapMagicPcapCollectionCreatePcapRequestParams.NiUlIPbzPcapsRequestSimple
  | PcapMagicPcapCollectionCreatePcapRequestParams.NiUlIPbzPcapsRequestFull;

export namespace PcapMagicPcapCollectionCreatePcapRequestParams {
  export interface NiUlIPbzPcapsRequestSimple {
    /**
     ...
     * The packet capture filter. When this field is empty, all packets are captured.
     */
    filter_v1?: PcapMagicPcapCollectionCreatePcapRequestParams.NiUlIPbzPcapsRequestSimple.FilterV1;
  }

  export namespace NiUlIPbzPcapsRequestSimple {
    /**
     * The packet capture filter. When this field is empty, all packets are captured.
     */
    export interface FilterV1 {
  ...
  export interface NiUlIPbzPcapsRequestFull {
    /**
     * The name of the data center used for the packet capture. This can be a specific
     * colo (ord02) or a multi-colo name (ORD). This field only applies to `full`
     * packet captures.
     ...
     * The packet capture filter. When this field is empty, all packets are captured.
     */
    filter_v1?: PcapMagicPcapCollectionCreatePcapRequestParams.NiUlIPbzPcapsRequestFull.FilterV1;
  ...
  export namespace NiUlIPbzPcapsRequestFull {
    /**
     * The packet capture filter. When this field is empty, all packets are captured.
     */
    export interface FilterV1 {
