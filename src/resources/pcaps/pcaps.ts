...
export type PcapCreateResponse =
  | PcapCreateResponse.F0NvmgHxPcapsResponseSimple
  | PcapCreateResponse.F0NvmgHxPcapsResponseFull;

export namespace PcapCreateResponse {
  export interface F0NvmgHxPcapsResponseSimple {
    /**
     ...
     */
    filter_v1?: F0NvmgHxPcapsResponseSimple.FilterV1;
  ...
  export namespace F0NvmgHxPcapsResponseSimple {
    /**
     * The packet capture filter. When this field is empty, all packets are captured.
     */
  ...
  export interface F0NvmgHxPcapsResponseFull {
    /**
     * The ID for the packet capture.
     */
    id?: string;
     ...
     * The packet capture filter. When this field is empty, all packets are captured.
     */
    filter_v1?: F0NvmgHxPcapsResponseFull.FilterV1;
  ...
  export namespace F0NvmgHxPcapsResponseFull {
    /**
     * The packet capture filter. When this field is empty, all packets are captured.
     */
    export interface FilterV1 {
...
export type PcapListResponse = Array<
  PcapListResponse.F0NvmgHxPcapsResponseSimple | PcapListResponse.F0NvmgHxPcapsResponseFull
>;
...
export type PcapGetResponse =
  | PcapGetResponse.F0NvmgHxPcapsResponseSimple
  | PcapGetResponse.F0NvmgHxPcapsResponseFull;
...
export type PcapCreateParams =
  | PcapCreateParams.F0NvmgHxPcapsRequestSimple
  | PcapCreateParams.F0NvmgHxPcapsRequestFull;

export namespace PcapCreateParams {
  export interface F0NvmgHxPcapsRequestSimple {
    /**
     ...
     * The packet capture filter. When this field is empty, all packets are captured.
     */
    filter_v1?: PcapCreateParams.F0NvmgHxPcapsRequestSimple.FilterV1;
  }
  ...
  export interface F0NvmgHxPcapsRequestFull {
    /**
     * The name of the data center used for the packet capture. This can be a specific
     * colo (ord02) or a multi-colo name (ORD). This field only applies to `full`
     * packet captures.
     ...
     * The packet capture filter. When this field is empty, all packets are captured.
     */
    filter_v1?: PcapCreateParams.F0NvmgHxPcapsRequestFull.FilterV1;
  ...
  export namespace F0NvmgHxPcapsRequestFull {
    /**
     * The packet capture filter. When this field is empty, all packets are captured.
     */
    export interface FilterV1 {
