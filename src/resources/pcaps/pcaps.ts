...
export type PcapCreateResponse =
  | PcapCreateResponse.OvZ3JqIqPcapsResponseSimple
  | PcapCreateResponse.OvZ3JqIqPcapsResponseFull;

export namespace PcapCreateResponse {
  export interface OvZ3JqIqPcapsResponseSimple {
    /**
     ...
     */
    filter_v1?: OvZ3JqIqPcapsResponseSimple.FilterV1;
  ...
  export namespace OvZ3JqIqPcapsResponseSimple {
    /**
     * The packet capture filter. When this field is empty, all packets are captured.
     */
  ...
  export interface OvZ3JqIqPcapsResponseFull {
    /**
     * The ID for the packet capture.
     */
    id?: string;
     ...
     * The packet capture filter. When this field is empty, all packets are captured.
     */
    filter_v1?: OvZ3JqIqPcapsResponseFull.FilterV1;
  ...
  export namespace OvZ3JqIqPcapsResponseFull {
    /**
     * The packet capture filter. When this field is empty, all packets are captured.
     */
    export interface FilterV1 {
...
export type PcapListResponse = Array<
  PcapListResponse.OvZ3JqIqPcapsResponseSimple | PcapListResponse.OvZ3JqIqPcapsResponseFull
>;
...
export type PcapGetResponse =
  | PcapGetResponse.OvZ3JqIqPcapsResponseSimple
  | PcapGetResponse.OvZ3JqIqPcapsResponseFull;
