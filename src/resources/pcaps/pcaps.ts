...
export type PcapCreateResponse =
  | PcapCreateResponse.FfMrAnLxPcapsResponseSimple
  | PcapCreateResponse.FfMrAnLxPcapsResponseFull;

export namespace PcapCreateResponse {
  export interface FfMrAnLxPcapsResponseSimple {
    /**
     ...
     */
    filter_v1?: FfMrAnLxPcapsResponseSimple.FilterV1;
  ...
  export namespace FfMrAnLxPcapsResponseSimple {
    /**
     * The packet capture filter. When this field is empty, all packets are captured.
     */
  ...
  export interface FfMrAnLxPcapsResponseFull {
    /**
     * The ID for the packet capture.
     */
    id?: string;
     ...
     * The packet capture filter. When this field is empty, all packets are captured.
     */
    filter_v1?: FfMrAnLxPcapsResponseFull.FilterV1;
  ...
  export namespace FfMrAnLxPcapsResponseFull {
    /**
     * The packet capture filter. When this field is empty, all packets are captured.
     */
    export interface FilterV1 {
...
export type PcapListResponse = Array<
  PcapListResponse.FfMrAnLxPcapsResponseSimple | PcapListResponse.FfMrAnLxPcapsResponseFull
>;
...
export type PcapGetResponse =
  | PcapGetResponse.FfMrAnLxPcapsResponseSimple
  | PcapGetResponse.FfMrAnLxPcapsResponseFull;
