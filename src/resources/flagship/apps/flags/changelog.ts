...
export class BaseChangelog extends APIResource {
  static override readonly _key: readonly ['flagship', 'apps', 'flags', 'changelog'] = Object.freeze([
    'flagship',
    'apps',
    'flags',
    'changelog',
  ...
  ): PagePromise<ChangelogListResponsesCursorPaginationAfter, ChangelogListResponse> {
    const { account_id, app_id, ...query } = params;
    return this._client.getAPIList(
      path`/accounts/${account_id}/flagship/apps/${app_id}/flags/${flagKey}/changelog`,
      CursorPaginationAfter<ChangelogListResponse>,
      { query, ...options },
    );
  }
}
...
export type ChangelogListResponsesCursorPaginationAfter = CursorPaginationAfter<ChangelogListResponse>;
