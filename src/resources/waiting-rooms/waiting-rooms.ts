...
import * as WaitingRoomsAPI from 'cloudflare/resources/waiting-rooms/waiting-rooms';
...
export class WaitingRooms extends APIResource {
  ...
  update(
    ...
    options?: Core.RequestOptions,
  ): Core.APIPromise<WaitingRoomUpdateResponse> {
    return (
      this._client.put(`/zones/${zoneIdentifier}/waiting_rooms/${waitingRoomId}`, {
        body,
        ...options,
      }) as Core.APIPromise<{ result: WaitingRoomUpdateResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  edit(
    ...
    options?: Core.RequestOptions,
  ): Core.APIPromise<WaitingRoomEditResponse> {
    return (
      this._client.patch(`/zones/${zoneIdentifier}/waiting_rooms/${waitingRoomId}`, {
        body,
        ...options,
      }) as Core.APIPromise<{ result: WaitingRoomEditResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  get(
    ...
    waitingRoomId: unknown,
    options?: Core.RequestOptions,
  ): Core.APIPromise<WaitingRoomGetResponse> {
    return (
      this._client.get(
        `/zones/${zoneIdentifier}/waiting_rooms/${waitingRoomId}`,
        options,
      ) as Core.APIPromise<{ result: WaitingRoomGetResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  preview(
    zoneIdentifier: string,
    body: WaitingRoomPreviewParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<WaitingRoomPreviewResponse> {
    return (
      this._client.post(`/zones/${zoneIdentifier}/waiting_rooms/preview`, {
        body,
        ...options,
      }) as Core.APIPromise<{ result: WaitingRoomPreviewResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
}
...
export interface WaitingRoomCreateResponse {
   ...
   */
  additional_routes?: Array<WaitingRoomCreateResponse.AdditionalRoute>;
   ...
   */
  cookie_attributes?: WaitingRoomCreateResponse.CookieAttributes;
...
export namespace WaitingRoomCreateResponse {
...
export interface WaitingRoomUpdateResponse {
   ...
   * be unique to this and all other waiting rooms.
   */
  additional_routes?: Array<WaitingRoomUpdateResponse.AdditionalRoute>;

  /**
   * Configures cookie attributes for the waiting room cookie. This encrypted cookie
   * stores a user's status in the waiting room, such as queue position.
   */
  cookie_attributes?: WaitingRoomUpdateResponse.CookieAttributes;
...
export namespace WaitingRoomUpdateResponse {
  export interface AdditionalRoute {
    /**
     * The hostname to which this waiting room will be applied (no wildcards). The
     * hostname must be the primary domain, subdomain, or custom hostname (if using SSL
...
export type WaitingRoomListResponse = Array<WaitingRoomListResponse.WaitingRoomListResponseItem>;

export namespace WaitingRoomListResponse {
  export interface WaitingRoomListResponseItem {
    id?: unknown;
     ...
     * be unique to this and all other waiting rooms.
     */
    additional_routes?: Array<WaitingRoomListResponseItem.AdditionalRoute>;

    /**
     * Configures cookie attributes for the waiting room cookie. This encrypted cookie
     * stores a user's status in the waiting room, such as queue position.
     */
    cookie_attributes?: WaitingRoomListResponseItem.CookieAttributes;
  ...
  export namespace WaitingRoomListResponseItem {
    export interface AdditionalRoute {
      /**
       * The hostname to which this waiting room will be applied (no wildcards). The
       * hostname must be the primary domain, subdomain, or custom hostname (if using SSL
...
export interface WaitingRoomEditResponse {
  id?: unknown;
   ...
   * be unique to this and all other waiting rooms.
   */
  additional_routes?: Array<WaitingRoomEditResponse.AdditionalRoute>;

  /**
   * Configures cookie attributes for the waiting room cookie. This encrypted cookie
   * stores a user's status in the waiting room, such as queue position.
   */
  cookie_attributes?: WaitingRoomEditResponse.CookieAttributes;
...
export namespace WaitingRoomEditResponse {
  export interface AdditionalRoute {
    /**
     * The hostname to which this waiting room will be applied (no wildcards). The
     * hostname must be the primary domain, subdomain, or custom hostname (if using SSL
...
export interface WaitingRoomGetResponse {
  id?: unknown;
   ...
   * be unique to this and all other waiting rooms.
   */
  additional_routes?: Array<WaitingRoomGetResponse.AdditionalRoute>;

  /**
   * Configures cookie attributes for the waiting room cookie. This encrypted cookie
   * stores a user's status in the waiting room, such as queue position.
   */
  cookie_attributes?: WaitingRoomGetResponse.CookieAttributes;
...
export namespace WaitingRoomGetResponse {
  export interface AdditionalRoute {
    /**
     * The hostname to which this waiting room will be applied (no wildcards). The
     * hostname must be the primary domain, subdomain, or custom hostname (if using SSL
...
export interface WaitingRoomPreviewResponse {
  /**
...
export interface WaitingRoomCreateParams {
   ...
   * be unique to this and all other waiting rooms.
   */
  additional_routes?: Array<WaitingRoomCreateParams.AdditionalRoute>;

  /**
   * Configures cookie attributes for the waiting room cookie. This encrypted cookie
   * stores a user's status in the waiting room, such as queue position.
   */
  cookie_attributes?: WaitingRoomCreateParams.CookieAttributes;
...
export namespace WaitingRoomCreateParams {
  export interface AdditionalRoute {
    /**
     * The hostname to which this waiting room will be applied (no wildcards). The
     * hostname must be the primary domain, subdomain, or custom hostname (if using SSL
...
export interface WaitingRoomEditParams {
   ...
   * be unique to this and all other waiting rooms.
   */
  additional_routes?: Array<WaitingRoomEditParams.AdditionalRoute>;

  /**
   * Configures cookie attributes for the waiting room cookie. This encrypted cookie
   * stores a user's status in the waiting room, such as queue position.
   */
  cookie_attributes?: WaitingRoomEditParams.CookieAttributes;
...
export namespace WaitingRoomEditParams {
  export interface AdditionalRoute {
    /**
     * The hostname to which this waiting room will be applied (no wildcards). The
     * hostname must be the primary domain, subdomain, or custom hostname (if using SSL
...
export interface WaitingRoomPreviewParams {
  /**
   * Only available for the Waiting Room Advanced subscription. This is a template
   * html file that will be rendered at the edge. If no custom_page_html is provided,
   * the default waiting room will be used. The template is based on mustache (
...
export namespace WaitingRooms {
  export import WaitingRoomCreateResponse = WaitingRoomsAPI.WaitingRoomCreateResponse;
  export import WaitingRoomUpdateResponse = WaitingRoomsAPI.WaitingRoomUpdateResponse;
  ...
  export import WaitingRoomEditResponse = WaitingRoomsAPI.WaitingRoomEditResponse;
  export import WaitingRoomGetResponse = WaitingRoomsAPI.WaitingRoomGetResponse;
  export import WaitingRoomPreviewResponse = WaitingRoomsAPI.WaitingRoomPreviewResponse;
  ...
  export import WaitingRoomPreviewParams = WaitingRoomsAPI.WaitingRoomPreviewParams;
