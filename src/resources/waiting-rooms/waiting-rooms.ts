...
import * as PreviewsAPI from 'cloudflare/resources/waiting-rooms/previews';
...
export namespace WaitingRooms {
  ...
  export import EventWaitingRoomCreateEventResponse = EventsAPI.EventWaitingRoomCreateEventResponse;
