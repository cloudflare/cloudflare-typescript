...
export class WaitingRooms extends APIResource {
  ...
  replace(
    zoneIdentifier: string,
    waitingRoomId: unknown,
    body: WaitingRoomReplaceParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<WaitingRoomReplaceResponse> {
    return (
      this._client.put(`/zones/${zoneIdentifier}/waiting_rooms/${waitingRoomId}`, {
        body,
        ...options,
      }) as Core.APIPromise<{ result: WaitingRoomReplaceResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
}
...
export interface WaitingRoomReplaceResponse {
  id?: unknown;
   ...
   * be unique to this and all other waiting rooms.
   */
  additional_routes?: Array<WaitingRoomReplaceResponse.AdditionalRoute>;

  /**
   * Configures cookie attributes for the waiting room cookie. This encrypted cookie
   * stores a user's status in the waiting room, such as queue position.
   */
  cookie_attributes?: WaitingRoomReplaceResponse.CookieAttributes;
...
export namespace WaitingRoomReplaceResponse {
  export interface AdditionalRoute {
    /**
     * The hostname to which this waiting room will be applied (no wildcards). The
     * hostname must be the primary domain, subdomain, or custom hostname (if using SSL
...
export interface WaitingRoomReplaceParams {
  /**
   * The host name to which the waiting room will be applied (no wildcards). Please
   * do not include the scheme (http:// or https://). The host and path combination
   * must be unique.
   ...
   * be unique to this and all other waiting rooms.
   */
  additional_routes?: Array<WaitingRoomReplaceParams.AdditionalRoute>;

  /**
   * Configures cookie attributes for the waiting room cookie. This encrypted cookie
   * stores a user's status in the waiting room, such as queue position.
   */
  cookie_attributes?: WaitingRoomReplaceParams.CookieAttributes;
...
export namespace WaitingRoomReplaceParams {
  export interface AdditionalRoute {
    /**
     * The hostname to which this waiting room will be applied (no wildcards). The
     * hostname must be the primary domain, subdomain, or custom hostname (if using SSL
...
export namespace WaitingRooms {
  ...
  export import WaitingRoomReplaceResponse = WaitingRoomsAPI.WaitingRoomReplaceResponse;
  ...
  export import WaitingRoomReplaceParams = WaitingRoomsAPI.WaitingRoomReplaceParams;
  ...
  export import EventReplaceResponse = EventsAPI.EventReplaceResponse;
  export import EventCreateParams = EventsAPI.EventCreateParams;
  export import EventReplaceParams = EventsAPI.EventReplaceParams;
