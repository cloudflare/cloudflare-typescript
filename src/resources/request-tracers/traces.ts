...
export type JjJoFrd1Trace = Array<JjJoFrd1Trace.JjJoFrd1TraceItem>;

export namespace JjJoFrd1Trace {
  /**
   * List of steps acting on request/response
   */
  export interface JjJoFrd1TraceItem {
    /**
...
export namespace Traces {
  export import JjJoFrd1Trace = TracesAPI.JjJoFrd1Trace;
