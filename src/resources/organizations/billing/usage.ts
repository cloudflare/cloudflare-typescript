...
export class BaseUsage extends APIResource {
  static override readonly _key: readonly ['organizations', 'billing', 'usage'] = Object.freeze([
    'organizations',
    'billing',
    'usage',
  ] as const);
  ...
  get(
    ...
    query: UsageGetParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<UsageGetResponse> {
    return (
      this._client.get(path`/organizations/${organizationID}/billable/usage`, {
        query,
        ...options,
      }) as APIPromise<{ result: UsageGetResponse }>
