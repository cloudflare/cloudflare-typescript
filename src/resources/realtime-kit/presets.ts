...
export class BasePresets extends APIResource {
  ...
  replacePresetByID(
    ...
    options?: RequestOptions,
  ): APIPromise<PresetReplacePresetByIDResponse> {
    const { account_id, app_id, ...body } = params;
    return this._client.put(path`/accounts/${account_id}/realtime/kit/${app_id}/presets/${presetID}`, {
      body,
      ...options,
    });
  }
...
export interface PresetReplacePresetByIDResponse {
  /**
   * Data returned by the operation
   */
  data: PresetReplacePresetByIDResponse.Data;
...
export namespace PresetReplacePresetByIDResponse {
  /**
   * Data returned by the operation
   */
  export interface Data {
...
export interface PresetReplacePresetByIDParams {
  /**
   * Path param: The account identifier tag.
   */
  account_id: string;
   ...
   * Body param
   */
  config: PresetReplacePresetByIDParams.Config;
   ...
   * Body param
   */
  permissions: PresetReplacePresetByIDParams.Permissions;

  /**
   * Body param
   */
  ui: PresetReplacePresetByIDParams.UI;
}

export namespace PresetReplacePresetByIDParams {
  export interface Config {
    /**
     * Maximum number of screen shares that can be active at a given time
     */
