...
export class Config extends APIResource {
  ...
  ): Core.APIPromise<ConfigReplaceResponse> {
    return (
...
export interface ConfigReplaceResponse {
   ...
   * General Zaraz settings.
   */
  settings: ConfigReplaceResponse.Settings;
  ...
  tools: Record<
    string,
    ConfigReplaceResponse.ZarazManagedComponent | ConfigReplaceResponse.ZarazCustomManagedComponent
  >;
   ...
   * alpha-numeric ID and value is the trigger configuration.
   */
  triggers: Record<string, ConfigReplaceResponse.Triggers>;
   ...
   * type secret are not included.
   */
  variables: Record<string, ConfigReplaceResponse.UnionMember0 | ConfigReplaceResponse.UnionMember1>;
   ...
   * Consent management configuration.
   */
  consent?: ConfigReplaceResponse.Consent;
...
export namespace ConfigReplaceResponse {
  /**
   * General Zaraz settings.
   */
  export interface Settings {
...
export interface ConfigReplaceParams {
   ...
   * General Zaraz settings.
   */
  settings: ConfigReplaceParams.Settings;
  ...
  tools: Record<
    string,
    | ConfigReplaceParams.ZarazLegacyTool
    | ConfigReplaceParams.ZarazManagedComponent
    | ConfigReplaceParams.ZarazCustomManagedComponent
  >;
   ...
   * alpha-numeric ID and value is the trigger configuration.
   */
  triggers: Record<string, ConfigReplaceParams.Triggers>;
   ...
   * type secret are not included.
   */
  variables: Record<string, ConfigReplaceParams.UnionMember0 | ConfigReplaceParams.UnionMember1>;
   ...
   * Consent management configuration.
   */
  consent?: ConfigReplaceParams.Consent;
