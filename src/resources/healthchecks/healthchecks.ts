...
export class Healthchecks extends APIResource {
  ...
  replace(
    zoneIdentifier: string,
    identifier: string,
    body: HealthcheckReplaceParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<HealthcheckReplaceResponse> {
    return (
      this._client.put(`/zones/${zoneIdentifier}/healthchecks/${identifier}`, {
        body,
        ...options,
      }) as Core.APIPromise<{ result: HealthcheckReplaceResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
}
...
export interface HealthcheckReplaceResponse {
  /**
   * Identifier
   */
  id?: string;
   ...
   * Parameters specific to an HTTP or HTTPS health check.
   */
  http_config?: HealthcheckReplaceResponse.HTTPConfig | null;
   ...
   * Parameters specific to TCP health check.
   */
  tcp_config?: HealthcheckReplaceResponse.TcpConfig | null;
...
export namespace HealthcheckReplaceResponse {
  /**
   * Parameters specific to an HTTP or HTTPS health check.
   */
  export interface HTTPConfig {
...
export interface HealthcheckReplaceParams {
  /**
   * The hostname or IP address of the origin server to run health checks on.
   */
  address: string;
   ...
   * Parameters specific to an HTTP or HTTPS health check.
   */
  http_config?: HealthcheckReplaceParams.HTTPConfig | null;
   ...
   * Parameters specific to TCP health check.
   */
  tcp_config?: HealthcheckReplaceParams.TcpConfig | null;
...
export namespace HealthcheckReplaceParams {
  /**
   * Parameters specific to an HTTP or HTTPS health check.
   */
  export interface HTTPConfig {
...
export namespace Healthchecks {
  ...
  export import HealthcheckReplaceResponse = HealthchecksAPI.HealthcheckReplaceResponse;
  export import HealthcheckCreateParams = HealthchecksAPI.HealthcheckCreateParams;
  export import HealthcheckReplaceParams = HealthchecksAPI.HealthcheckReplaceParams;
