...
export class Healthchecks extends APIResource {
  ...
  edit(
    ...
    options?: Core.RequestOptions,
  ): Core.APIPromise<HealthcheckEditResponse> {
    return (
      this._client.patch(`/zones/${zoneIdentifier}/healthchecks/${identifier}`, {
        body,
        ...options,
      }) as Core.APIPromise<{ result: HealthcheckEditResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
...
export interface HealthcheckEditResponse {
  /**
   * Identifier
   */
  id?: string;
   ...
   * Parameters specific to an HTTP or HTTPS health check.
   */
  http_config?: HealthcheckEditResponse.HTTPConfig | null;
   ...
   * Parameters specific to TCP health check.
   */
  tcp_config?: HealthcheckEditResponse.TcpConfig | null;
...
export namespace HealthcheckEditResponse {
  /**
   * Parameters specific to an HTTP or HTTPS health check.
   */
  export interface HTTPConfig {
...
export namespace Healthchecks {
  ...
  export import HealthcheckEditResponse = HealthchecksAPI.HealthcheckEditResponse;
