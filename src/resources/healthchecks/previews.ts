...
export class Previews extends APIResource {
  ...
  healthChecksCreatePreviewHealthCheck(
    ...
    options?: Core.RequestOptions,
  ): Core.APIPromise<PreviewHealthChecksCreatePreviewHealthCheckResponse> {
    return (
      this._client.post(`/zones/${zoneIdentifier}/healthchecks/preview`, {
        body,
        ...options,
      }) as Core.APIPromise<{ result: PreviewHealthChecksCreatePreviewHealthCheckResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
}
...
export interface PreviewGetResponse {
   ...
   */
  http_config?: PreviewGetResponse.HTTPConfig | null;
   ...
   */
  tcp_config?: PreviewGetResponse.TcpConfig | null;
...
export interface PreviewHealthChecksCreatePreviewHealthCheckResponse {
  /**
   * Identifier
   */
  id?: string;
   ...
   * Parameters specific to an HTTP or HTTPS health check.
   */
  http_config?: PreviewHealthChecksCreatePreviewHealthCheckResponse.HTTPConfig | null;
   ...
   * Parameters specific to TCP health check.
   */
  tcp_config?: PreviewHealthChecksCreatePreviewHealthCheckResponse.TcpConfig | null;
...
export namespace PreviewHealthChecksCreatePreviewHealthCheckResponse {
  /**
   * Parameters specific to an HTTP or HTTPS health check.
   */
  export interface HTTPConfig {
