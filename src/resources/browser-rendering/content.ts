...
export class Content extends APIResource {
  ...
  ): Core.APIPromise<ContentCreateResponse>;
  create(accountId: string, options?: Core.RequestOptions): Core.APIPromise<ContentCreateResponse>;
  create(
    accountId: string,
    params: ContentCreateParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<ContentCreateResponse> {
