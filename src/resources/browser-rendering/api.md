...
- <code title="get /accounts/{account_id}/browser-rendering/devtools/browser/{session_id}/json/close/{target_id}">client.browserRendering.devtools.browser.targets.<a href="./src/resources/browser-rendering/devtools/browser/targets.ts">close</a>(targetID, { ...params }) -> TargetCloseResponse</code>
