...
export interface ByTagGetResponse {
  ...
  rules: Array<
    ...
    | ByTagGetResponse.RulesetsCompressResponseRule
    | RulesAPI.ExecuteRule
    | ByTagGetResponse.RulesetsJsChallengeRule
    | RulesAPI.LogRule
    | ByTagGetResponse.RulesetsManagedChallengeRule
    | ByTagGetResponse.RulesetsRedirectRule
    | ByTagGetResponse.RulesetsRewriteRule
    | ByTagGetResponse.RulesetsRouteRule
    | ByTagGetResponse.RulesetsScoreRule
    | ByTagGetResponse.RulesetsServeErrorRule
    | ByTagGetResponse.RulesetsSetConfigRule
    | RulesAPI.SkipRule
    | ByTagGetResponse.RulesetsSetCacheSettingsRule
  >;
