...
export interface PhaseUpdateResponse {
  ...
  rules: Array<
    ...
    | PhaseUpdateResponse.RulesetsCompressResponseRule
    | RulesAPI.ExecuteRule
    | PhaseUpdateResponse.RulesetsJsChallengeRule
    | RulesAPI.LogRule
    | PhaseUpdateResponse.RulesetsManagedChallengeRule
    | PhaseUpdateResponse.RulesetsRedirectRule
    | PhaseUpdateResponse.RulesetsRewriteRule
    | PhaseUpdateResponse.RulesetsRouteRule
    | PhaseUpdateResponse.RulesetsScoreRule
    | PhaseUpdateResponse.RulesetsServeErrorRule
    | PhaseUpdateResponse.RulesetsSetConfigRule
    | RulesAPI.SkipRule
    | PhaseUpdateResponse.RulesetsSetCacheSettingsRule
  >;
...
export interface PhaseGetResponse {
  ...
  rules: Array<
    ...
    | PhaseGetResponse.RulesetsCompressResponseRule
    | RulesAPI.ExecuteRule
    | PhaseGetResponse.RulesetsJsChallengeRule
    | RulesAPI.LogRule
    | PhaseGetResponse.RulesetsManagedChallengeRule
    | PhaseGetResponse.RulesetsRedirectRule
    | PhaseGetResponse.RulesetsRewriteRule
    | PhaseGetResponse.RulesetsRouteRule
    | PhaseGetResponse.RulesetsScoreRule
    | PhaseGetResponse.RulesetsServeErrorRule
    | PhaseGetResponse.RulesetsSetConfigRule
    | RulesAPI.SkipRule
    | PhaseGetResponse.RulesetsSetCacheSettingsRule
  >;
...
export interface PhaseUpdateParams {
  ...
  rules: Array<
    ...
    | PhaseUpdateParams.RulesetsCompressResponseRule
    | RulesAPI.ExecuteRule
    | PhaseUpdateParams.RulesetsJsChallengeRule
    | RulesAPI.LogRule
    | PhaseUpdateParams.RulesetsManagedChallengeRule
    | PhaseUpdateParams.RulesetsRedirectRule
    | PhaseUpdateParams.RulesetsRewriteRule
    | PhaseUpdateParams.RulesetsRouteRule
    | PhaseUpdateParams.RulesetsScoreRule
    | PhaseUpdateParams.RulesetsServeErrorRule
    | PhaseUpdateParams.RulesetsSetConfigRule
    | RulesAPI.SkipRule
    | PhaseUpdateParams.RulesetsSetCacheSettingsRule
  >;
