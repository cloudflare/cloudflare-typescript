...
import { BaseDetections, DetectionGetParams, DetectionGetResponse, Detections } from './detections';
...
import { BaseReclassify, Reclassify, ReclassifyCreateParams, ReclassifyCreateResponse } from './reclassify';
...
export class BaseInvestigate extends APIResource {
   ...
   */
  list(
    params: InvestigateListParams | null | undefined = {},
    options?: RequestOptions,
  ): PagePromise<InvestigateListResponsesV4PagePaginationArray, InvestigateListResponse> {
    const { account_id = this._client.accountID, ...query } = params ?? {};
    return this._client.getAPIList(
      path`/accounts/${account_id}/email-security/investigate`,
      V4PagePaginationArray<InvestigateListResponse>,
      { query, ...options },
    );
  }
  ...
  get(
    postfixID: string,
    params: InvestigateGetParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<InvestigateGetResponse> {
    const { account_id = this._client.accountID, ...query } = params ?? {};
    return (
      this._client.get(path`/accounts/${account_id}/email-security/investigate/${postfixID}`, {
        query,
        ...options,
      }) as APIPromise<{ result: InvestigateGetResponse }>
...
export declare namespace Investigate {
  ...
  export {
    ...
    type TraceGetResponse as TraceGetResponse,
    type TraceGetParams as TraceGetParams,
  };
  ...
  export {
    ...
    BaseReclassify as BaseReclassify,
