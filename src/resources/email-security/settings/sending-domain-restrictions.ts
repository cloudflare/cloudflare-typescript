...
export class BaseSendingDomainRestrictions extends APIResource {
  static override readonly _key: readonly ['emailSecurity', 'settings', 'sendingDomainRestrictions'] =
    Object.freeze(['emailSecurity', 'settings', 'sendingDomainRestrictions'] as const);
  ...
  ): APIPromise<SendingDomainRestrictionCreateResponse> {
    const { account_id, ...body } = params;
    return (
      this._client.post(path`/accounts/${account_id}/email-security/settings/sending_domain_restrictions`, {
        body,
        ...options,
      }) as APIPromise<{ result: SendingDomainRestrictionCreateResponse }>
  ...
  > {
    ...
    return this._client.getAPIList(
      ...
      V4PagePaginationArray<SendingDomainRestrictionListResponse>,
      { query, ...options },
    );
  }
  ...
  delete(
    ...
    options?: RequestOptions,
  ): APIPromise<SendingDomainRestrictionDeleteResponse> {
    const { account_id } = params;
    return (
      this._client.delete(
        path`/accounts/${account_id}/email-security/settings/sending_domain_restrictions/${sendingDomainRestrictionID}`,
        options,
      ) as APIPromise<{ result: SendingDomainRestrictionDeleteResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  edit(
    ...
    options?: RequestOptions,
  ): APIPromise<SendingDomainRestrictionEditResponse> {
    const { account_id, ...body } = params;
    return (
      this._client.patch(
        path`/accounts/${account_id}/email-security/settings/sending_domain_restrictions/${sendingDomainRestrictionID}`,
        { body, ...options },
      ) as APIPromise<{ result: SendingDomainRestrictionEditResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  get(
    ...
    options?: RequestOptions,
  ): APIPromise<SendingDomainRestrictionGetResponse> {
    const { account_id } = params;
    return (
      this._client.get(
        path`/accounts/${account_id}/email-security/settings/sending_domain_restrictions/${sendingDomainRestrictionID}`,
        options,
      ) as APIPromise<{ result: SendingDomainRestrictionGetResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
}
export class SendingDomainRestrictions extends BaseSendingDomainRestrictions {}
