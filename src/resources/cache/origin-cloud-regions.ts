...
export class BaseOriginCloudRegions extends APIResource {
  ...
  delete(
    ...
    return (
      this._client.delete(path`/zones/${zone_id}/origin/cloud_regions/${originIP}`, options) as APIPromise<{
  ...
  bulkDelete(
    ...
    const { zone_id } = params;
    return (
      this._client.delete(path`/zones/${zone_id}/origin/cloud_regions/batch`, options) as APIPromise<{
  ...
  bulkUpdate(
    ...
    options?: RequestOptions,
  ): APIPromise<OriginCloudRegionBulkUpdateResponse> {
    const { zone_id, body } = params;
    return (
      this._client.put(path`/zones/${zone_id}/origin/cloud_regions/batch`, {
        body: body,
        ...options,
      }) as APIPromise<{ result: OriginCloudRegionBulkUpdateResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
