...
export class Deployments extends APIResource {
  ...
  create(
    ...
    return (
      ...
      ) as APIPromise<{ result: DeploymentCreateResponse }>
  ...
  list(
    ...
    options?: RequestOptions,
  ): PagePromise<DeploymentListResponsesV4PagePaginationArray, DeploymentListResponse> {
    const { account_id, ...query } = params;
    return this._client.getAPIList(
      path`/accounts/${account_id}/pages/projects/${projectName}/deployments`,
      V4PagePaginationArray<DeploymentListResponse>,
      { query, ...options },
    );
  }
  ...
  get(
    ...
    options?: RequestOptions,
  ): APIPromise<DeploymentGetResponse> {
    const { account_id, project_name } = params;
    return (
      this._client.get(
        path`/accounts/${account_id}/pages/projects/${project_name}/deployments/${deploymentID}`,
        options,
      ) as APIPromise<{ result: DeploymentGetResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  rollback(
    ...
    options?: RequestOptions,
  ): APIPromise<DeploymentRollbackResponse> {
    const { account_id, project_name } = params;
    return (
      this._client.post(
        path`/accounts/${account_id}/pages/projects/${project_name}/deployments/${deploymentID}/rollback`,
        options,
      ) as APIPromise<{ result: DeploymentRollbackResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
}

export type DeploymentListResponsesV4PagePaginationArray = V4PagePaginationArray<DeploymentListResponse>;
...
export declare namespace Deployments {
  export {
    ...
    type DeploymentListResponsesV4PagePaginationArray as DeploymentListResponsesV4PagePaginationArray,
