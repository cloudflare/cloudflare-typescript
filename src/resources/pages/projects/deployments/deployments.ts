...
export class Deployments extends APIResource {
  ...
  create(projectName: string, params: DeploymentCreateParams, options?: Core.RequestOptions): Core.APIPromise<ProjectsAPI.Deployment> {
    ...
    return (this._client.post(`/accounts/${account_id}/pages/projects/${projectName}/deployments`, Core.multipartFormRequestOptions({ body, ...options })) as Core.APIPromise<{ result: ProjectsAPI.Deployment }>)._thenUnwrap((obj) => obj.result);
  }
   ...
   * Delete a deployment.
   */
  delete(projectName: string, deploymentId: string, params: DeploymentDeleteParams, options?: Core.RequestOptions): Core.APIPromise<DeploymentDeleteResponse> {
    const { account_id } = params;
    return (this._client.delete(`/accounts/${account_id}/pages/projects/${projectName}/deployments/${deploymentId}`, options) as Core.APIPromise<{ result: DeploymentDeleteResponse }>)._thenUnwrap((obj) => obj.result);
  }
  ...
  get(projectName: string, deploymentId: string, params: DeploymentGetParams, options?: Core.RequestOptions): Core.APIPromise<ProjectsAPI.Deployment> {
    const { account_id } = params;
    return (this._client.get(`/accounts/${account_id}/pages/projects/${projectName}/deployments/${deploymentId}`, options) as Core.APIPromise<{ result: ProjectsAPI.Deployment }>)._thenUnwrap((obj) => obj.result);
  }
  ...
  retry(projectName: string, deploymentId: string, params: DeploymentRetryParams, options?: Core.RequestOptions): Core.APIPromise<ProjectsAPI.Deployment> {
    const { account_id, body } = params;
    return (this._client.post(`/accounts/${account_id}/pages/projects/${projectName}/deployments/${deploymentId}/retry`, { body: body, ...options }) as Core.APIPromise<{ result: ProjectsAPI.Deployment }>)._thenUnwrap((obj) => obj.result);
  }
  ...
  rollback(projectName: string, deploymentId: string, params: DeploymentRollbackParams, options?: Core.RequestOptions): Core.APIPromise<ProjectsAPI.Deployment> {
    const { account_id, body } = params;
    return (this._client.post(`/accounts/${account_id}/pages/projects/${projectName}/deployments/${deploymentId}/rollback`, { body: body, ...options }) as Core.APIPromise<{ result: ProjectsAPI.Deployment }>)._thenUnwrap((obj) => obj.result);
  }
}
