...
export interface GroupRetrieveResponse {
   ...
   */
  exclude?: Array<
    | GroupRetrieveResponse.AccessEmailRule
    | GroupRetrieveResponse.AccessEmailListRule
    | GroupRetrieveResponse.AccessDomainRule
    | GroupRetrieveResponse.AccessEveryoneRule
    | GroupRetrieveResponse.AccessIPRule
    | GroupRetrieveResponse.AccessIPListRule
    | GroupRetrieveResponse.AccessCertificateRule
    | GroupRetrieveResponse.AccessAccessGroupRule
    | GroupRetrieveResponse.AccessAzureGroupRule
    | GroupRetrieveResponse.AccessGitHubOrganizationRule
    | GroupRetrieveResponse.AccessGsuiteGroupRule
    | GroupRetrieveResponse.AccessOktaGroupRule
    | GroupRetrieveResponse.AccessSamlGroupRule
    | GroupRetrieveResponse.AccessServiceTokenRule
    | GroupRetrieveResponse.AccessAnyValidServiceTokenRule
    | GroupRetrieveResponse.AccessExternalEvaluationRule
    | GroupRetrieveResponse.AccessCountryRule
    | GroupRetrieveResponse.AccessAuthenticationMethodRule
    | GroupRetrieveResponse.AccessDevicePostureRule
  >;
