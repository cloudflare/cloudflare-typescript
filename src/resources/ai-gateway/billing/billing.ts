...
export class BaseBilling extends APIResource {
  static override readonly _key: readonly ['aiGateway', 'billing'] = Object.freeze([
    'aiGateway',
    'billing',
  ] as const);
  ...
  ): APIPromise<BillingCreditBalanceResponse> {
    const { account_id } = params;
    return (
      this._client.get(
        path`/accounts/${account_id}/ai-gateway/billing/credit-balance`,
        options,
      ) as APIPromise<{ result: BillingCreditBalanceResponse }>
  ...
  invoiceHistory(
    ...
    options?: RequestOptions,
  ): APIPromise<BillingInvoiceHistoryResponse> {
    const { account_id, ...query } = params;
    return (
      this._client.get(path`/accounts/${account_id}/ai-gateway/billing/invoice-history`, {
        query,
        ...options,
      }) as APIPromise<{ result: BillingInvoiceHistoryResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  invoicePreview(
    ...
    options?: RequestOptions,
  ): APIPromise<BillingInvoicePreviewResponse> {
    const { account_id } = params;
    return (
      this._client.get(
        path`/accounts/${account_id}/ai-gateway/billing/invoice-preview`,
        options,
      ) as APIPromise<{ result: BillingInvoicePreviewResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  usageHistory(
    ...
    options?: RequestOptions,
  ): APIPromise<BillingUsageHistoryResponse> {
    const { account_id, ...query } = params;
    return (
      this._client.get(path`/accounts/${account_id}/ai-gateway/billing/usage-history`, {
        query,
        ...options,
      }) as APIPromise<{ result: BillingUsageHistoryResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
}
...
Billing.Topup = Topup;
Billing.BaseTopup = BaseTopup;
Billing.SpendingLimit = SpendingLimit;
Billing.BaseSpendingLimit = BaseSpendingLimit;
...
export declare namespace Billing {
  ...
  export {
    ...
    BaseSpendingLimit as BaseSpendingLimit,
