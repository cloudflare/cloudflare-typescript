...
export class Summaries extends APIResource {
  ...
  ): Core.APIPromise<SummarySpectrumAnalyticsSummaryGetAnalyticsSummaryResponse | null>;
  spectrumAnalyticsSummaryGetAnalyticsSummary(
    zone: string,
    options?: Core.RequestOptions,
  ): Core.APIPromise<SummarySpectrumAnalyticsSummaryGetAnalyticsSummaryResponse | null>;
  spectrumAnalyticsSummaryGetAnalyticsSummary(
    ...
    return (
      this._client.get(`/zones/${zone}/spectrum/analytics/events/summary`, {
        query,
        ...options,
      }) as Core.APIPromise<{ result: SummarySpectrumAnalyticsSummaryGetAnalyticsSummaryResponse | null }>
    )._thenUnwrap((obj) => obj.result);
  }
}

export type SummarySpectrumAnalyticsSummaryGetAnalyticsSummaryResponse = unknown | string;
