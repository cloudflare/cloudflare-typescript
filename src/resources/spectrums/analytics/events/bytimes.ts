...
export class Bytimes extends APIResource {
  ...
  ): Core.APIPromise<BytimeSpectrumAnalyticsByTimeGetAnalyticsByTimeResponse | null>;
  spectrumAnalyticsByTimeGetAnalyticsByTime(
    zone: string,
    options?: Core.RequestOptions,
  ): Core.APIPromise<BytimeSpectrumAnalyticsByTimeGetAnalyticsByTimeResponse | null>;
  spectrumAnalyticsByTimeGetAnalyticsByTime(
    ...
    return (
      this._client.get(`/zones/${zone}/spectrum/analytics/events/bytime`, {
        query,
        ...options,
      }) as Core.APIPromise<{ result: BytimeSpectrumAnalyticsByTimeGetAnalyticsByTimeResponse | null }>
    )._thenUnwrap((obj) => obj.result);
  }
}

export type BytimeSpectrumAnalyticsByTimeGetAnalyticsByTimeResponse = unknown | string;
