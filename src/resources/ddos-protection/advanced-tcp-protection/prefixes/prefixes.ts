...
export class BasePrefixes extends APIResource {
  static override readonly _key: readonly ['DDoSProtection', 'advancedTCPProtection', 'prefixes'] =
    Object.freeze(['DDoSProtection', 'advancedTCPProtection', 'prefixes'] as const);
   ...
   * ```
   */
  create(params: PrefixCreateParams, options?: RequestOptions): APIPromise<PrefixCreateResponse> {
    const { account_id, ...body } = params;
    return (
      this._client.post(path`/accounts/${account_id}/magic/advanced_tcp_protection/configs/prefixes`, {
        body,
        ...options,
      }) as APIPromise<{ result: PrefixCreateResponse }>
  ...
  ): PagePromise<PrefixListResponsesV4PagePaginationArray, PrefixListResponse> {
    const { account_id, ...query } = params;
    return this._client.getAPIList(
      path`/accounts/${account_id}/magic/advanced_tcp_protection/configs/prefixes`,
      V4PagePaginationArray<PrefixListResponse>,
      { query, ...options },
    );
  }
  ...
  bulkCreate(
    ...
    options?: RequestOptions,
  ): PagePromise<PrefixBulkCreateResponsesSinglePage, PrefixBulkCreateResponse> {
    const { account_id, body } = params;
    return this._client.getAPIList(
      path`/accounts/${account_id}/magic/advanced_tcp_protection/configs/prefixes/bulk`,
      SinglePage<PrefixBulkCreateResponse>,
   ...
   * ```
   */
  bulkDelete(params: PrefixBulkDeleteParams, options?: RequestOptions): APIPromise<PrefixBulkDeleteResponse> {
...
export type PrefixListResponsesV4PagePaginationArray = V4PagePaginationArray<PrefixListResponse>;

export type PrefixBulkCreateResponsesSinglePage = SinglePage<PrefixBulkCreateResponse>;
