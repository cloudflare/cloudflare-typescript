...
export class BaseItems extends APIResource {
  static override readonly _key: readonly ['DDoSProtection', 'advancedTCPProtection', 'prefixes', 'items'] =
    Object.freeze(['DDoSProtection', 'advancedTCPProtection', 'prefixes', 'items'] as const);
