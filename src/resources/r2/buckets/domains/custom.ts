...
export class Custom extends APIResource {
  ...
  update(
    ...
    return (
      this._client.put(path`/accounts/${account_id}/r2/buckets/${bucket_name}/domains/custom/${domainName}`, {
        body,
        ...options,
        headers: buildHeaders([
          {
  ...
  delete(
    ...
    return (
      this._client.delete(
        path`/accounts/${account_id}/r2/buckets/${bucket_name}/domains/custom/${domainName}`,
        {
          ...options,
          headers: buildHeaders([
            {
   ...
   */
  get(domainName: string, params: CustomGetParams, options?: RequestOptions): APIPromise<CustomGetResponse> {
    const { account_id, bucket_name, jurisdiction } = params;
    return (
      this._client.get(path`/accounts/${account_id}/r2/buckets/${bucket_name}/domains/custom/${domainName}`, {
        ...options,
        headers: buildHeaders([
          {
            ...(jurisdiction?.toString() != null ?
