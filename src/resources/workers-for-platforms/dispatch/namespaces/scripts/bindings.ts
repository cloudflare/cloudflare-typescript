...
export class Bindings extends APIResource {
  ...
  get(dispatchNamespace: string, scriptName: string, params: BindingGetParams, options?: Core.RequestOptions): Core.APIPromise<BindingGetResponse> {
    ...
    return (this._client.get(`/accounts/${account_id}/workers/dispatch/namespaces/${dispatchNamespace}/scripts/${scriptName}/bindings`, options) as Core.APIPromise<{ result: BindingGetResponse }>)._thenUnwrap((obj) => obj.result);
  }
}
