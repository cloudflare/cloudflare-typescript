...
export class DNSSEC extends APIResource {
   ...
   */
  edit(params: DNSSECEditParams, options?: Core.RequestOptions): Core.APIPromise<DNSSECEditResponse> {
   ...
   */
  get(params: DNSSECGetParams, options?: Core.RequestOptions): Core.APIPromise<DNSSECGetResponse> {
    const { zone_id } = params;
    return (
      this._client.get(`/zones/${zone_id}/dnssec`, options) as Core.APIPromise<{ result: DNSSECGetResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
}
