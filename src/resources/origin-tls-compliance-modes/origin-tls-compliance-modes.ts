...
export class BaseOriginTLSComplianceModes extends APIResource {
  static override readonly _key: readonly ['originTLSComplianceModes'] = Object.freeze([
  ...
  ): APIPromise<OriginTLSComplianceModeUpdateResponse> {
    const { zone_id, ...body } = params;
    return (
      this._client.put(path`/zones/${zone_id}/settings/origin_tls_compliance_modes`, {
        body,
        ...options,
      }) as APIPromise<{ result: OriginTLSComplianceModeUpdateResponse }>
  ...
  delete(
    ...
    options?: RequestOptions,
  ): APIPromise<OriginTLSComplianceModeDeleteResponse> {
    const { zone_id } = params;
    return (
      this._client.delete(
        path`/zones/${zone_id}/settings/origin_tls_compliance_modes`,
        options,
      ) as APIPromise<{ result: OriginTLSComplianceModeDeleteResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  edit(
    ...
    options?: RequestOptions,
  ): APIPromise<OriginTLSComplianceModeEditResponse> {
    const { zone_id, ...body } = params;
    return (
      this._client.patch(path`/zones/${zone_id}/settings/origin_tls_compliance_modes`, {
        body,
        ...options,
      }) as APIPromise<{ result: OriginTLSComplianceModeEditResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  get(
    ...
    options?: RequestOptions,
  ): APIPromise<OriginTLSComplianceModeGetResponse> {
    const { zone_id } = params;
    return (
      this._client.get(path`/zones/${zone_id}/settings/origin_tls_compliance_modes`, options) as APIPromise<{
        result: OriginTLSComplianceModeGetResponse;
      }>
    )._thenUnwrap((obj) => obj.result);
  }
}
export class OriginTLSComplianceModes extends BaseOriginTLSComplianceModes {}
