...
export class Memberships extends APIResource {
  ...
  update(
    ...
    return (
      this._client.put(path`/memberships/${membershipID}`, { body, ...options }) as APIPromise<{
  ...
  list(
    ...
    options?: RequestOptions,
  ): PagePromise<MembershipsV4PagePaginationArray, Membership> {
    return this._client.getAPIList('/memberships', V4PagePaginationArray<Membership>, { query, ...options });
  }
  ...
  delete(membershipID: string, options?: RequestOptions): APIPromise<MembershipDeleteResponse> {
    return (
      this._client.delete(path`/memberships/${membershipID}`, options) as APIPromise<{
  ...
  get(membershipID: string, options?: RequestOptions): APIPromise<MembershipGetResponse> {
    return (
      this._client.get(path`/memberships/${membershipID}`, options) as APIPromise<{
