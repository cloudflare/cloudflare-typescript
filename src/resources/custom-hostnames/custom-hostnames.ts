  ...
  edit(
    ...
    return (
      this._client.patch(path`/zones/${zone_id}/custom_hostnames/${customHostnameID}`, {
        body,
        ...options,
      }) as APIPromise<{ result: CustomHostnameEditResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
...
export type BundleMethod = unknown;

export type CustomHostname = unknown;

export type DCVMethod = unknown;

export type DomainValidationType = unknown;
...
export declare namespace CustomHostnames {
  export {
    ...
    type CustomHostnameListResponsesV4PagePaginationArray as CustomHostnameListResponsesV4PagePaginationArray,
