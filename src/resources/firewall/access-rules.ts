...
export class AccessRules extends APIResource {
  ...
  create(params: AccessRuleCreateParams, options?: RequestOptions): APIPromise<AccessRuleCreateResponse> {
    ...
    return (
      this._client.post(path`/${accountOrZone}/${accountOrZoneId}/firewall/access_rules/rules`, {
        body,
        ...options,
      }) as APIPromise<{ result: AccessRuleCreateResponse }>
  ...
  list(
    ...
    return this._client.getAPIList(
      ...
      V4PagePaginationArray<AccessRuleListResponse>,
      { query, ...options },
    );
  }
  ...
  delete(
    ...
    return (
      this._client.delete(
        ...
        options,
      ) as APIPromise<{ result: AccessRuleDeleteResponse | null }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  edit(
    ...
    return (
      this._client.patch(path`/${accountOrZone}/${accountOrZoneId}/firewall/access_rules/rules/${ruleID}`, {
        body,
        ...options,
      }) as APIPromise<{ result: AccessRuleEditResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  get(
    ...
    return (
      this._client.get(
        path`/${accountOrZone}/${accountOrZoneId}/firewall/access_rules/rules/${ruleID}`,
        options,
      ) as APIPromise<{ result: AccessRuleGetResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
}
