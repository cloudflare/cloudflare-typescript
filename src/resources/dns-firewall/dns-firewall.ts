...
export namespace DNSFirewall {
  ...
  export import DNSFirewallUpdateResponse = DNSFirewallAPI.DNSFirewallUpdateResponse;
  ...
  export import DNSFirewallUpdateParams = DNSFirewallAPI.DNSFirewallUpdateParams;
