...
import * as ReportsAPI from 'cloudflare/resources/dns-firewall/dns-analytics/reports/reports';
import * as BytimesAPI from 'cloudflare/resources/dns-firewall/dns-analytics/reports/bytimes';
