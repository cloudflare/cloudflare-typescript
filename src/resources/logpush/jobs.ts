...
export class Jobs extends APIResource {
  ...
  create(params: JobCreateParams, options?: RequestOptions): APIPromise<LogpushJob | null> {
    ...
    return (
      this._client.post(path`/${accountOrZone}/${accountOrZoneId}/logpush/jobs`, {
        body,
        ...options,
      }) as APIPromise<{ result: LogpushJob | null }>
  ...
  update(jobID: number, params: JobUpdateParams, options?: RequestOptions): APIPromise<LogpushJob | null> {
    ...
    return (
      this._client.put(path`/${accountOrZone}/${accountOrZoneId}/logpush/jobs/${jobID}`, {
        body,
        ...options,
      }) as APIPromise<{ result: LogpushJob | null }>
    )._thenUnwrap((obj) => obj.result);
  ...
  delete(
    ...
    return (
      this._client.delete(
        ...
        options,
      ) as APIPromise<{ result: JobDeleteResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
