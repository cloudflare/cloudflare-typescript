...
export class Validate extends APIResource {
  ...
  destination(
    ...
    return (
      this._client.post(path`/${accountOrZone}/${accountOrZoneId}/logpush/validate/destination`, {
        body,
        ...options,
      }) as APIPromise<{ result: ValidateDestinationResponse | null }>
  ...
  destinationExists(
    ...
    return (
      this._client.post(path`/${accountOrZone}/${accountOrZoneId}/logpush/validate/destination/exists`, {
        body,
        ...options,
      }) as APIPromise<{ result: ValidateDestinationExistsResponse | null }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  origin(params: ValidateOriginParams, options?: RequestOptions): APIPromise<ValidateOriginResponse | null> {
    ...
    return (
      this._client.post(path`/${accountOrZone}/${accountOrZoneId}/logpush/validate/origin`, {
        body,
        ...options,
      }) as APIPromise<{ result: ValidateOriginResponse | null }>
    )._thenUnwrap((obj) => obj.result);
  }
}
