...
export class BaseIdentityProviders extends APIResource {
  ...
  create(params: IdentityProviderCreateParams, options?: RequestOptions): APIPromise<IdentityProvider> {
    ...
    return (
      this._client.post(path`/${accountOrZone}/${accountOrZoneId}/access/identity_providers`, {
        body,
        ...options,
  ...
  delete(
    ...
    return (
      this._client.delete(
        path`/${accountOrZone}/${accountOrZoneId}/access/identity_providers/${identityProviderID}`,
        options,
      ) as APIPromise<{ result: IdentityProviderDeleteResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
...
export declare namespace IdentityProviders {
  ...
  export {
    ...
    BaseSAMLCertificate as BaseSAMLCertificate,
