...
export class Subnets extends APIResource {
  ...
  ): PagePromise<SubnetListResponsesV4PagePaginationArray, SubnetListResponse> {
    const { account_id, ...query } = params;
    return this._client.getAPIList(
      path`/accounts/${account_id}/zerotrust/subnets`,
      V4PagePaginationArray<SubnetListResponse>,
      { query, ...options },
    );
  }
}

export type SubnetListResponsesV4PagePaginationArray = V4PagePaginationArray<SubnetListResponse>;
