...
export class Organizations extends APIResource {
  ...
  create(params: OrganizationCreateParams, options?: RequestOptions): APIPromise<Organization> {
    ...
    return (
      this._client.post(path`/${accountOrZone}/${accountOrZoneId}/access/organizations`, {
        body,
        ...options,
  ...
  update(params: OrganizationUpdateParams, options?: RequestOptions): APIPromise<Organization> {
    ...
    return (
      this._client.put(path`/${accountOrZone}/${accountOrZoneId}/access/organizations`, {
        body,
        ...options,
      }) as APIPromise<{ result: Organization }>
    )._thenUnwrap((obj) => obj.result);
  ...
  revokeUsers(
    ...
    return (
      this._client.post(path`/${accountOrZone}/${accountOrZoneId}/access/organizations/revoke_user`, {
