...
export class ProxyEndpoints extends APIResource {
  ...
  create(params: ProxyEndpointCreateParams, options?: Core.RequestOptions): Core.APIPromise<ProxyEndpoint> {
    ...
    return (this._client.post(`/accounts/${account_id}/gateway/proxy_endpoints`, { body, ...options }) as Core.APIPromise<{ result: ProxyEndpoint }>)._thenUnwrap((obj) => obj.result);
  }
  ...
  list(params: ProxyEndpointListParams, options?: Core.RequestOptions): Core.APIPromise<ProxyEndpoint> {
    ...
    return (this._client.get(`/accounts/${account_id}/gateway/proxy_endpoints`, options) as Core.APIPromise<{ result: ProxyEndpoint }>)._thenUnwrap((obj) => obj.result);
  }
  ...
  delete(proxyEndpointId: string, params: ProxyEndpointDeleteParams, options?: Core.RequestOptions): Core.APIPromise<ProxyEndpointDeleteResponse> {
    const { account_id } = params;
    return (this._client.delete(`/accounts/${account_id}/gateway/proxy_endpoints/${proxyEndpointId}`, options) as Core.APIPromise<{ result: ProxyEndpointDeleteResponse }>)._thenUnwrap((obj) => obj.result);
  }
  ...
  edit(proxyEndpointId: string, params: ProxyEndpointEditParams, options?: Core.RequestOptions): Core.APIPromise<ProxyEndpoint> {
    const { account_id, ...body } = params;
    return (this._client.patch(`/accounts/${account_id}/gateway/proxy_endpoints/${proxyEndpointId}`, { body, ...options }) as Core.APIPromise<{ result: ProxyEndpoint }>)._thenUnwrap((obj) => obj.result);
  }
  ...
  get(proxyEndpointId: string, params: ProxyEndpointGetParams, options?: Core.RequestOptions): Core.APIPromise<ProxyEndpointGetResponse> {
    const { account_id } = params;
    return (this._client.get(`/accounts/${account_id}/gateway/proxy_endpoints/${proxyEndpointId}`, options) as Core.APIPromise<{ result: ProxyEndpointGetResponse }>)._thenUnwrap((obj) => obj.result);
  }
}
