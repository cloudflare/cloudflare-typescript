...
import {
  ...
  SchemaData,
  SchemaHTTP,
  SchemaHTTPSV4PagePaginationArray,
} from './dex-tests';
...
Devices.BaseDeploymentGroups = BaseDeploymentGroups;
...
export declare namespace Devices {
  ...
  export {
    ...
    BaseDeploymentGroups as BaseDeploymentGroups,
  ...
  export {
    ...
    type DevicePostureRulesSinglePage as DevicePostureRulesSinglePage,
