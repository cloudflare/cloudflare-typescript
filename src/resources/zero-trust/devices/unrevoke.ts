...
export class Unrevoke extends APIResource {
  ...
  create(params: UnrevokeCreateParams, options?: Core.RequestOptions): Core.APIPromise<UnrevokeCreateResponse | null> {
    ...
    return (this._client.post(`/accounts/${account_id}/devices/unrevoke`, { body: body, ...options }) as Core.APIPromise<{ result: UnrevokeCreateResponse | null }>)._thenUnwrap((obj) => obj.result);
  }
}
