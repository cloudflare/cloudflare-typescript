...
import { BaseGlobalWARPOverride, GlobalWARPOverride } from './global-warp-override';
...
export declare namespace Resilience {
  export { GlobalWARPOverride as GlobalWARPOverride, BaseGlobalWARPOverride as BaseGlobalWARPOverride };
}
