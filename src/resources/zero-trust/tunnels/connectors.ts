...
export class Connectors extends APIResource {
  ...
  get(tunnelId: string, connectorId: string, params: ConnectorGetParams, options?: Core.RequestOptions): Core.APIPromise<ConnectionsAPI.Client> {
    ...
    return (this._client.get(`/accounts/${account_id}/cfd_tunnel/${tunnelId}/connectors/${connectorId}`, options) as Core.APIPromise<{ result: ConnectionsAPI.Client }>)._thenUnwrap((obj) => obj.result);
  }
}
