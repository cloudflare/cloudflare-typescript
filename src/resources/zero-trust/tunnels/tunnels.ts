...
export class Tunnels extends APIResource {
   ...
   */
  create(params: TunnelCreateParams, options?: RequestOptions): APIPromise<TunnelCreateResponse> {
  ...
  delete(
    ...
    options?: RequestOptions,
  ): APIPromise<TunnelDeleteResponse> {
   ...
   */
  edit(tunnelID: string, params: TunnelEditParams, options?: RequestOptions): APIPromise<TunnelEditResponse> {
    const { account_id, ...body } = params;
    return (
      this._client.patch(path`/accounts/${account_id}/cfd_tunnel/${tunnelID}`, {
        body,
        ...options,
      }) as APIPromise<{ result: TunnelEditResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
   ...
   */
  get(tunnelID: string, params: TunnelGetParams, options?: RequestOptions): APIPromise<TunnelGetResponse> {
    const { account_id } = params;
    return (
