...
import { BaseResourceLibrary, ResourceLibrary } from './resource-library/resource-library';
...
ZeroTrust.BaseResourceLibrary = BaseResourceLibrary;
...
export declare namespace ZeroTrust {
  ...
  export { ResourceLibrary as ResourceLibrary, BaseResourceLibrary as BaseResourceLibrary };
}
