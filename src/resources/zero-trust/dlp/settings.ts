...
export class BaseSettings extends APIResource {
   ...
   * ```
   */
  edit(params: SettingEditParams | null | undefined = {}, options?: RequestOptions): APIPromise<DLPSettings> {
    const { account_id = this._client.accountID, ...body } = params ?? {};
    return (
   ...
   * ```
   */
  get(params: SettingGetParams | null | undefined = {}, options?: RequestOptions): APIPromise<DLPSettings> {
    const { account_id = this._client.accountID } = params ?? {};
    return (
