...
export class SmartShield extends APIResource {
   ...
   * ```
   */
  update(params: SmartShieldUpdateParams, options?: RequestOptions): APIPromise<SmartShieldUpdateResponse> {
    const { zone_id, ...body } = params;
    return (
      this._client.patch(path`/zones/${zone_id}/smart_shield`, { body, ...options }) as APIPromise<{
  ...
  ): APIPromise<SmartShieldCreateHealthcheckResponse> {
    const { zone_id, ...body } = params;
    return (
      this._client.post(path`/zones/${zone_id}/smart_shield/healthchecks`, {
        body,
        ...options,
      }) as APIPromise<{ result: SmartShieldCreateHealthcheckResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  deleteHealthcheck(
    ...
    options?: RequestOptions,
  ): APIPromise<SmartShieldDeleteHealthcheckResponse> {
    const { zone_id } = params;
    return (
      this._client.delete(
        path`/zones/${zone_id}/smart_shield/healthchecks/${healthcheckID}`,
        options,
      ) as APIPromise<{ result: SmartShieldDeleteHealthcheckResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  editHealthcheck(
    ...
    options?: RequestOptions,
  ): APIPromise<SmartShieldEditHealthcheckResponse> {
    const { zone_id, ...body } = params;
    return (
      this._client.patch(path`/zones/${zone_id}/smart_shield/healthchecks/${healthcheckID}`, {
        body,
        ...options,
      }) as APIPromise<{ result: SmartShieldEditHealthcheckResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
   ...
   * ```
   */
  get(params: SmartShieldGetParams, options?: RequestOptions): APIPromise<SmartShieldGetResponse> {
    const { zone_id } = params;
    return (
      this._client.get(path`/zones/${zone_id}/smart_shield`, options) as APIPromise<{
  ...
  getHealthcheck(
    ...
    options?: RequestOptions,
  ): APIPromise<SmartShieldGetHealthcheckResponse> {
    const { zone_id } = params;
    return (
      this._client.get(
        path`/zones/${zone_id}/smart_shield/healthchecks/${healthcheckID}`,
        options,
      ) as APIPromise<{ result: SmartShieldGetHealthcheckResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  > {
    ...
    return this._client.getAPIList(
      ...
      V4PagePaginationArray<SmartShieldListHealthchecksResponse>,
      { query, ...options },
    );
  }
  ...
  updateHealthcheck(
    ...
    options?: RequestOptions,
  ): APIPromise<SmartShieldUpdateHealthcheckResponse> {
    const { zone_id, ...body } = params;
    return (
      this._client.put(path`/zones/${zone_id}/smart_shield/healthchecks/${healthcheckID}`, {
        body,
        ...options,
      }) as APIPromise<{ result: SmartShieldUpdateHealthcheckResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
}

export type SmartShieldListHealthchecksResponsesV4PagePaginationArray =
  V4PagePaginationArray<SmartShieldListHealthchecksResponse>;
...
export declare namespace SmartShield {
  export {
    ...
    type SmartShieldListHealthchecksResponsesV4PagePaginationArray as SmartShieldListHealthchecksResponsesV4PagePaginationArray,
