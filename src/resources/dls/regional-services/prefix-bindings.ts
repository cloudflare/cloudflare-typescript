...
export class BasePrefixBindings extends APIResource {
  static override readonly _key: readonly ['dls', 'regionalServices', 'prefixBindings'] = Object.freeze([
    'dls',
    'regionalServices',
    'prefixBindings',
  ] as const);
  ...
  ): APIPromise<PrefixBindingCreateResponse> {
    const { account_id, ...body } = params;
    return (
      this._client.post(path`/accounts/${account_id}/dls/regional_services/prefix_bindings`, {
        body,
        ...options,
      }) as APIPromise<{ result: PrefixBindingCreateResponse }>
  ...
  list(
    ...
    options?: RequestOptions,
  ): PagePromise<PrefixBindingListResponsesCursorPagination, PrefixBindingListResponse> {
    const { account_id, ...query } = params;
    return this._client.getAPIList(
      path`/accounts/${account_id}/dls/regional_services/prefix_bindings`,
      CursorPagination<PrefixBindingListResponse>,
      { query, ...options },
    );
  }
  ...
  delete(
    ...
    options?: RequestOptions,
  ): APIPromise<PrefixBindingDeleteResponse> {
  ...
  edit(
    ...
    options?: RequestOptions,
  ): APIPromise<PrefixBindingEditResponse> {
    const { account_id, ...body } = params;
    return (
      this._client.patch(path`/accounts/${account_id}/dls/regional_services/prefix_bindings/${bindingID}`, {
        body,
        ...options,
      }) as APIPromise<{ result: PrefixBindingEditResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  get(
    ...
    options?: RequestOptions,
  ): APIPromise<PrefixBindingGetResponse> {
    const { account_id } = params;
    return (
      this._client.get(
        path`/accounts/${account_id}/dls/regional_services/prefix_bindings/${bindingID}`,
        options,
      ) as APIPromise<{ result: PrefixBindingGetResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
}
export class PrefixBindings extends BasePrefixBindings {}

export type PrefixBindingListResponsesCursorPagination = CursorPagination<PrefixBindingListResponse>;
