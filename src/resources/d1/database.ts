...
export type DatabaseQueryParams = DatabaseQueryParams.D1Query | DatabaseQueryParams.MultipleQueries;
...
export declare namespace DatabaseQueryParams {
  ...
  export interface MultipleQueries {
     ...
     * Body param:
     */
    body: Array<MultipleQueries.Body>;
  }
...
export type DatabaseRawParams = DatabaseRawParams.D1Query | DatabaseRawParams.MultipleQueries;
