...
export class BrowserRendering extends APIResource {
  ...
  content(
    accountID: string,
    params: BrowserRenderingContentParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<BrowserRenderingContentResponse> {
    const { cacheTTL, ...body } = params ?? {};
    return (
      this._client.post(path`/accounts/${accountID}/browser-rendering/content`, {
        query: { cacheTTL },
        body,
        ...options,
      }) as APIPromise<{ result: BrowserRenderingContentResponse }>
  ...
  pdf(
    accountID: string,
    params: BrowserRenderingPDFParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<Response> {
    const { cacheTTL, ...body } = params ?? {};
    return this._client.post(path`/accounts/${accountID}/browser-rendering/pdf`, {
      query: { cacheTTL },
      body,
      ...options,
  ...
  scrape(
    ...
    options?: RequestOptions,
  ): APIPromise<BrowserRenderingScrapeResponse> {
    const { cacheTTL, ...body } = params;
    return (
      this._client.post(path`/accounts/${accountID}/browser-rendering/scrape`, {
        query: { cacheTTL },
        body,
        ...options,
      }) as APIPromise<{ result: BrowserRenderingScrapeResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  screenshot(
    accountID: string,
    params: BrowserRenderingScreenshotParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<BrowserRenderingScreenshotResponse> {
    const { cacheTTL, ...body } = params ?? {};
    return this._client.post(path`/accounts/${accountID}/browser-rendering/screenshot`, {
      query: { cacheTTL },
      body,
      ...options,
    });
  ...
  snapshot(
    accountID: string,
    params: BrowserRenderingSnapshotParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<BrowserRenderingSnapshotResponse> {
    const { cacheTTL, ...body } = params ?? {};
    return (
      this._client.post(path`/accounts/${accountID}/browser-rendering/snapshot`, {
        query: { cacheTTL },
        body,
        ...options,
      }) as APIPromise<{ result: BrowserRenderingSnapshotResponse }>
    )._thenUnwrap((obj) => obj.result);
  }
}
