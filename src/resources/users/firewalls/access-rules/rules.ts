...
export class Rules extends APIResource {
  ...
  ipAccessRulesForAUserCreateAnIPAccessRule(
    ...
    options?: Core.RequestOptions,
  ): Core.APIPromise<RuleIPAccessRulesForAUserCreateAnIPAccessRuleResponse | null> {
    return (
      this._client.post('/user/firewall/access_rules/rules', { body, ...options }) as Core.APIPromise<{
        result: RuleIPAccessRulesForAUserCreateAnIPAccessRuleResponse | null;
      }>
    )._thenUnwrap((obj) => obj.result);
  }
  ...
  ipAccessRulesForAUserListIPAccessRules(
    ...
    options?: Core.RequestOptions,
  ): Core.APIPromise<RuleIPAccessRulesForAUserListIPAccessRulesResponse | null>;
  ipAccessRulesForAUserListIPAccessRules(
    options?: Core.RequestOptions,
  ): Core.APIPromise<RuleIPAccessRulesForAUserListIPAccessRulesResponse | null>;
  ipAccessRulesForAUserListIPAccessRules(
    ...
    return (
      this._client.get('/user/firewall/access_rules/rules', { query, ...options }) as Core.APIPromise<{
        result: RuleIPAccessRulesForAUserListIPAccessRulesResponse | null;
      }>
    )._thenUnwrap((obj) => obj.result);
  }
}
...
export interface RuleIPAccessRulesForAUserCreateAnIPAccessRuleResponse {
   ...
   */
  configuration:
    | RuleIPAccessRulesForAUserCreateAnIPAccessRuleResponse.LegacyJhsIPConfiguration
    | RuleIPAccessRulesForAUserCreateAnIPAccessRuleResponse.LegacyJhsIPV6Configuration
    | RuleIPAccessRulesForAUserCreateAnIPAccessRuleResponse.LegacyJhsCidrConfiguration
    | RuleIPAccessRulesForAUserCreateAnIPAccessRuleResponse.LegacyJhsAsnConfiguration
    | RuleIPAccessRulesForAUserCreateAnIPAccessRuleResponse.LegacyJhsCountryConfiguration;
...
export type RuleIPAccessRulesForAUserListIPAccessRulesResponse =
  Array<RuleIPAccessRulesForAUserListIPAccessRulesResponse.RuleIPAccessRulesForAUserListIPAccessRulesResponseItem>;

export namespace RuleIPAccessRulesForAUserListIPAccessRulesResponse {
  export interface RuleIPAccessRulesForAUserListIPAccessRulesResponseItem {
    /**
     * The unique identifier of the IP Access rule.
     */
    id: string;
     ...
     */
    configuration:
      | RuleIPAccessRulesForAUserListIPAccessRulesResponseItem.LegacyJhsIPConfiguration
      | RuleIPAccessRulesForAUserListIPAccessRulesResponseItem.LegacyJhsIPV6Configuration
      | RuleIPAccessRulesForAUserListIPAccessRulesResponseItem.LegacyJhsCidrConfiguration
      | RuleIPAccessRulesForAUserListIPAccessRulesResponseItem.LegacyJhsAsnConfiguration
      | RuleIPAccessRulesForAUserListIPAccessRulesResponseItem.LegacyJhsCountryConfiguration;
  ...
  export namespace RuleIPAccessRulesForAUserListIPAccessRulesResponseItem {
    export interface LegacyJhsIPConfiguration {
      /**
       * The configuration target. You must set the target to `ip` when specifying an IP
       * address in the rule.
...
export interface RuleIPAccessRulesForAUserCreateAnIPAccessRuleParams {
   ...
   */
  configuration:
    | RuleIPAccessRulesForAUserCreateAnIPAccessRuleParams.LegacyJhsIPConfiguration
    | RuleIPAccessRulesForAUserCreateAnIPAccessRuleParams.LegacyJhsIPV6Configuration
    | RuleIPAccessRulesForAUserCreateAnIPAccessRuleParams.LegacyJhsCidrConfiguration
    | RuleIPAccessRulesForAUserCreateAnIPAccessRuleParams.LegacyJhsAsnConfiguration
    | RuleIPAccessRulesForAUserCreateAnIPAccessRuleParams.LegacyJhsCountryConfiguration;
