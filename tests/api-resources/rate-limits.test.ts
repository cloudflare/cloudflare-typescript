...
import { BaseRateLimits } from 'cloudflare/resources/rate-limits/rate-limits';
...
const partialClient = createClient({
  ...
  apiEmail: 'user@example.com',
  baseURL: process.env['TEST_API_BASE_URL'] ?? 'http://127.0.0.1:4010',
  resources: [BaseRateLimits],
});

const runTests = (client: PartialCloudflare<{ rateLimits: BaseRateLimits }>) => {
...
describe('resource rateLimits', () => runTests(client));
describe('resource rateLimits (tree shakable, base)', () => runTests(partialClient));
