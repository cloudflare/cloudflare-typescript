...
import { DurableObjects } from 'cloudflare/resources/durable-objects/durable-objects';
import { BaseNamespaces } from 'cloudflare/resources/durable-objects/namespaces/namespaces';
...
const runTests = (client: PartialCloudflare<{ durableObjects: { namespaces: BaseNamespaces } }>) => {
