...
describe('resource ipv6', () => {
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = cloudflare.settings.ipv6.update('023e105f4ecef8ad9ca31a8372d0c353', {
      value: 'off',
    });
  ...
  test.skip('update: required and optional params', async () => {
    const response = await cloudflare.settings.ipv6.update('023e105f4ecef8ad9ca31a8372d0c353', {
      value: 'off',
    });
  });
