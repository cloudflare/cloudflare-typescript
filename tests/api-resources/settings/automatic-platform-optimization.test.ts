...
describe('resource automaticPlatformOptimization', () => {
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = cloudflare.settings.automaticPlatformOptimization.update(
  ...
  test.skip('update: required and optional params', async () => {
    const response = await cloudflare.settings.automaticPlatformOptimization.update(
      '023e105f4ecef8ad9ca31a8372d0c353',
      {
        value: {
          cache_by_device_type: false,
