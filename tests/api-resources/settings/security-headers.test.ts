...
describe('resource securityHeaders', () => {
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = cloudflare.settings.securityHeaders.update('023e105f4ecef8ad9ca31a8372d0c353', {
      value: {},
    });
  ...
  test.skip('update: required and optional params', async () => {
    const response = await cloudflare.settings.securityHeaders.update('023e105f4ecef8ad9ca31a8372d0c353', {
      value: {
