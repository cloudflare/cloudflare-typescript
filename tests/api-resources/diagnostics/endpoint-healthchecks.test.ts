...
import { Diagnostics } from 'cloudflare/resources/diagnostics/diagnostics';
import { BaseEndpointHealthchecks } from 'cloudflare/resources/diagnostics/endpoint-healthchecks';
...
const partialClient = createClient({
  ...
  apiEmail: 'user@example.com',
  baseURL: process.env['TEST_API_BASE_URL'] ?? 'http://127.0.0.1:4010',
  resources: [BaseEndpointHealthchecks],
});
...
const runTests = (
  client: PartialCloudflare<{ diagnostics: { endpointHealthchecks: BaseEndpointHealthchecks } }>,
) => {
...
describe('resource endpointHealthchecks', () => runTests(client));
describe('resource endpointHealthchecks (tree shakable, base)', () => runTests(partialClient));
describe('resource endpointHealthchecks (tree shakable, subresource)', () => runTests(parentPartialClient));
