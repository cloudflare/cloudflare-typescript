...
describe('resource routes', () => {
  ...
  test.skip('list', async () => {
    const responsePromise = cloudflare.magics.routes.list('023e105f4ecef8ad9ca31a8372d0c353');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('list: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      cloudflare.magics.routes.list('023e105f4ecef8ad9ca31a8372d0c353', { path: '/_stainless_unknown_path' }),
  ...
  test.skip('empty: only required params', async () => {
    const responsePromise = cloudflare.magics.routes.empty('023e105f4ecef8ad9ca31a8372d0c353', {
      routes: [{}, {}, {}],
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test.skip('empty: required and optional params', async () => {
    const response = await cloudflare.magics.routes.empty('023e105f4ecef8ad9ca31a8372d0c353', {
      routes: [{}, {}, {}],
    });
  });
