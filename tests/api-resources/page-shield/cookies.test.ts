...
import { BaseCookies } from 'cloudflare/resources/page-shield/cookies';
...
const runTests = (client: PartialCloudflare<{ pageShield: { cookies: BaseCookies } }>) => {
...
describe('resource cookies', () => runTests(client));
describe('resource cookies (tree shakable, base)', () => runTests(partialClient));
describe('resource cookies (tree shakable, subresource)', () => runTests(parentPartialClient));
