...
import { BaseMonitors } from 'cloudflare/resources/load-balancers/monitors/monitors';
...
const runTests = (client: PartialCloudflare<{ loadBalancers: { monitors: BaseMonitors } }>) => {
...
describe('resource monitors', () => runTests(client));
describe('resource monitors (tree shakable, base)', () => runTests(partialClient));
describe('resource monitors (tree shakable, subresource)', () => runTests(parentPartialClient));
