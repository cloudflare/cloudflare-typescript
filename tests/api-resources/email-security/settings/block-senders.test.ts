...
import { BaseBlockSenders } from 'cloudflare/resources/email-security/settings/block-senders';
...
const runTests = (
  client: PartialCloudflare<{ emailSecurity: { settings: { blockSenders: BaseBlockSenders } } }>,
) => {
...
describe('resource blockSenders', () => runTests(client));
describe('resource blockSenders (tree shakable, base)', () => runTests(partialClient));
describe('resource blockSenders (tree shakable, subresource)', () => runTests(parentPartialClient));
