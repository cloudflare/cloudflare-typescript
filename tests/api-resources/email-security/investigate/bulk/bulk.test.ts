...
import { BaseBulk } from 'cloudflare/resources/email-security/investigate/bulk/bulk';
...
const runTests = (client: PartialCloudflare<{ emailSecurity: { investigate: { bulk: BaseBulk } } }>) => {
  test('create: only required params', async () => {
    const responsePromise = client.emailSecurity.investigate.bulk.create({
  ...
  test('create: required and optional params', async () => {
    const response = await client.emailSecurity.investigate.bulk.create({
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
      action: 'MOVE',
      search_params: {
        action_log: true,
  ...
  test('list: only required params', async () => {
    const responsePromise = client.emailSecurity.investigate.bulk.list({
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test('list: required and optional params', async () => {
    const response = await client.emailSecurity.investigate.bulk.list({
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
      action_type: 'MOVE',
      page: 1,
      per_page: 20,
