...
import { BaseMove } from 'cloudflare/resources/email-security/investigate/move';
...
const runTests = (client: PartialCloudflare<{ emailSecurity: { investigate: { move: BaseMove } } }>) => {
