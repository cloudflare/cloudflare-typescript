...
import { BaseOverrides } from 'cloudflare/resources/firewall/waf/overrides';
...
const runTests = (client: PartialCloudflare<{ firewall: { waf: { overrides: BaseOverrides } } }>) => {
...
describe('resource overrides', () => runTests(client));
describe('resource overrides (tree shakable, base)', () => runTests(partialClient));
describe('resource overrides (tree shakable, subresource)', () => runTests(parentPartialClient));
