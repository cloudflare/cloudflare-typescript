...
import { BaseRules } from 'cloudflare/resources/firewall/waf/packages/rules';
...
const runTests = (client: PartialCloudflare<{ firewall: { waf: { packages: { rules: BaseRules } } } }>) => {
  ...
  test('edit: only required params', async () => {
    const responsePromise = client.firewall.waf.packages.rules.edit('a25a9a7e9c00afc1fb2e0245519d725b', {
      zone_id: '023e105f4ecef8ad9ca31a8372d0c353',
  ...
  test('get: only required params', async () => {
    const responsePromise = client.firewall.waf.packages.rules.get('a25a9a7e9c00afc1fb2e0245519d725b', {
      zone_id: '023e105f4ecef8ad9ca31a8372d0c353',
      package_id: 'a25a9a7e9c00afc1fb2e0245519d725b',
    });
    const rawResponse = await responsePromise.asResponse();
  ...
  test('get: required and optional params', async () => {
    const response = await client.firewall.waf.packages.rules.get('a25a9a7e9c00afc1fb2e0245519d725b', {
      zone_id: '023e105f4ecef8ad9ca31a8372d0c353',
      package_id: 'a25a9a7e9c00afc1fb2e0245519d725b',
    });
  });
