...
import { BaseEvents } from 'cloudflare/resources/waiting-rooms/events/events';
...
const runTests = (client: PartialCloudflare<{ waitingRooms: { events: BaseEvents } }>) => {
  ...
  test('update: only required params', async () => {
    const responsePromise = client.waitingRooms.events.update('25756b2dfe6e378a06b033b670413757', {
      zone_id: '023e105f4ecef8ad9ca31a8372d0c353',
  ...
  test('update: required and optional params', async () => {
    const response = await client.waitingRooms.events.update('25756b2dfe6e378a06b033b670413757', {
      zone_id: '023e105f4ecef8ad9ca31a8372d0c353',
      waiting_room_id: '699d98642c564d2e855e9661899b7252',
      event_end_time: '2021-09-28T17:00:00.000Z',
      event_start_time: '2021-09-28T15:30:00.000Z',
  ...
  test('delete: only required params', async () => {
    const responsePromise = client.waitingRooms.events.delete('25756b2dfe6e378a06b033b670413757', {
      zone_id: '023e105f4ecef8ad9ca31a8372d0c353',
      waiting_room_id: '699d98642c564d2e855e9661899b7252',
    });
    const rawResponse = await responsePromise.asResponse();
  ...
  test('delete: required and optional params', async () => {
    const response = await client.waitingRooms.events.delete('25756b2dfe6e378a06b033b670413757', {
      zone_id: '023e105f4ecef8ad9ca31a8372d0c353',
      waiting_room_id: '699d98642c564d2e855e9661899b7252',
    });
  });
  ...
  test('edit: only required params', async () => {
    const responsePromise = client.waitingRooms.events.edit('25756b2dfe6e378a06b033b670413757', {
      zone_id: '023e105f4ecef8ad9ca31a8372d0c353',
      waiting_room_id: '699d98642c564d2e855e9661899b7252',
      event_end_time: '2021-09-28T17:00:00.000Z',
      event_start_time: '2021-09-28T15:30:00.000Z',
  ...
  test('edit: required and optional params', async () => {
    const response = await client.waitingRooms.events.edit('25756b2dfe6e378a06b033b670413757', {
      zone_id: '023e105f4ecef8ad9ca31a8372d0c353',
      waiting_room_id: '699d98642c564d2e855e9661899b7252',
      event_end_time: '2021-09-28T17:00:00.000Z',
      event_start_time: '2021-09-28T15:30:00.000Z',
  ...
  test('get: only required params', async () => {
    const responsePromise = client.waitingRooms.events.get('25756b2dfe6e378a06b033b670413757', {
      zone_id: '023e105f4ecef8ad9ca31a8372d0c353',
      waiting_room_id: '699d98642c564d2e855e9661899b7252',
    });
    const rawResponse = await responsePromise.asResponse();
  ...
  test('get: required and optional params', async () => {
    const response = await client.waitingRooms.events.get('25756b2dfe6e378a06b033b670413757', {
      zone_id: '023e105f4ecef8ad9ca31a8372d0c353',
      waiting_room_id: '699d98642c564d2e855e9661899b7252',
    });
  });
