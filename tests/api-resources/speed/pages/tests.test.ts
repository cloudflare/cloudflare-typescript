...
import { Pages } from 'cloudflare/resources/speed/pages/pages';
import { BaseTests } from 'cloudflare/resources/speed/pages/tests';
...
const runTests = (client: PartialCloudflare<{ speed: { pages: { tests: BaseTests } } }>) => {
  ...
  test('get: only required params', async () => {
    const responsePromise = client.speed.pages.tests.get('test_id', {
      zone_id: '023e105f4ecef8ad9ca31a8372d0c353',
      url: 'example.com',
    });
    const rawResponse = await responsePromise.asResponse();
  ...
  test('get: required and optional params', async () => {
    const response = await client.speed.pages.tests.get('test_id', {
      zone_id: '023e105f4ecef8ad9ca31a8372d0c353',
      url: 'example.com',
    });
  });
