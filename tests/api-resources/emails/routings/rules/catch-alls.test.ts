...
describe('resource catchAlls', () => {
  ...
  test.skip('emailRoutingRoutingRulesGetCatchAllRule', async () => {
    const responsePromise =
      cloudflare.emails.routings.rules.catchAlls.emailRoutingRoutingRulesGetCatchAllRule(
  ...
  test.skip('emailRoutingRoutingRulesUpdateCatchAllRule: only required params', async () => {
    const responsePromise =
      cloudflare.emails.routings.rules.catchAlls.emailRoutingRoutingRulesUpdateCatchAllRule(
        '023e105f4ecef8ad9ca31a8372d0c353',
        {
  ...
  test.skip('emailRoutingRoutingRulesUpdateCatchAllRule: required and optional params', async () => {
    const response =
      await cloudflare.emails.routings.rules.catchAlls.emailRoutingRoutingRulesUpdateCatchAllRule(
        '023e105f4ecef8ad9ca31a8372d0c353',
        {
          actions: [
            {
