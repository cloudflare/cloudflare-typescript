...
import { BasePeers } from 'cloudflare/resources/dns/zone-transfers/peers';
...
const runTests = (client: PartialCloudflare<{ dns: { zoneTransfers: { peers: BasePeers } } }>) => {
...
describe('resource peers', () => runTests(client));
describe('resource peers (tree shakable, base)', () => runTests(partialClient));
describe('resource peers (tree shakable, subresource)', () => runTests(parentPartialClient));
