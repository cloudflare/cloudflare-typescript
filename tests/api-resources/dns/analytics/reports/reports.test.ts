...
import { Analytics } from 'cloudflare/resources/dns/analytics/analytics';
import { BaseReports } from 'cloudflare/resources/dns/analytics/reports/reports';
...
const runTests = (client: PartialCloudflare<{ dns: { analytics: { reports: BaseReports } } }>) => {
