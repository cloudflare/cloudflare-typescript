...
import { BaseIndicatorFeeds } from 'cloudflare/resources/intel/indicator-feeds/indicator-feeds';
...
const runTests = (client: PartialCloudflare<{ intel: { indicatorFeeds: BaseIndicatorFeeds } }>) => {
...
describe('resource indicatorFeeds', () => runTests(client));
describe('resource indicatorFeeds (tree shakable, base)', () => runTests(partialClient));
describe('resource indicatorFeeds (tree shakable, subresource)', () => runTests(parentPartialClient));
