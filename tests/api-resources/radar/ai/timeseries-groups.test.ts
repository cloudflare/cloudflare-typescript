...
import { BaseTimeseriesGroups } from 'cloudflare/resources/radar/ai/timeseries-groups';
...
const runTests = (
  client: PartialCloudflare<{ radar: { ai: { timeseriesGroups: BaseTimeseriesGroups } } }>,
) => {
  test('summary', async () => {
