...
import { Speed } from 'cloudflare/resources/radar/quality/speed/speed';
import { BaseTop } from 'cloudflare/resources/radar/quality/speed/top';
...
const runTests = (client: PartialCloudflare<{ radar: { quality: { speed: { top: BaseTop } } } }>) => {
  test('ases', async () => {
