...
describe('resource ases', () => {
  ...
  test('get: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.radar.http.ases.get({ path: '/_stainless_unknown_path' }))
      .rejects
