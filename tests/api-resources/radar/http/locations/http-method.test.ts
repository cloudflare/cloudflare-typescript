...
describe('resource httpMethod', () => {
  ...
  test('get: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.radar.http.locations.httpMethod.get('HTTPv1', { path: '/_stainless_unknown_path' }))
      .rejects
