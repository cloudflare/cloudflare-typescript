...
import { BaseLocations } from 'cloudflare/resources/radar/http/locations/locations';
...
const runTests = (client: PartialCloudflare<{ radar: { http: { locations: BaseLocations } } }>) => {
  test('get', async () => {
