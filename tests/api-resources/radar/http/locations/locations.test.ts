...
describe('resource locations', () => {
  ...
  test('get: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.radar.http.locations.get({ path: '/_stainless_unknown_path' }))
      .rejects
