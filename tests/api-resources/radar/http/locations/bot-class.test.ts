...
describe('resource botClass', () => {
  ...
  test('get: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.radar.http.locations.botClass.get('LIKELY_AUTOMATED', { path: '/_stainless_unknown_path' }))
      .rejects
