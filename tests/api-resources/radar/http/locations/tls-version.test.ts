...
import { BaseTLSVersion } from 'cloudflare/resources/radar/http/locations/tls-version';
...
const runTests = (
  client: PartialCloudflare<{ radar: { http: { locations: { tlsVersion: BaseTLSVersion } } } }>,
) => {
  test('get', async () => {
