...
describe('resource ipVersion', () => {
  ...
  test('get: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.radar.http.locations.ipVersion.get('IPv4', { path: '/_stainless_unknown_path' }))
      .rejects
