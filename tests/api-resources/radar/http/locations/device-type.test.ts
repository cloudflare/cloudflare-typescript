...
describe('resource deviceType', () => {
  ...
  test('get: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.radar.http.locations.deviceType.get('DESKTOP', { path: '/_stainless_unknown_path' }))
      .rejects
