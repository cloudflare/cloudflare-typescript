...
describe('resource browserFamily', () => {
  ...
  test('get: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.radar.http.locations.browserFamily.get('CHROME', { path: '/_stainless_unknown_path' }))
      .rejects
