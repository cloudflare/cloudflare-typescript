...
describe('resource os', () => {
  ...
  test('get: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.radar.http.locations.os.get('WINDOWS', { path: '/_stainless_unknown_path' }))
      .rejects
