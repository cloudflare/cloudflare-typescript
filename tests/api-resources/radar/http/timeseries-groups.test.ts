...
import { HTTP } from 'cloudflare/resources/radar/http/http';
import { BaseTimeseriesGroups } from 'cloudflare/resources/radar/http/timeseries-groups';
...
const runTests = (
  client: PartialCloudflare<{ radar: { http: { timeseriesGroups: BaseTimeseriesGroups } } }>,
) => {
  test('botClass', async () => {
