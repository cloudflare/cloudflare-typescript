...
describe('resource ases', () => {
  ...
  test.skip('list', async () => {
    const responsePromise = cloudflare.radar.bgp.tops.ases.list();
  ...
  test.skip('list: request options instead of params are passed correctly', async () => {
    ...
    await expect(cloudflare.radar.bgp.tops.ases.list({ path: '/_stainless_unknown_path' })).rejects.toThrow(
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      cloudflare.radar.bgp.tops.ases.list(
        {
