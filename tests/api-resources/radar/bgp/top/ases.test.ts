...
import { BaseAses } from 'cloudflare/resources/radar/bgp/top/ases';
import { Top } from 'cloudflare/resources/radar/bgp/top/top';
...
const runTests = (client: PartialCloudflare<{ radar: { bgp: { top: { ases: BaseAses } } } }>) => {
  test('get', async () => {
