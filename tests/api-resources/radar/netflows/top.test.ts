...
import { NetFlows } from 'cloudflare/resources/radar/netflows/netflows';
import { BaseTop } from 'cloudflare/resources/radar/netflows/top';
...
const runTests = (client: PartialCloudflare<{ radar: { netFlows: { top: BaseTop } } }>) => {
  test('ases', async () => {
