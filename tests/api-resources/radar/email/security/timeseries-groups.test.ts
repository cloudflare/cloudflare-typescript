...
import { BaseTimeseriesGroups } from 'cloudflare/resources/radar/email/security/timeseries-groups';
...
const runTests = (
  client: PartialCloudflare<{ radar: { email: { security: { timeseriesGroups: BaseTimeseriesGroups } } } }>,
) => {
  test('arc', async () => {
