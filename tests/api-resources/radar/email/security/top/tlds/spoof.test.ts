...
describe('resource spoof', () => {
  ...
  test('get: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.radar.email.security.top.tlds.spoof.get('SPOOF', { path: '/_stainless_unknown_path' }))
      .rejects
