...
describe('resource malicious', () => {
  ...
  test('get: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.radar.email.security.top.tlds.malicious.get('MALICIOUS', { path: '/_stainless_unknown_path' }))
      .rejects
