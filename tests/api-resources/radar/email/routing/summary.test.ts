...
import { BaseSummary } from 'cloudflare/resources/radar/email/routing/summary';
...
const runTests = (client: PartialCloudflare<{ radar: { email: { routing: { summary: BaseSummary } } } }>) => {
  test('arc', async () => {
