...
describe('resource layer3', () => {
  ...
  test('timeseries: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.radar.attacks.layer3.timeseries({ path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('timeseries: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.radar.attacks.layer3.timeseries({ aggInterval: '15m', asn: ['string', 'string', 'string'], continent: ['string', 'string', 'string'], dateEnd: ['2019-12-27T18:11:19.117Z', '2019-12-27T18:11:19.117Z', '2019-12-27T18:11:19.117Z'], dateRange: ['7d', '7d', '7d'], dateStart: ['2019-12-27T18:11:19.117Z', '2019-12-27T18:11:19.117Z', '2019-12-27T18:11:19.117Z'], direction: 'ORIGIN', format: 'JSON', ipVersion: ['IPv4', 'IPv6'], location: ['string', 'string', 'string'], metric: 'BYTES', name: ['string', 'string', 'string'], normalization: 'PERCENTAGE_CHANGE', protocol: ['UDP', 'TCP', 'ICMP'] }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Cloudflare.NotFoundError);
  });
});
