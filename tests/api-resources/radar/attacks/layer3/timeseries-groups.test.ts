...
import { Layer3 } from 'cloudflare/resources/radar/attacks/layer3/layer3';
import { BaseTimeseriesGroups } from 'cloudflare/resources/radar/attacks/layer3/timeseries-groups';
...
const runTests = (
  client: PartialCloudflare<{ radar: { attacks: { layer3: { timeseriesGroups: BaseTimeseriesGroups } } } }>,
) => {
  test('bitrate', async () => {
