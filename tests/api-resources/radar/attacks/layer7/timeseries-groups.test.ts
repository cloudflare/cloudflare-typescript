...
import { BaseTimeseriesGroups } from 'cloudflare/resources/radar/attacks/layer7/timeseries-groups';
...
const runTests = (
  client: PartialCloudflare<{ radar: { attacks: { layer7: { timeseriesGroups: BaseTimeseriesGroups } } } }>,
) => {
