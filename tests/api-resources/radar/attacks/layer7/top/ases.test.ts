...
describe('resource ases', () => {
  ...
  test('origin: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.radar.attacks.layer7.top.ases.origin({ path: '/_stainless_unknown_path' }))
      .rejects
