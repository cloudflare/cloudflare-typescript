...
import { BaseOAuthClients } from 'cloudflare/resources/iam/oauth-clients';
...
const runTests = (client: PartialCloudflare<{ iam: { oauthClients: BaseOAuthClients } }>) => {
...
describe('resource oauthClients', () => runTests(client));
describe('resource oauthClients (tree shakable, base)', () => runTests(partialClient));
describe('resource oauthClients (tree shakable, subresource)', () => runTests(parentPartialClient));
