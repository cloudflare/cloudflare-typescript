...
import { BasePermissionGroups } from 'cloudflare/resources/iam/permission-groups';
...
const runTests = (client: PartialCloudflare<{ iam: { permissionGroups: BasePermissionGroups } }>) => {
