...
import { Phases } from 'cloudflare/resources/rulesets/phases/phases';
import { BaseVersions } from 'cloudflare/resources/rulesets/phases/versions';
...
const runTests = (client: PartialCloudflare<{ rulesets: { phases: { versions: BaseVersions } } }>) => {
