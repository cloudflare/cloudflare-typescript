...
import { Rulesets } from 'cloudflare/resources/rulesets/rulesets';
import { BaseVersions } from 'cloudflare/resources/rulesets/versions';
...
const runTests = (client: PartialCloudflare<{ rulesets: { versions: BaseVersions } }>) => {
  ...
  test.skip('delete: only required params', async () => {
    const responsePromise = client.rulesets.versions.delete('1', {
  ...
  test.skip('get: only required params', async () => {
    const responsePromise = client.rulesets.versions.get('1', {
      ruleset_id: '2f2feab2026849078ba485f918791bdc',
      account_id: 'account_id',
    });
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('get: required and optional params', async () => {
    const response = await client.rulesets.versions.get('1', {
      ruleset_id: '2f2feab2026849078ba485f918791bdc',
      account_id: 'account_id',
    });
  });
