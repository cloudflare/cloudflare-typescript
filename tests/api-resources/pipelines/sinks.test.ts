...
import { BaseSinks } from 'cloudflare/resources/pipelines/sinks';
...
const runTests = (client: PartialCloudflare<{ pipelines: { sinks: BaseSinks } }>) => {
...
describe('resource sinks', () => runTests(client));
describe('resource sinks (tree shakable, base)', () => runTests(partialClient));
describe('resource sinks (tree shakable, subresource)', () => runTests(parentPartialClient));
