...
import { BaseOnRamps } from 'cloudflare/resources/magic-cloud-networking/on-ramps/on-ramps';
...
const runTests = (client: PartialCloudflare<{ magicCloudNetworking: { onRamps: BaseOnRamps } }>) => {
...
describe('resource onRamps', () => runTests(client));
describe('resource onRamps (tree shakable, base)', () => runTests(partialClient));
describe('resource onRamps (tree shakable, subresource)', () => runTests(parentPartialClient));
