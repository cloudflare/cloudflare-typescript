...
import { BaseBytimes } from 'cloudflare/resources/dns-firewall/analytics/reports/bytimes';
import { Reports } from 'cloudflare/resources/dns-firewall/analytics/reports/reports';
...
const runTests = (
  client: PartialCloudflare<{ dnsFirewall: { analytics: { reports: { bytimes: BaseBytimes } } } }>,
) => {
