...
import { BaseDNSFirewall } from 'cloudflare/resources/dns-firewall/dns-firewall';
...
const partialClient = createClient({
  ...
  apiEmail: 'user@example.com',
  baseURL: process.env['TEST_API_BASE_URL'] ?? 'http://127.0.0.1:4010',
  resources: [BaseDNSFirewall],
});

const runTests = (client: PartialCloudflare<{ dnsFirewall: BaseDNSFirewall }>) => {
...
describe('resource dnsFirewall', () => runTests(client));
describe('resource dnsFirewall (tree shakable, base)', () => runTests(partialClient));
