...
import { BaseSubscriptions } from 'cloudflare/resources/accounts/subscriptions/subscriptions';
...
const runTests = (client: PartialCloudflare<{ accounts: { subscriptions: BaseSubscriptions } }>) => {
  ...
  test('cancelDowngrade: only required params', async () => {
    const responsePromise = client.accounts.subscriptions.cancelDowngrade({
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test('cancelDowngrade: required and optional params', async () => {
    const response = await client.accounts.subscriptions.cancelDowngrade({
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
  ...
  test('getByIdentifier: only required params', async () => {
    const responsePromise = client.accounts.subscriptions.getByIdentifier(
  ...
  test('getByIdentifier: required and optional params', async () => {
    const response = await client.accounts.subscriptions.getByIdentifier('506e3185e9c882d175a2d0cb0093d9f2', {
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
    });
  });
};
