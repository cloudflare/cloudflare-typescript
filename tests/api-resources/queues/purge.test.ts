...
import { BasePurge } from 'cloudflare/resources/queues/purge';
...
const runTests = (client: PartialCloudflare<{ queues: { purge: BasePurge } }>) => {
...
describe('resource purge', () => runTests(client));
describe('resource purge (tree shakable, base)', () => runTests(partialClient));
describe('resource purge (tree shakable, subresource)', () => runTests(parentPartialClient));
