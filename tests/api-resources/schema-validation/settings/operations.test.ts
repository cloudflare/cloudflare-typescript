...
import { BaseOperations } from 'cloudflare/resources/schema-validation/settings/operations';
import { Settings } from 'cloudflare/resources/schema-validation/settings/settings';
...
const runTests = (
  client: PartialCloudflare<{ schemaValidation: { settings: { operations: BaseOperations } } }>,
) => {
