...
describe('resource validates', () => {
  ...
  test.skip('postAccountsAccountIdentifierLogpushOwnershipValidate: only required params', async () => {
    const responsePromise =
      cloudflare.logpush.ownerships.validates.postAccountsAccountIdentifierLogpushOwnershipValidate(
        'string',
  ...
  test.skip('postAccountsAccountIdentifierLogpushOwnershipValidate: required and optional params', async () => {
    const response =
      await cloudflare.logpush.ownerships.validates.postAccountsAccountIdentifierLogpushOwnershipValidate(
        'string',
        '023e105f4ecef8ad9ca31a8372d0c353',
        {
          destination_conf: 's3://mybucket/logs?region=us-west-2',
