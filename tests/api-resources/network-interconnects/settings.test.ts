...
import { BaseSettings } from 'cloudflare/resources/network-interconnects/settings';
...
const runTests = (client: PartialCloudflare<{ networkInterconnects: { settings: BaseSettings } }>) => {
