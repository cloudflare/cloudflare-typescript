...
import { BaseInterconnects } from 'cloudflare/resources/network-interconnects/interconnects';
...
const runTests = (
  client: PartialCloudflare<{ networkInterconnects: { interconnects: BaseInterconnects } }>,
) => {
...
describe('resource interconnects', () => runTests(client));
describe('resource interconnects (tree shakable, base)', () => runTests(partialClient));
describe('resource interconnects (tree shakable, subresource)', () => runTests(parentPartialClient));
