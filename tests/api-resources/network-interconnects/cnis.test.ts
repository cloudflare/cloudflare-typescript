...
import { BaseCNIs } from 'cloudflare/resources/network-interconnects/cnis';
...
const runTests = (client: PartialCloudflare<{ networkInterconnects: { cnis: BaseCNIs } }>) => {
...
describe('resource cnis', () => runTests(client));
describe('resource cnis (tree shakable, base)', () => runTests(partialClient));
describe('resource cnis (tree shakable, subresource)', () => runTests(parentPartialClient));
