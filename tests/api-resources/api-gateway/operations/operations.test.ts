...
import { BaseOperations } from 'cloudflare/resources/api-gateway/operations/operations';
...
const runTests = (client: PartialCloudflare<{ apiGateway: { operations: BaseOperations } }>) => {
