...
import { BaseOperation } from 'cloudflare/resources/api-gateway/labels/user/resources/operation';
import { Resources } from 'cloudflare/resources/api-gateway/labels/user/resources/resources';
...
const runTests = (
  client: PartialCloudflare<{
    apiGateway: { labels: { user: { resources: { operation: BaseOperation } } } };
  }>,
) => {
