...
import { BaseUser } from 'cloudflare/resources/api-gateway/labels/user/user';
...
const runTests = (client: PartialCloudflare<{ apiGateway: { labels: { user: BaseUser } } }>) => {
...
describe('resource user', () => runTests(client));
describe('resource user (tree shakable, base)', () => runTests(partialClient));
describe('resource user (tree shakable, subresource)', () => runTests(parentPartialClient));
