...
import { BaseConfigurations } from 'cloudflare/resources/api-gateway/configurations';
...
const runTests = (client: PartialCloudflare<{ apiGateway: { configurations: BaseConfigurations } }>) => {
