...
describe('resource smartRouting', () => {
  test('edit: only required params', async () => {
    const responsePromise = client.argo.smartRouting.edit({ zone_id: '023e105f4ecef8ad9ca31a8372d0c353', value: 'on' });
  ...
  test('edit: required and optional params', async () => {
    const response = await client.argo.smartRouting.edit({ zone_id: '023e105f4ecef8ad9ca31a8372d0c353', value: 'on' });
  });
