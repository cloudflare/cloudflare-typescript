...
describe('resource holds', () => {
  ...
  test('create: required and optional params', async () => {
    const response = await client.zones.holds.create({ zone_id: '023e105f4ecef8ad9ca31a8372d0c353', include_subdomains: true });
  });
  ...
  test('delete: required and optional params', async () => {
    const response = await client.zones.holds.delete({ zone_id: '023e105f4ecef8ad9ca31a8372d0c353', hold_after: 'hold_after' });
  });
