...
import { BaseContent } from 'cloudflare/resources/browser-rendering/content';
...
const runTests = (client: PartialCloudflare<{ browserRendering: { content: BaseContent } }>) => {
  test('create: only required params', async () => {
    const responsePromise = client.browserRendering.content.create({ account_id: 'account_id', url: 'url' });
