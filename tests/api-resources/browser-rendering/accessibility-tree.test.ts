...
import { BaseAccessibilityTree } from 'cloudflare/resources/browser-rendering/accessibility-tree';
...
const partialClient = createClient({
  ...
  apiEmail: 'user@example.com',
  baseURL: process.env['TEST_API_BASE_URL'] ?? 'http://127.0.0.1:4010',
  resources: [BaseAccessibilityTree],
});
...
describe('resource accessibilityTree', () => runTests(client));
describe('resource accessibilityTree (tree shakable, base)', () => runTests(partialClient));
describe('resource accessibilityTree (tree shakable, subresource)', () => runTests(parentPartialClient));
