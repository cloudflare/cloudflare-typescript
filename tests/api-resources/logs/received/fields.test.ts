...
import { BaseFields } from 'cloudflare/resources/logs/received/fields';
import { Received } from 'cloudflare/resources/logs/received/received';
...
const runTests = (client: PartialCloudflare<{ logs: { received: { fields: BaseFields } } }>) => {
