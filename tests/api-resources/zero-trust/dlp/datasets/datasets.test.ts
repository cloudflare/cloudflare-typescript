...
import { BaseDatasets } from 'cloudflare/resources/zero-trust/dlp/datasets/datasets';
...
const runTests = (client: PartialCloudflare<{ zeroTrust: { dlp: { datasets: BaseDatasets } } }>) => {
