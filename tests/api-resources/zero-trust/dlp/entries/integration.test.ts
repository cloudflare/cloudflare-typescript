...
import { BaseIntegration } from 'cloudflare/resources/zero-trust/dlp/entries/integration';
...
const runTests = (
  client: PartialCloudflare<{ zeroTrust: { dlp: { entries: { integration: BaseIntegration } } } }>,
) => {
...
describe('resource integration', () => runTests(client));
describe('resource integration (tree shakable, base)', () => runTests(partialClient));
describe('resource integration (tree shakable, subresource)', () => runTests(parentPartialClient));
