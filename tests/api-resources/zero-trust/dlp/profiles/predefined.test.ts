...
import { BasePredefined } from 'cloudflare/resources/zero-trust/dlp/profiles/predefined';
...
const runTests = (
  client: PartialCloudflare<{ zeroTrust: { dlp: { profiles: { predefined: BasePredefined } } } }>,
) => {
