...
import { BaseConfigurations } from 'cloudflare/resources/zero-trust/tunnels/cloudflared/configurations';
...
const runTests = (
  client: PartialCloudflare<{
    zeroTrust: { tunnels: { cloudflared: { configurations: BaseConfigurations } } };
  }>,
) => {
