...
import { BaseConnectors } from 'cloudflare/resources/zero-trust/tunnels/cloudflared/connectors';
...
const runTests = (
  client: PartialCloudflare<{ zeroTrust: { tunnels: { cloudflared: { connectors: BaseConnectors } } } }>,
) => {
