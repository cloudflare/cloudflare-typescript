...
import { BaseTunnels } from 'cloudflare/resources/zero-trust/tunnels/tunnels';
...
const runTests = (client: PartialCloudflare<{ zeroTrust: { tunnels: BaseTunnels } }>) => {
...
describe('resource tunnels', () => runTests(client));
describe('resource tunnels (tree shakable, base)', () => runTests(partialClient));
describe('resource tunnels (tree shakable, subresource)', () => runTests(parentPartialClient));
