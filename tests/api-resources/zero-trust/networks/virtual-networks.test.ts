...
import { BaseVirtualNetworks } from 'cloudflare/resources/zero-trust/networks/virtual-networks';
...
const runTests = (
  client: PartialCloudflare<{ zeroTrust: { networks: { virtualNetworks: BaseVirtualNetworks } } }>,
) => {
...
describe('resource virtualNetworks', () => runTests(client));
describe('resource virtualNetworks (tree shakable, base)', () => runTests(partialClient));
describe('resource virtualNetworks (tree shakable, subresource)', () => runTests(parentPartialClient));
