...
import { BaseRoutes } from 'cloudflare/resources/zero-trust/networks/routes/routes';
...
const runTests = (client: PartialCloudflare<{ zeroTrust: { networks: { routes: BaseRoutes } } }>) => {
