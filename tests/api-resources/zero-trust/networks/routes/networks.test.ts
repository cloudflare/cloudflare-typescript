...
import { BaseNetworks } from 'cloudflare/resources/zero-trust/networks/routes/networks';
...
const runTests = (
  client: PartialCloudflare<{ zeroTrust: { networks: { routes: { networks: BaseNetworks } } } }>,
) => {
...
describe('resource networks', () => runTests(client));
describe('resource networks (tree shakable, base)', () => runTests(partialClient));
describe('resource networks (tree shakable, subresource)', () => runTests(parentPartialClient));
