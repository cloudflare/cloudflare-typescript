...
import { BaseServers } from 'cloudflare/resources/zero-trust/access/ai-controls/mcp/servers';
...
const runTests = (
  client: PartialCloudflare<{ zeroTrust: { access: { aiControls: { mcp: { servers: BaseServers } } } } }>,
) => {
...
describe('resource servers', () => runTests(client));
describe('resource servers (tree shakable, base)', () => runTests(partialClient));
describe('resource servers (tree shakable, subresource)', () => runTests(parentPartialClient));
