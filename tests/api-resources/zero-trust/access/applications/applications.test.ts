...
import { BaseApplications } from 'cloudflare/resources/zero-trust/access/applications/applications';
...
const runTests = (
  client: PartialCloudflare<{ zeroTrust: { access: { applications: BaseApplications } } }>,
) => {
