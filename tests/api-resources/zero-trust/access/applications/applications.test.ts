...
describe('resource applications', () => {
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.zeroTrust.access.applications.create({
      ...
      destinations: [
        { destination: 'test.example.com/admin', type: 'public' },
        { destination: 'test.anotherexample.com/staff', type: 'public' },
        { destination: '10.5.0.2', type: 'public' },
        { destination: '10.5.0.3/32:1234-4321', type: 'public' },
        { destination: 'private-sni.example.com', type: 'public' },
      ],
