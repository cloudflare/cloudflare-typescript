...
import { Infrastructure } from 'cloudflare/resources/zero-trust/access/infrastructure/infrastructure';
import { BaseTargets } from 'cloudflare/resources/zero-trust/access/infrastructure/targets';
...
const runTests = (
  client: PartialCloudflare<{ zeroTrust: { access: { infrastructure: { targets: BaseTargets } } } }>,
) => {
