...
import { BaseServiceTokens } from 'cloudflare/resources/zero-trust/access/service-tokens';
...
const runTests = (
  client: PartialCloudflare<{ zeroTrust: { access: { serviceTokens: BaseServiceTokens } } }>,
) => {
...
describe('resource serviceTokens', () => runTests(client));
describe('resource serviceTokens (tree shakable, base)', () => runTests(partialClient));
describe('resource serviceTokens (tree shakable, subresource)', () => runTests(parentPartialClient));
