...
import { Certificates } from 'cloudflare/resources/zero-trust/access/certificates/certificates';
import { BaseSettings } from 'cloudflare/resources/zero-trust/access/certificates/settings';
...
const runTests = (
  client: PartialCloudflare<{ zeroTrust: { access: { certificates: { settings: BaseSettings } } } }>,
) => {
