...
import { BasePolicies } from 'cloudflare/resources/zero-trust/access/policies';
...
const runTests = (client: PartialCloudflare<{ zeroTrust: { access: { policies: BasePolicies } } }>) => {
