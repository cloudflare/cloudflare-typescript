...
import { BaseOrganizations } from 'cloudflare/resources/zero-trust/organizations/organizations';
...
const runTests = (client: PartialCloudflare<{ zeroTrust: { organizations: BaseOrganizations } }>) => {
