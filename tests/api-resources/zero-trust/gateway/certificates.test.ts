...
import { BaseCertificates } from 'cloudflare/resources/zero-trust/gateway/certificates';
...
const runTests = (
  client: PartialCloudflare<{ zeroTrust: { gateway: { certificates: BaseCertificates } } }>,
) => {
