...
describe('resource certificates', () => {
  ...
  test('activate: only required params', async () => {
    const responsePromise = cloudflare.zeroTrust.gateway.certificates.activate(
      'f174e90a-fafe-4643-bbbc-4a0ed4fc8415',
  ...
  test('activate: required and optional params', async () => {
    const response = await cloudflare.zeroTrust.gateway.certificates.activate(
      'f174e90a-fafe-4643-bbbc-4a0ed4fc8415',
      { account_id: '699d98642c564d2e855e9661899b7252', body: {} },
    );
  });
  ...
  test('deactivate: only required params', async () => {
    const responsePromise = cloudflare.zeroTrust.gateway.certificates.deactivate(
      'f174e90a-fafe-4643-bbbc-4a0ed4fc8415',
      { account_id: '699d98642c564d2e855e9661899b7252', body: {} },
    );
    const rawResponse = await responsePromise.asResponse();
  ...
  test('deactivate: required and optional params', async () => {
    const response = await cloudflare.zeroTrust.gateway.certificates.deactivate(
      'f174e90a-fafe-4643-bbbc-4a0ed4fc8415',
      { account_id: '699d98642c564d2e855e9661899b7252', body: {} },
    );
  });
