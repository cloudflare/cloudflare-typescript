...
import { BaseIntegrations } from 'cloudflare/resources/zero-trust/risk-scoring/integrations/integrations';
...
const runTests = (
  client: PartialCloudflare<{ zeroTrust: { riskScoring: { integrations: BaseIntegrations } } }>,
) => {
