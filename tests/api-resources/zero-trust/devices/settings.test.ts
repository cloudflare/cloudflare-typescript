...
import { BaseSettings } from 'cloudflare/resources/zero-trust/devices/settings';
...
const runTests = (client: PartialCloudflare<{ zeroTrust: { devices: { settings: BaseSettings } } }>) => {
