...
import { BaseRegistrations } from 'cloudflare/resources/zero-trust/devices/registrations';
...
const runTests = (
  client: PartialCloudflare<{ zeroTrust: { devices: { registrations: BaseRegistrations } } }>,
) => {
