...
import { BaseCustom } from 'cloudflare/resources/zero-trust/devices/policies/custom/custom';
...
const runTests = (
  client: PartialCloudflare<{ zeroTrust: { devices: { policies: { custom: BaseCustom } } } }>,
) => {
