...
import { BaseFallbackDomains } from 'cloudflare/resources/zero-trust/devices/policies/custom/fallback-domains';
...
const runTests = (
  client: PartialCloudflare<{
    zeroTrust: { devices: { policies: { custom: { fallbackDomains: BaseFallbackDomains } } } };
  }>,
) => {
