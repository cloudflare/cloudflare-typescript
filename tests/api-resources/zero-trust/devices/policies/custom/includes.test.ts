...
import { BaseIncludes } from 'cloudflare/resources/zero-trust/devices/policies/custom/includes';
...
const runTests = (
  client: PartialCloudflare<{ zeroTrust: { devices: { policies: { custom: { includes: BaseIncludes } } } } }>,
) => {
...
describe('resource includes', () => runTests(client));
describe('resource includes (tree shakable, base)', () => runTests(partialClient));
describe('resource includes (tree shakable, subresource)', () => runTests(parentPartialClient));
