...
import { BaseOverrideCodes } from 'cloudflare/resources/zero-trust/devices/override-codes';
...
const runTests = (
  client: PartialCloudflare<{ zeroTrust: { devices: { overrideCodes: BaseOverrideCodes } } }>,
) => {
...
describe('resource overrideCodes', () => runTests(client));
describe('resource overrideCodes (tree shakable, base)', () => runTests(partialClient));
describe('resource overrideCodes (tree shakable, subresource)', () => runTests(parentPartialClient));
