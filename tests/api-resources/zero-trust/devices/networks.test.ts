...
import { BaseNetworks } from 'cloudflare/resources/zero-trust/devices/networks';
...
const runTests = (client: PartialCloudflare<{ zeroTrust: { devices: { networks: BaseNetworks } } }>) => {
