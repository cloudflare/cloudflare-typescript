...
import { BaseDEXTests } from 'cloudflare/resources/zero-trust/devices/dex-tests';
...
const runTests = (client: PartialCloudflare<{ zeroTrust: { devices: { dexTests: BaseDEXTests } } }>) => {
...
describe('resource dexTests', () => runTests(client));
describe('resource dexTests (tree shakable, base)', () => runTests(partialClient));
describe('resource dexTests (tree shakable, subresource)', () => runTests(parentPartialClient));
