...
import { BasePosture } from 'cloudflare/resources/zero-trust/devices/posture/posture';
...
const runTests = (client: PartialCloudflare<{ zeroTrust: { devices: { posture: BasePosture } } }>) => {
...
describe('resource posture', () => runTests(client));
describe('resource posture (tree shakable, base)', () => runTests(partialClient));
describe('resource posture (tree shakable, subresource)', () => runTests(parentPartialClient));
