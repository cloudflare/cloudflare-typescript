...
import { BaseFleetStatus } from 'cloudflare/resources/zero-trust/dex/fleet-status/fleet-status';
...
const runTests = (client: PartialCloudflare<{ zeroTrust: { dex: { fleetStatus: BaseFleetStatus } } }>) => {
