...
import { BaseV1 } from 'cloudflare/resources/images/v1/v1';
...
const runTests = (client: PartialCloudflare<{ images: { v1: BaseV1 } }>) => {
...
describe('resource v1', () => runTests(client));
describe('resource v1 (tree shakable, base)', () => runTests(partialClient));
describe('resource v1 (tree shakable, subresource)', () => runTests(parentPartialClient));
