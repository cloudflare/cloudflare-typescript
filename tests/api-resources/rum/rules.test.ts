...
import { BaseRules } from 'cloudflare/resources/rum/rules';
import { RUM } from 'cloudflare/resources/rum/rum';
...
const runTests = (client: PartialCloudflare<{ rum: { rules: BaseRules } }>) => {
  ...
  test('update: only required params', async () => {
    const responsePromise = client.rum.rules.update('f174e90a-fafe-4643-bbbc-4a0ed4fc8415', {
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
  ...
  test('update: required and optional params', async () => {
    const response = await client.rum.rules.update('f174e90a-fafe-4643-bbbc-4a0ed4fc8415', {
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
      ruleset_id: 'f174e90a-fafe-4643-bbbc-4a0ed4fc8415',
      host: 'example.com',
      inclusive: true,
  ...
  test('delete: only required params', async () => {
    const responsePromise = client.rum.rules.delete('f174e90a-fafe-4643-bbbc-4a0ed4fc8415', {
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
      ruleset_id: 'f174e90a-fafe-4643-bbbc-4a0ed4fc8415',
    });
    const rawResponse = await responsePromise.asResponse();
  ...
  test('delete: required and optional params', async () => {
    const response = await client.rum.rules.delete('f174e90a-fafe-4643-bbbc-4a0ed4fc8415', {
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
      ruleset_id: 'f174e90a-fafe-4643-bbbc-4a0ed4fc8415',
    });
  });
