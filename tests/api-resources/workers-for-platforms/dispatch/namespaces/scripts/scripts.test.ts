...
import { Namespaces } from 'cloudflare/resources/workers-for-platforms/dispatch/namespaces/namespaces';
import { BaseScripts } from 'cloudflare/resources/workers-for-platforms/dispatch/namespaces/scripts/scripts';
...
const runTests = (
  client: PartialCloudflare<{ workersForPlatforms: { dispatch: { namespaces: { scripts: BaseScripts } } } }>,
) => {
