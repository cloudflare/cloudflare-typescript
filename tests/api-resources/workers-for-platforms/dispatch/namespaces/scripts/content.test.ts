...
import { BaseContent } from 'cloudflare/resources/workers-for-platforms/dispatch/namespaces/scripts/content';
...
const runTests = (
  client: PartialCloudflare<{
    workersForPlatforms: { dispatch: { namespaces: { scripts: { content: BaseContent } } } };
  }>,
) => {
