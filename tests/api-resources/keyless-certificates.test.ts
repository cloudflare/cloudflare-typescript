...
import { BaseKeylessCertificates } from 'cloudflare/resources/keyless-certificates/keyless-certificates';
...
const partialClient = createClient({
  ...
  apiEmail: 'user@example.com',
  baseURL: process.env['TEST_API_BASE_URL'] ?? 'http://127.0.0.1:4010',
  resources: [BaseKeylessCertificates],
});

const runTests = (client: PartialCloudflare<{ keylessCertificates: BaseKeylessCertificates }>) => {
...
describe('resource keylessCertificates', () => runTests(client));
describe('resource keylessCertificates (tree shakable, base)', () => runTests(partialClient));
