...
import { BaseDatasets } from 'cloudflare/resources/ai-gateway/datasets';
...
const runTests = (client: PartialCloudflare<{ aiGateway: { datasets: BaseDatasets } }>) => {
  ...
  test('update: only required params', async () => {
    const responsePromise = client.aiGateway.datasets.update('id', {
      account_id: '3ebbcb006d4d46d7bb6a8c7f14676cb0',
  ...
  test('update: required and optional params', async () => {
    const response = await client.aiGateway.datasets.update('id', {
      account_id: '3ebbcb006d4d46d7bb6a8c7f14676cb0',
      gateway_id: 'my-gateway',
      enable: true,
      filters: [
  ...
  test('delete: only required params', async () => {
    const responsePromise = client.aiGateway.datasets.delete('id', {
      account_id: '3ebbcb006d4d46d7bb6a8c7f14676cb0',
      gateway_id: 'my-gateway',
    });
    const rawResponse = await responsePromise.asResponse();
  ...
  test('delete: required and optional params', async () => {
    const response = await client.aiGateway.datasets.delete('id', {
      account_id: '3ebbcb006d4d46d7bb6a8c7f14676cb0',
      gateway_id: 'my-gateway',
    });
  });
  ...
  test('get: only required params', async () => {
    const responsePromise = client.aiGateway.datasets.get('id', {
      account_id: '3ebbcb006d4d46d7bb6a8c7f14676cb0',
      gateway_id: 'my-gateway',
    });
    const rawResponse = await responsePromise.asResponse();
  ...
  test('get: required and optional params', async () => {
    const response = await client.aiGateway.datasets.get('id', {
      account_id: '3ebbcb006d4d46d7bb6a8c7f14676cb0',
      gateway_id: 'my-gateway',
    });
  });
