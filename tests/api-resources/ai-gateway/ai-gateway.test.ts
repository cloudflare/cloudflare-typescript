...
import { BaseAIGateway } from 'cloudflare/resources/ai-gateway/ai-gateway';
...
const partialClient = createClient({
  ...
  apiEmail: 'user@example.com',
  baseURL: process.env['TEST_API_BASE_URL'] ?? 'http://127.0.0.1:4010',
  resources: [BaseAIGateway],
});

const runTests = (client: PartialCloudflare<{ aiGateway: BaseAIGateway }>) => {
...
describe('resource aiGateway', () => runTests(client));
describe('resource aiGateway (tree shakable, base)', () => runTests(partialClient));
