...
describe('resource domains', () => {
  ...
  test.skip('get: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      cloudflare.pages.projects.domains.get(
        '023e105f4ecef8ad9ca31a8372d0c353',
        'this-is-my-project-01',
        'string',
  ...
  test.skip('pagesDomainsAddDomain: only required params', async () => {
    const responsePromise = cloudflare.pages.projects.domains.pagesDomainsAddDomain(
      '023e105f4ecef8ad9ca31a8372d0c353',
      'this-is-my-project-01',
      { name: 'example.com' },
    );
  ...
  test.skip('pagesDomainsAddDomain: required and optional params', async () => {
    const response = await cloudflare.pages.projects.domains.pagesDomainsAddDomain(
      '023e105f4ecef8ad9ca31a8372d0c353',
      'this-is-my-project-01',
      { name: 'example.com' },
    );
  ...
  test.skip('pagesDomainsGetDomains', async () => {
    const responsePromise = cloudflare.pages.projects.domains.pagesDomainsGetDomains(
      '023e105f4ecef8ad9ca31a8372d0c353',
      'this-is-my-project-01',
    );
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('pagesDomainsGetDomains: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      cloudflare.pages.projects.domains.pagesDomainsGetDomains(
        '023e105f4ecef8ad9ca31a8372d0c353',
        'this-is-my-project-01',
        { path: '/_stainless_unknown_path' },
      ),
