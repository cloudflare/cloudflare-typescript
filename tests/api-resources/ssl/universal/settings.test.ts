...
import { BaseSettings } from 'cloudflare/resources/ssl/universal/settings';
import { Universal } from 'cloudflare/resources/ssl/universal/universal';
...
const runTests = (client: PartialCloudflare<{ ssl: { universal: { settings: BaseSettings } } }>) => {
