...
import { BaseCertificatePacks } from 'cloudflare/resources/ssl/certificate-packs/certificate-packs';
...
const partialClient = createClient({
  ...
  apiEmail: 'user@example.com',
  baseURL: process.env['TEST_API_BASE_URL'] ?? 'http://127.0.0.1:4010',
  resources: [BaseCertificatePacks],
});
...
const runTests = (client: PartialCloudflare<{ ssl: { certificatePacks: BaseCertificatePacks } }>) => {
...
describe('resource certificatePacks', () => runTests(client));
describe('resource certificatePacks (tree shakable, base)', () => runTests(partialClient));
describe('resource certificatePacks (tree shakable, subresource)', () => runTests(parentPartialClient));
