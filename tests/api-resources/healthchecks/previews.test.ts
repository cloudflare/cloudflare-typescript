...
import { Healthchecks } from 'cloudflare/resources/healthchecks/healthchecks';
import { BasePreviews } from 'cloudflare/resources/healthchecks/previews';
...
const runTests = (client: PartialCloudflare<{ healthchecks: { previews: BasePreviews } }>) => {
