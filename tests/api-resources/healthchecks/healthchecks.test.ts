...
import { BaseHealthchecks } from 'cloudflare/resources/healthchecks/healthchecks';
...
const partialClient = createClient({
  ...
  apiEmail: 'user@example.com',
  baseURL: process.env['TEST_API_BASE_URL'] ?? 'http://127.0.0.1:4010',
  resources: [BaseHealthchecks],
});

const runTests = (client: PartialCloudflare<{ healthchecks: BaseHealthchecks }>) => {
...
describe('resource healthchecks', () => runTests(client));
describe('resource healthchecks (tree shakable, base)', () => runTests(partialClient));
