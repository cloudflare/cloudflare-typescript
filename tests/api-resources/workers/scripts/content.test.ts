...
describe('resource content', () => {
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = client.workers.scripts.content.update('this-is_my_script-01', { account_id: '023e105f4ecef8ad9ca31a8372d0c353' });
