...
const runTests = (client: PartialCloudflare<{ workers: { scripts: { deployments: BaseDeployments } } }>) => {
  ...
  test('delete: only required params', async () => {
    const responsePromise = client.workers.scripts.deployments.delete(
      ...
      { account_id: '023e105f4ecef8ad9ca31a8372d0c353', script_name: 'this-is_my_script-01' },
    );
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
  ...
  test('delete: required and optional params', async () => {
    const response = await client.workers.scripts.deployments.delete('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
  ...
  test('get: only required params', async () => {
    const responsePromise = client.workers.scripts.deployments.get('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
      script_name: 'this-is_my_script-01',
    });
    const rawResponse = await responsePromise.asResponse();
  ...
  test('get: required and optional params', async () => {
    const response = await client.workers.scripts.deployments.get('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
      script_name: 'this-is_my_script-01',
    });
  });
