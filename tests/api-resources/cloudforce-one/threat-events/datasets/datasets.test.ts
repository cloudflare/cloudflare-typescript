...
import { BaseDatasets } from 'cloudflare/resources/cloudforce-one/threat-events/datasets/datasets';
...
const runTests = (
  client: PartialCloudflare<{ cloudforceOne: { threatEvents: { datasets: BaseDatasets } } }>,
) => {
