...
import { BaseRegionalHostnames } from 'cloudflare/resources/addressing/regional-hostnames/regional-hostnames';
...
const partialClient = createClient({
  ...
  apiEmail: 'user@example.com',
  baseURL: process.env['TEST_API_BASE_URL'] ?? 'http://127.0.0.1:4010',
  resources: [BaseRegionalHostnames],
});
...
const runTests = (
  client: PartialCloudflare<{ addressing: { regionalHostnames: BaseRegionalHostnames } }>,
) => {
...
describe('resource regionalHostnames', () => runTests(client));
describe('resource regionalHostnames (tree shakable, base)', () => runTests(partialClient));
describe('resource regionalHostnames (tree shakable, subresource)', () => runTests(parentPartialClient));
