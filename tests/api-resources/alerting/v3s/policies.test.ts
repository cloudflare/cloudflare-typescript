...
describe('resource policies', () => {
  ...
  test.skip('update', async () => {
    const responsePromise = cloudflare.alerting.v3s.policies.update(
  ...
  test.skip('delete', async () => {
    const responsePromise = cloudflare.alerting.v3s.policies.delete(
      '023e105f4ecef8ad9ca31a8372d0c353',
      '0da2b59e-f118-439d-8097-bdfb215203c9',
    );
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('delete: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      cloudflare.alerting.v3s.policies.delete(
        '023e105f4ecef8ad9ca31a8372d0c353',
        '0da2b59e-f118-439d-8097-bdfb215203c9',
  ...
  // skipped: tests are disabled for the time being
  test.skip('get', async () => {
    const responsePromise = cloudflare.alerting.v3s.policies.get(
      '023e105f4ecef8ad9ca31a8372d0c353',
      '0da2b59e-f118-439d-8097-bdfb215203c9',
    );
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('get: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      cloudflare.alerting.v3s.policies.get(
        '023e105f4ecef8ad9ca31a8372d0c353',
        '0da2b59e-f118-439d-8097-bdfb215203c9',
        { path: '/_stainless_unknown_path' },
      ),
  ...
  // skipped: tests are disabled for the time being
  test.skip('notificationPoliciesCreateANotificationPolicy: only required params', async () => {
    const responsePromise = cloudflare.alerting.v3s.policies.notificationPoliciesCreateANotificationPolicy(
      '023e105f4ecef8ad9ca31a8372d0c353',
      {
  ...
  // skipped: tests are disabled for the time being
  test.skip('notificationPoliciesCreateANotificationPolicy: required and optional params', async () => {
    const response = await cloudflare.alerting.v3s.policies.notificationPoliciesCreateANotificationPolicy(
      '023e105f4ecef8ad9ca31a8372d0c353',
      {
        alert_type: 'universal_ssl_event_type',
        enabled: true,
  ...
  // skipped: tests are disabled for the time being
  test.skip('notificationPoliciesListNotificationPolicies', async () => {
    const responsePromise = cloudflare.alerting.v3s.policies.notificationPoliciesListNotificationPolicies(
      '023e105f4ecef8ad9ca31a8372d0c353',
    );
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  // skipped: tests are disabled for the time being
  test.skip('notificationPoliciesListNotificationPolicies: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      cloudflare.alerting.v3s.policies.notificationPoliciesListNotificationPolicies(
        '023e105f4ecef8ad9ca31a8372d0c353',
        { path: '/_stainless_unknown_path' },
      ),
    ).rejects.toThrow(Cloudflare.NotFoundError);
