...
describe('resource webhooks', () => {
  test('update: only required params', async () => {
    const responsePromise = client.stream.webhooks.update({ account_id: '023e105f4ecef8ad9ca31a8372d0c353', notificationUrl: 'https://example.com' });
  ...
  test('update: required and optional params', async () => {
    const response = await client.stream.webhooks.update({ account_id: '023e105f4ecef8ad9ca31a8372d0c353', notificationUrl: 'https://example.com' });
  });
