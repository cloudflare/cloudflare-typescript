...
describe('resource outputs', () => {
  ...
  test('update: only required params', async () => {
    const responsePromise = client.stream.liveInputs.outputs.update('baea4d9c515887b80289d5c33cf01145', {
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
  ...
  test('update: required and optional params', async () => {
    const response = await client.stream.liveInputs.outputs.update('baea4d9c515887b80289d5c33cf01145', {
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
      live_input_identifier: '66be4bf738797e01e1fca35a7bdecdcd',
      enabled: true,
    });
  ...
  test.skip('delete: only required params', async () => {
    const responsePromise = client.stream.liveInputs.outputs.delete('baea4d9c515887b80289d5c33cf01145', {
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
      live_input_identifier: '66be4bf738797e01e1fca35a7bdecdcd',
    });
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('delete: required and optional params', async () => {
    const response = await client.stream.liveInputs.outputs.delete('baea4d9c515887b80289d5c33cf01145', {
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
      live_input_identifier: '66be4bf738797e01e1fca35a7bdecdcd',
    });
  });
