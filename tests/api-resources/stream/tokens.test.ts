...
describe('resource tokens', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = cloudflare.stream.tokens.create('ea95132c15732412d22c1476fa83f27a', {
  ...
  test.skip('create: required and optional params', async () => {
    const response = await cloudflare.stream.tokens.create('ea95132c15732412d22c1476fa83f27a', {
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
