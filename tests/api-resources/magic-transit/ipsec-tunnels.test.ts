...
import { BaseIPSECTunnels } from 'cloudflare/resources/magic-transit/ipsec-tunnels';
...
const runTests = (client: PartialCloudflare<{ magicTransit: { ipsecTunnels: BaseIPSECTunnels } }>) => {
...
describe('resource ipsecTunnels', () => runTests(client));
describe('resource ipsecTunnels (tree shakable, base)', () => runTests(partialClient));
describe('resource ipsecTunnels (tree shakable, subresource)', () => runTests(parentPartialClient));
