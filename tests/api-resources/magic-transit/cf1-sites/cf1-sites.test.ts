...
import { BaseCf1Sites } from 'cloudflare/resources/magic-transit/cf1-sites/cf1-sites';
...
const runTests = (client: PartialCloudflare<{ magicTransit: { cf1Sites: BaseCf1Sites } }>) => {
...
describe('resource cf1Sites', () => runTests(client));
describe('resource cf1Sites (tree shakable, base)', () => runTests(partialClient));
describe('resource cf1Sites (tree shakable, subresource)', () => runTests(parentPartialClient));
