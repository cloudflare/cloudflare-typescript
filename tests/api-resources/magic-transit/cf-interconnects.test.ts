...
import { BaseCfInterconnects } from 'cloudflare/resources/magic-transit/cf-interconnects';
...
const runTests = (client: PartialCloudflare<{ magicTransit: { cfInterconnects: BaseCfInterconnects } }>) => {
...
describe('resource cfInterconnects', () => runTests(client));
describe('resource cfInterconnects (tree shakable, base)', () => runTests(partialClient));
describe('resource cfInterconnects (tree shakable, subresource)', () => runTests(parentPartialClient));
