...
import { BaseConnectors } from 'cloudflare/resources/magic-transit/connectors/connectors';
...
const runTests = (client: PartialCloudflare<{ magicTransit: { connectors: BaseConnectors } }>) => {
