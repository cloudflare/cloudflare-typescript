...
import { BaseSites } from 'cloudflare/resources/magic-transit/sites/sites';
...
const runTests = (client: PartialCloudflare<{ magicTransit: { sites: BaseSites } }>) => {
...
describe('resource sites', () => runTests(client));
describe('resource sites (tree shakable, base)', () => runTests(partialClient));
describe('resource sites (tree shakable, subresource)', () => runTests(parentPartialClient));
