...
describe('resource recipients', () => {
  ...
  test('delete: only required params', async () => {
    const responsePromise = client.resourceSharing.recipients.delete('3fd85f74b32742f1bff64a85009dda07', {
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
  ...
  test('delete: required and optional params', async () => {
    const response = await client.resourceSharing.recipients.delete('3fd85f74b32742f1bff64a85009dda07', {
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
      share_id: '3fd85f74b32742f1bff64a85009dda07',
    });
  });
  ...
  test('get: only required params', async () => {
    const responsePromise = client.resourceSharing.recipients.get('3fd85f74b32742f1bff64a85009dda07', {
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
      share_id: '3fd85f74b32742f1bff64a85009dda07',
    });
    const rawResponse = await responsePromise.asResponse();
  ...
  test('get: required and optional params', async () => {
    const response = await client.resourceSharing.recipients.get('3fd85f74b32742f1bff64a85009dda07', {
      account_id: '023e105f4ecef8ad9ca31a8372d0c353',
      share_id: '3fd85f74b32742f1bff64a85009dda07',
    });
  });
