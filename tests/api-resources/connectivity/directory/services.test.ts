...
import { Directory } from 'cloudflare/resources/connectivity/directory/directory';
import { BaseServices } from 'cloudflare/resources/connectivity/directory/services';
...
const runTests = (client: PartialCloudflare<{ connectivity: { directory: { services: BaseServices } } }>) => {
