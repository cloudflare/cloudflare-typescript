...
describe('resource cacheReserve', () => {
  test('clear: only required params', async () => {
    const responsePromise = client.cache.cacheReserve.clear({ zone_id: '023e105f4ecef8ad9ca31a8372d0c353', body: '{}' });
  ...
  test('clear: required and optional params', async () => {
    const response = await client.cache.cacheReserve.clear({ zone_id: '023e105f4ecef8ad9ca31a8372d0c353', body: '{}' });
  });

  test('edit: only required params', async () => {
    const responsePromise = client.cache.cacheReserve.edit({ zone_id: '023e105f4ecef8ad9ca31a8372d0c353', value: 'on' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
