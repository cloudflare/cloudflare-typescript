...
describe('resource variants', () => {
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = cloudflare.cache.variants.update('023e105f4ecef8ad9ca31a8372d0c353', {
      value: {},
    });
  ...
  test.skip('update: required and optional params', async () => {
    const response = await cloudflare.cache.variants.update('023e105f4ecef8ad9ca31a8372d0c353', {
      value: {
