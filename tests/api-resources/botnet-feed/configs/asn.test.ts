...
import { BaseASN } from 'cloudflare/resources/botnet-feed/configs/asn';
import { Configs } from 'cloudflare/resources/botnet-feed/configs/configs';
...
const runTests = (client: PartialCloudflare<{ botnetFeed: { configs: { asn: BaseASN } } }>) => {
