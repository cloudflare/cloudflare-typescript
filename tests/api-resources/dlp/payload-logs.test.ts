...
describe('resource payloadLogs', () => {
  ...
  test.skip('replace: only required params', async () => {
    const responsePromise = cloudflare.dlp.payloadLogs.replace('023e105f4ecef8ad9ca31a8372d0c353', {
  ...
  test.skip('replace: required and optional params', async () => {
    const response = await cloudflare.dlp.payloadLogs.replace('023e105f4ecef8ad9ca31a8372d0c353', {
      public_key: 'EmpOvSXw8BfbrGCi0fhGiD/3yXk2SiV1Nzg2lru3oj0=',
    });
  });
});
