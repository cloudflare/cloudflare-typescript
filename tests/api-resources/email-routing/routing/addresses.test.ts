...
describe('resource addresses', () => {
  ...
  test.skip('list', async () => {
    const responsePromise = cloudflare.emailRouting.routing.addresses.list(
      '023e105f4ecef8ad9ca31a8372d0c353',
    );
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test.skip('list: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      cloudflare.emailRouting.routing.addresses.list('023e105f4ecef8ad9ca31a8372d0c353', {
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      cloudflare.emailRouting.routing.addresses.list(
        '023e105f4ecef8ad9ca31a8372d0c353',
