...
import { BaseEmailRouting } from 'cloudflare/resources/email-routing/email-routing';
...
describe('resource emailRouting', () => runTests(client));
describe('resource emailRouting (tree shakable, base)', () => runTests(partialClient));
