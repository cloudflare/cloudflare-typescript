...
import { BaseCustomNameservers } from 'cloudflare/resources/custom-nameservers/custom-nameservers';
...
const runTests = (client: PartialCloudflare<{ customNameservers: BaseCustomNameservers }>) => {
