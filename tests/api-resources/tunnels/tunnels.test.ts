...
describe('resource tunnels', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = cloudflare.tunnels.create('699d98642c564d2e855e9661899b7252', {
      name: 'blog',
      tunnel_secret: {},
    });
  ...
  test.skip('create: required and optional params', async () => {
    const response = await cloudflare.tunnels.create('699d98642c564d2e855e9661899b7252', {
      name: 'blog',
      tunnel_secret: {},
    });
  });
  ...
  test.skip('list: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      cloudflare.tunnels.list('699d98642c564d2e855e9661899b7252', { path: '/_stainless_unknown_path' }),
