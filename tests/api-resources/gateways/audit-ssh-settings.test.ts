...
describe('resource auditSSHSettings', () => {
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = cloudflare.gateways.auditSSHSettings.update('699d98642c564d2e855e9661899b7252', {
  ...
  test.skip('update: required and optional params', async () => {
    const response = await cloudflare.gateways.auditSSHSettings.update('699d98642c564d2e855e9661899b7252', {
      public_key: '1pyl6I1tL7xfJuFYVzXlUW8uXXlpxegHXBzGCBKaSFA=',
