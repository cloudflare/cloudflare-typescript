...
describe('resource rules', () => {
  ...
  test.skip('zeroTrustGatewayRulesCreateZeroTrustGatewayRule: only required params', async () => {
    const responsePromise = cloudflare.gateways.rules.zeroTrustGatewayRulesCreateZeroTrustGatewayRule(
      '699d98642c564d2e855e9661899b7252',
      { action: 'allow', name: 'block bad websites' },
    );
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('zeroTrustGatewayRulesCreateZeroTrustGatewayRule: required and optional params', async () => {
    const response = await cloudflare.gateways.rules.zeroTrustGatewayRulesCreateZeroTrustGatewayRule(
      '699d98642c564d2e855e9661899b7252',
      {
        action: 'allow',
        name: 'block bad websites',
  ...
  test.skip('zeroTrustGatewayRulesListZeroTrustGatewayRules', async () => {
    const responsePromise = cloudflare.gateways.rules.zeroTrustGatewayRulesListZeroTrustGatewayRules(
      '699d98642c564d2e855e9661899b7252',
    );
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test.skip('zeroTrustGatewayRulesListZeroTrustGatewayRules: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      cloudflare.gateways.rules.zeroTrustGatewayRulesListZeroTrustGatewayRules(
        '699d98642c564d2e855e9661899b7252',
        { path: '/_stainless_unknown_path' },
      ),
    ).rejects.toThrow(Cloudflare.NotFoundError);
