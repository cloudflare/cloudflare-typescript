...
describe('resource configurations', () => {
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = cloudflare.gateways.configurations.update({
  ...
  test.skip('update: required and optional params', async () => {
    const response = await cloudflare.gateways.configurations.update({
      account_id: '699d98642c564d2e855e9661899b7252',
      settings: {
  ...
  test.skip('edit: only required params', async () => {
    const responsePromise = cloudflare.gateways.configurations.edit({
      account_id: '699d98642c564d2e855e9661899b7252',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test.skip('edit: required and optional params', async () => {
    const response = await cloudflare.gateways.configurations.edit({
      account_id: '699d98642c564d2e855e9661899b7252',
      settings: {
        activity_log: { enabled: true },
        antivirus: {
  ...
  test.skip('get: only required params', async () => {
    const responsePromise = cloudflare.gateways.configurations.get({
      account_id: '699d98642c564d2e855e9661899b7252',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test.skip('get: required and optional params', async () => {
    const response = await cloudflare.gateways.configurations.get({
      account_id: '699d98642c564d2e855e9661899b7252',
    });
  });
});
