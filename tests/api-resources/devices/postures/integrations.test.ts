...
describe('resource integrations', () => {
  ...
  test.skip('devicePostureIntegrationsCreateDevicePostureIntegration: only required params', async () => {
    const responsePromise =
      cloudflare.devices.postures.integrations.devicePostureIntegrationsCreateDevicePostureIntegration(
        '699d98642c564d2e855e9661899b7252',
        {
          config: {
  ...
  test.skip('devicePostureIntegrationsCreateDevicePostureIntegration: required and optional params', async () => {
    const response =
      await cloudflare.devices.postures.integrations.devicePostureIntegrationsCreateDevicePostureIntegration(
        '699d98642c564d2e855e9661899b7252',
        {
          config: {
            api_url: 'https://as123.awmdm.com/API',
  ...
  test.skip('devicePostureIntegrationsListDevicePostureIntegrations', async () => {
    const responsePromise =
      cloudflare.devices.postures.integrations.devicePostureIntegrationsListDevicePostureIntegrations(
        '699d98642c564d2e855e9661899b7252',
      );
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
