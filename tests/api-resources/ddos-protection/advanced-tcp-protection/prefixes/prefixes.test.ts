...
import { BasePrefixes } from 'cloudflare/resources/ddos-protection/advanced-tcp-protection/prefixes/prefixes';
...
const runTests = (
  client: PartialCloudflare<{ DDoSProtection: { advancedTCPProtection: { prefixes: BasePrefixes } } }>,
) => {
