...
describe('resource bytimes', () => {
  test('get', async () => {
    const responsePromise = client.spectrum.analytics.events.bytimes.get('023e105f4ecef8ad9ca31a8372d0c353');
  ...
  test('get: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.spectrum.analytics.events.bytimes.get('023e105f4ecef8ad9ca31a8372d0c353', {
