...
describe('resource serviceTokens', () => {
  ...
  test.skip('delete', async () => {
    const responsePromise = cloudflare.access.serviceTokens.delete(
      'string',
      '023e105f4ecef8ad9ca31a8372d0c353',
      'f174e90a-fafe-4643-bbbc-4a0ed4fc8415',
    );
  ...
  test.skip('accessServiceTokensCreateAServiceToken: only required params', async () => {
    const responsePromise = cloudflare.access.serviceTokens.accessServiceTokensCreateAServiceToken(
      'string',
      '023e105f4ecef8ad9ca31a8372d0c353',
      { name: 'CI/CD token' },
    );
  ...
  test.skip('accessServiceTokensCreateAServiceToken: required and optional params', async () => {
    const response = await cloudflare.access.serviceTokens.accessServiceTokensCreateAServiceToken(
      'string',
      '023e105f4ecef8ad9ca31a8372d0c353',
  ...
  test.skip('accessServiceTokensListServiceTokens', async () => {
    const responsePromise = cloudflare.access.serviceTokens.accessServiceTokensListServiceTokens(
      'string',
      '023e105f4ecef8ad9ca31a8372d0c353',
    );
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('accessServiceTokensListServiceTokens: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      cloudflare.access.serviceTokens.accessServiceTokensListServiceTokens(
        'string',
        '023e105f4ecef8ad9ca31a8372d0c353',
        { path: '/_stainless_unknown_path' },
      ),
