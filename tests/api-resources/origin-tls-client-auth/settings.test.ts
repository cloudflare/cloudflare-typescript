...
describe('resource settings', () => {
  ...
  test.skip('zoneLevelAuthenticatedOriginPullsGetEnablementSettingForZone', async () => {
    const responsePromise =
      cloudflare.originTLSClientAuth.settings.zoneLevelAuthenticatedOriginPullsGetEnablementSettingForZone(
  ...
  test.skip('zoneLevelAuthenticatedOriginPullsSetEnablementForZone: only required params', async () => {
    const responsePromise =
      cloudflare.originTLSClientAuth.settings.zoneLevelAuthenticatedOriginPullsSetEnablementForZone(
        '023e105f4ecef8ad9ca31a8372d0c353',
        { enabled: true },
      );
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('zoneLevelAuthenticatedOriginPullsSetEnablementForZone: required and optional params', async () => {
    const response =
      await cloudflare.originTLSClientAuth.settings.zoneLevelAuthenticatedOriginPullsSetEnablementForZone(
        '023e105f4ecef8ad9ca31a8372d0c353',
        { enabled: true },
      );
  });
