...
import { BaseSettings } from 'cloudflare/resources/origin-tls-client-auth/settings';
...
const runTests = (client: PartialCloudflare<{ originTLSClientAuth: { settings: BaseSettings } }>) => {
