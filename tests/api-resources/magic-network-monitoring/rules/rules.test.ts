...
import { BaseRules } from 'cloudflare/resources/magic-network-monitoring/rules/rules';
...
const runTests = (client: PartialCloudflare<{ magicNetworkMonitoring: { rules: BaseRules } }>) => {
