...
describe('resource tenantCustomNameservers', () => {
  ...
  test('delete', async () => {
    const responsePromise = client.tenantCustomNameservers.delete(
  ...
  test('delete: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.tenantCustomNameservers.delete('699d98642c564d2e855e9661899b7252', 'ns1.example.com', {
  ...
  test('get: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.tenantCustomNameservers.get('699d98642c564d2e855e9661899b7252', {
        path: '/_stainless_unknown_path',
      }),
    ).rejects.toThrow(Cloudflare.NotFoundError);
  });
