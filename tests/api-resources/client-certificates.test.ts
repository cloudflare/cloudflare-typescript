...
import { BaseClientCertificates } from 'cloudflare/resources/client-certificates/client-certificates';
...
const partialClient = createClient({
  ...
  apiEmail: 'user@example.com',
  baseURL: process.env['TEST_API_BASE_URL'] ?? 'http://127.0.0.1:4010',
  resources: [BaseClientCertificates],
});

const runTests = (client: PartialCloudflare<{ clientCertificates: BaseClientCertificates }>) => {
...
describe('resource clientCertificates', () => runTests(client));
describe('resource clientCertificates (tree shakable, base)', () => runTests(partialClient));
