...
- `create_directory_connectivity_services` (`write`): Create connectivity service
- `update_directory_connectivity_services` (`write`): Update connectivity service
- `list_directory_connectivity_services` (`read`): List connectivity services
- `delete_directory_connectivity_services` (`write`): Delete connectivity service
- `get_directory_connectivity_services` (`read`): Get connectivity service
