...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['account_id', 'name', 'zones'],
  },
  annotations: {},
};
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.dns.settings.account.views.create(body)),
    );
  } catch (error) {
