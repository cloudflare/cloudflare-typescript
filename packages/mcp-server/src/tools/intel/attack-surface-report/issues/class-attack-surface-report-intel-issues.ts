...
export const tool: Tool = {
  name: 'class_attack_surface_report_intel_issues',
  description: 'Get Security Center Issue Counts by Class',
  inputSchema: {
    type: 'object',
    properties: {
      account_id: {
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.intel.attackSurfaceReport.issues.class(body));
};
