...
export const tool: Tool = {
  name: 'timeseries_groups_v2_radar_as112',
  description: 'Retrieves the distribution of AS112 queries grouped by dimension over time.',
  inputSchema: {
    type: 'object',
    properties: {
      dimension: {
        ...
        enum: ['DNSSEC', 'EDNS', 'IP_VERSION', 'PROTOCOL', 'QUERY_TYPE', 'RESPONSE_CODE'],
      },
      aggInterval: {
        type: 'string',
        description:
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.radar.as112.timeseriesGroupsV2(dimension, body));
};
