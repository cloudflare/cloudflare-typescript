...
export const tool: Tool = {
  name: 'timeseries_groups_v2_attacks_radar_layer3',
  description: 'Retrieves the distribution of layer 3 attacks grouped by dimension over time.',
  inputSchema: {
    type: 'object',
    properties: {
      dimension: {
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await client.radar.attacks.layer3.timeseriesGroupsV2(dimension, body));
  } catch (error) {
