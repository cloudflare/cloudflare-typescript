...
export const tool: Tool = {
  name: 'managed_rules_layer7_attacks_radar_summary',
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.radar.attacks.layer7.summary.managedRules(body));
};
