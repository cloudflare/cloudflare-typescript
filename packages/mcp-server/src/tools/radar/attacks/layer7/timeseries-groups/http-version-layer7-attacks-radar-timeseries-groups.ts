...
export const tool: Tool = {
  name: 'http_version_layer7_attacks_radar_timeseries_groups',
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.radar.attacks.layer7.timeseriesGroups.httpVersion(body));
};
