...
export const tool: Tool = {
  name: 'summary_v2_attacks_radar_layer7',
  description: 'Retrieves the distribution of layer 7 attacks by the specified dimension.',
  inputSchema: {
    type: 'object',
    properties: {
      dimension: {
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await client.radar.attacks.layer7.summaryV2(dimension, body));
  } catch (error) {
