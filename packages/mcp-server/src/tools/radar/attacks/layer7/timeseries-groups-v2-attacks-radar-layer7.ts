...
export const tool: Tool = {
  name: 'timeseries_groups_v2_attacks_radar_layer7',
  description: 'Retrieves the distribution of layer 7 attacks grouped by dimension over time.',
  inputSchema: {
    type: 'object',
    properties: {
      dimension: {
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.radar.attacks.layer7.timeseriesGroupsV2(dimension, body));
};
