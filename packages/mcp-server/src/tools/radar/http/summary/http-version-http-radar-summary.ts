...
export const tool: Tool = {
  name: 'http_version_http_radar_summary',
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.radar.http.summary.httpVersion(body));
};
