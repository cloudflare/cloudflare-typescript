...
export const tool: Tool = {
  name: 'get_locations_http_radar_device_type',
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.radar.http.locations.deviceType.get(device_type, body));
};
