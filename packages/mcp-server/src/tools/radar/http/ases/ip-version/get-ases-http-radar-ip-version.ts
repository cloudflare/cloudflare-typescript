...
export const tool: Tool = {
  name: 'get_ases_http_radar_ip_version',
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.radar.http.ases.ipVersion.get(ip_version, body));
};
