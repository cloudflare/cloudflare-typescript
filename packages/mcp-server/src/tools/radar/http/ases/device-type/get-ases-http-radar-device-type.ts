...
export const tool: Tool = {
  name: 'get_ases_http_radar_device_type',
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.radar.http.ases.deviceType.get(device_type, body));
};
