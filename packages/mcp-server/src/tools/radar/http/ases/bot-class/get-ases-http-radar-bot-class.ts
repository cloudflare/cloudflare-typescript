...
export const tool: Tool = {
  name: 'get_ases_http_radar_bot_class',
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.radar.http.ases.botClass.get(bot_class, body));
};
