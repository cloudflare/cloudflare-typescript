...
export const tool: Tool = {
  ...
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nCreate an entry in impersonation registry\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/impersonation_registry_create_response',\n  $defs: {\n    impersonation_registry_create_response: {\n      type: 'object',\n      properties: {\n        id: {\n          type: 'integer',\n          title: 'identifier'\n        },\n        created_at: {\n          type: 'string',\n          format: 'date-time'\n        },\n        email: {\n          type: 'string'\n        },\n        is_email_regex: {\n          type: 'boolean'\n        },\n        last_modified: {\n          type: 'string',\n          format: 'date-time'\n        },\n        name: {\n          type: 'string'\n        },\n        comments: {\n          type: 'string'\n        },\n        directory_id: {\n          type: 'integer'\n        },\n        directory_node_id: {\n          type: 'integer'\n        },\n        external_directory_node_id: {\n          type: 'string'\n        },\n        provenance: {\n          type: 'string'\n        }\n      },\n      required: [        'id',\n        'created_at',\n        'email',\n        'is_email_regex',\n        'last_modified',\n        'name'\n      ]\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      account_id: {
    ...
    required: ['account_id', 'email', 'is_email_regex', 'name'],
  },
  annotations: {},
};
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.emailSecurity.settings.impersonationRegistry.create(body)),
    );
  } catch (error) {
