...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.accounts.tokens.permissionGroups.list(body).asResponse();
  try {
