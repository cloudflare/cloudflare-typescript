  ...
  inputSchema: {
    ...
    properties: {
      ...
      session_affinity_attributes: {
        $ref: '#/$defs/session_affinity_attributes',
      },
    ...
    required: ['zone_id', 'load_balancer_id', 'default_pools', 'fallback_pool', 'name'],
    $defs: {
      default_pools: {
        type: 'string',
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.loadBalancers.update(load_balancer_id, body));
};
