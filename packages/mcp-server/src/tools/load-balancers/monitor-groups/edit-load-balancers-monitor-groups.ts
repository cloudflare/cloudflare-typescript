...
export const tool: Tool = {
  name: 'edit_load_balancers_monitor_groups',
  description:
  ...
  inputSchema: {
    ...
    properties: {
      ...
      members: {
        ...
        items: {
          ...
          required: ['enabled', 'monitor_id', 'monitoring_only', 'must_be_healthy'],
        },
      },
      jq_filter: {
        type: 'string',
    ...
    required: ['account_id', 'monitor_group_id', 'id', 'description', 'members'],
  },
  annotations: {},
};
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.loadBalancers.monitorGroups.edit(monitor_group_id, body)),
  );
};
