...
export const tool: Tool = {
  name: 'create_load_balancers_monitor_groups',
  description:
  ...
  inputSchema: {
    ...
    required: ['account_id', 'id', 'description', 'members'],
  },
  annotations: {},
};
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.loadBalancers.monitorGroups.create(body)),
  );
};
