...
export const tool: Tool = {
  name: 'update_load_balancers_pools',
  ...
  inputSchema: {
    ...
    required: ['account_id', 'pool_id', 'name', 'origins'],
    $defs: {
      origin: {
        type: 'object',
        properties: {
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.loadBalancers.pools.update(pool_id, body));
};
