...
export const tool: Tool = {
  name: 'get_directory_connectivity_services',
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nGet connectivity service\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/service_get_response',\n  $defs: {\n    service_get_response: {\n      type: 'object',\n      properties: {\n        host: {\n          anyOf: [            {\n              type: 'object',\n              properties: {\n                ipv4: {\n                  type: 'string'\n                },\n                network: {\n                  type: 'object',\n                  properties: {\n                    tunnel_id: {\n                      type: 'string'\n                    }\n                  },\n                  required: [                    'tunnel_id'\n                  ]\n                }\n              },\n              required: [                'ipv4',\n                'network'\n              ]\n            },\n            {\n              type: 'object',\n              properties: {\n                ipv6: {\n                  type: 'string'\n                },\n                network: {\n                  type: 'object',\n                  properties: {\n                    tunnel_id: {\n                      type: 'string'\n                    }\n                  },\n                  required: [                    'tunnel_id'\n                  ]\n                }\n              },\n              required: [                'ipv6',\n                'network'\n              ]\n            },\n            {\n              type: 'object',\n              properties: {\n                ipv4: {\n                  type: 'string'\n                },\n                ipv6: {\n                  type: 'string'\n                },\n                network: {\n                  type: 'object',\n                  properties: {\n                    tunnel_id: {\n                      type: 'string'\n                    }\n                  },\n                  required: [                    'tunnel_id'\n                  ]\n                }\n              },\n              required: [                'ipv4',\n                'ipv6',\n                'network'\n              ]\n            },\n            {\n              type: 'object',\n              properties: {\n                hostname: {\n                  type: 'string'\n                },\n                resolver_network: {\n                  type: 'object',\n                  properties: {\n                    tunnel_id: {\n                      type: 'string'\n                    },\n                    resolver_ips: {\n                      type: 'array',\n                      items: {\n                        type: 'string'\n                      }\n                    }\n                  },\n                  required: [                    'tunnel_id'\n                  ]\n                }\n              },\n              required: [                'hostname',\n                'resolver_network'\n              ]\n            }\n          ]\n        },\n        name: {\n          type: 'string'\n        },\n        type: {\n          type: 'string',\n          enum: [            'http'\n          ]\n        },\n        created_at: {\n          type: 'string',\n          format: 'date-time'\n        },\n        http_port: {\n          type: 'integer'\n        },\n        https_port: {\n          type: 'integer'\n        },\n        service_id: {\n          type: 'string'\n        },\n        updated_at: {\n          type: 'string',\n          format: 'date-time'\n        }\n      },\n      required: [        'host',\n        'name',\n        'type'\n      ]\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      account_id: {
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.connectivity.directory.services.get(service_id, body)),
    );
  } catch (error) {
