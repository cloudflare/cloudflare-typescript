...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'patch',
  httpPath: '/zones/{zone_id}/smart_shield',
  operationId: 'smart-shield-patch-settings',
};

export const tool: Tool = {
  name: 'update_smart_shield',
  description:
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.smartShield.update(body)));
};
