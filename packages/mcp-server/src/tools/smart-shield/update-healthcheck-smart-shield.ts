...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/zones/{zone_id}/smart_shield/healthchecks/{healthcheck_id}',
  operationId: 'smart-shield-update-health-check',
};

export const tool: Tool = {
  name: 'update_healthcheck_smart_shield',
  ...
  inputSchema: {
      ...
      result: {
        ...
        properties: {
          ...
          status: {
            ...
            enum: ['unknown', 'healthy', 'unhealthy', 'suspended'],
          },
          suspended: {
            type: 'boolean',
    ...
    required: ['zone_id', 'healthcheck_id', 'errors', 'messages', 'result', 'success'],
    $defs: {
      response_info: {
        type: 'object',
        properties: {
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.smartShield.updateHealthcheck(healthcheck_id, body));
};
