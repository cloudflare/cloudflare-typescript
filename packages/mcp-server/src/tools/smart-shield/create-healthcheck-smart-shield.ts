...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/zones/{zone_id}/smart_shield/healthchecks',
  operationId: 'smart-shield-create-health-check',
};

export const tool: Tool = {
  name: 'create_healthcheck_smart_shield',
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.smartShield.createHealthcheck(body));
};
