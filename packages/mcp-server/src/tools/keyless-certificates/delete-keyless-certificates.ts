...
export const tool: Tool = {
  name: 'delete_keyless_certificates',
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nDelete Keyless SSL Configuration\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/keyless_certificate_delete_response',\n  $defs: {\n    keyless_certificate_delete_response: {\n      type: 'object',\n      properties: {\n        id: {\n          type: 'string',\n          description: 'Identifier.'\n        }\n      }\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      zone_id: {
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.keylessCertificates.delete(keyless_certificate_id, body)),
    );
  } catch (error) {
