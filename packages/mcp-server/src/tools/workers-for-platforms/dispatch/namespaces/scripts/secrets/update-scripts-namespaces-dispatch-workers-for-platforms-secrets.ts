    ...
    anyOf: [
      {
        ...
        required: ['account_id', 'dispatch_namespace', 'script_name', 'name', 'text', 'type'],
      },
      {
        type: 'object',
        properties: {
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(
      args,
      await client.workersForPlatforms.dispatch.namespaces.scripts.secrets.update(script_name, body),
    ),
  );
};
