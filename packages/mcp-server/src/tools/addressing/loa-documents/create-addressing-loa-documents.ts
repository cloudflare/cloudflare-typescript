...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['account_id', 'loa_document'],
  },
  annotations: {},
};
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.addressing.loaDocuments.create(body)),
    );
  } catch (error) {
