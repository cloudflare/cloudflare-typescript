...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['zone_id', 'account_id', 'address_map_id', 'body'],
  },
  annotations: {
    idempotentHint: true,
  },
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.addressing.addressMaps.zones.update(address_map_id, body)),
    );
  } catch (error) {
