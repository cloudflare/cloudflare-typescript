...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['account_id', 'priority_id', 'labels', 'priority', 'requirement', 'tlp'],
    $defs: {
      label: {
        type: 'string',
      },
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.cloudforceOne.requests.priority.update(priority_id, body)),
  );
};
