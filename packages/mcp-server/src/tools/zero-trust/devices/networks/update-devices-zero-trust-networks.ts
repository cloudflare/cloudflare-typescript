...
export const tool: Tool = {
  name: 'update_devices_zero_trust_networks',
  description:
  ...
  inputSchema: {
    ...
    required: ['account_id', 'network_id'],
  },
  annotations: {
    idempotentHint: true,
  },
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.zeroTrust.devices.networks.update(network_id, body)),
  );
};
