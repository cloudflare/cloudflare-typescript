...
export const tool: Tool = {
  name: 'update_custom_policies_devices_zero_trust_includes',
  description:
  ...
  inputSchema: {
    ...
    required: ['account_id', 'policy_id', 'body'],
    $defs: {
      split_tunnel_include: {
        anyOf: [
          {
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.zeroTrust.devices.policies.custom.includes
