...
export const tool: Tool = {
  name: 'update_default_policies_devices_zero_trust_excludes',
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.zeroTrust.devices.policies.default.excludes.update(body));
};
