...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.zeroTrust.access.users.activeSessions.list(user_id, body).asResponse();
  try {
