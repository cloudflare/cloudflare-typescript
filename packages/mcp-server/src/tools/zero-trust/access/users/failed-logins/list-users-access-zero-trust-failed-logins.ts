...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.zeroTrust.access.users.failedLogins.list(user_id, body).asResponse();
  try {
