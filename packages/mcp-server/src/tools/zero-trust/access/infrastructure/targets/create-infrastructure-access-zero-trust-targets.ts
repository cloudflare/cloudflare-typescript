...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['account_id', 'hostname', 'ip'],
  },
  annotations: {},
};
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.zeroTrust.access.infrastructure.targets.create(body)),
    );
  } catch (error) {
