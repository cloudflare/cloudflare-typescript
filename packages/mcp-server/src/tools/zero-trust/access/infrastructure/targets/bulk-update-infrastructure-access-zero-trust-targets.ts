...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.zeroTrust.access.infrastructure.targets.bulkUpdate(body).asResponse();
  try {
