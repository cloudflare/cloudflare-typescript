...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['account_id', 'service_token_id'],
  },
  annotations: {},
};
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(
        jq_filter,
        await client.zeroTrust.access.serviceTokens.rotate(service_token_id, body),
      ),
    );
  } catch (error) {
