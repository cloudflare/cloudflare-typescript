...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['account_id', 'enabled', 'name', 'pattern', 'profile_id'],
    $defs: {
      pattern: {
        type: 'object',
        properties: {
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(args, await client.zeroTrust.dlp.entries.custom.create(body)));
};
