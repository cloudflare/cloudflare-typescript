...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['account_id', 'test_id', 'from', 'to'],
  },
  annotations: {
    readOnlyHint: true,
  },
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.zeroTrust.dex.httpTests.percentiles.get(test_id, body)),
  );
};
