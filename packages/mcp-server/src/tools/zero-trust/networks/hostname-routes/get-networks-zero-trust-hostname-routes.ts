...
export const tool: Tool = {
  name: 'get_networks_zero_trust_hostname_routes',
  description:
  ...
  inputSchema: {
    ...
    required: ['account_id', 'hostname_route_id'],
  },
  annotations: {
    readOnlyHint: true,
  },
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  const { hostname_route_id, jq_filter, ...body } = args as any;
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.zeroTrust.networks.hostnameRoutes.get(hostname_route_id, body)),
  );
};
