...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['account_id', 'clippedFromVideoUID', 'endTimeSeconds', 'startTimeSeconds'],
    $defs: {
      allowed_origins: {
        type: 'string',
      },
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.stream.clip.create(body)));
};
