...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['account_id', 'account', 'interconnect', 'magic'],
  },
  annotations: {},
};
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.networkInterconnects.cnis.create(body)),
    );
  } catch (error) {
