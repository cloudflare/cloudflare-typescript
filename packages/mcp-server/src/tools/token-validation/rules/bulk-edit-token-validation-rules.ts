...
export const tool: Tool = {
  name: 'bulk_edit_token_validation_rules',
  description:
      ...
      body: {
        ...
        items: {
          ...
          properties: {
            id: {
              type: 'string',
              description: 'Rule ID this patch applies to',
            },
            action: {
              type: 'string',
              description:
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.tokenValidation.rules.bulkEdit(body).asResponse();
