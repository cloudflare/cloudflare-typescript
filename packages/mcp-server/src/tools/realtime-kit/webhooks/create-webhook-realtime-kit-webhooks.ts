...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['account_id', 'app_id', 'events', 'name', 'url'],
  },
  annotations: {},
};
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.realtimeKit.webhooks.createWebhook(app_id, body)),
    );
  } catch (error) {
