...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['account_id', 'app_id', 'webhook_id', 'events', 'name', 'url'],
  },
  annotations: {
    idempotentHint: true,
  },
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.realtimeKit.webhooks.replaceWebhook(webhook_id, body)),
    );
  } catch (error) {
