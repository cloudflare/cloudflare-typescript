...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['account_id', 'app_id', 'recording_id'],
  },
  annotations: {
    readOnlyHint: true,
  },
...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.realtimeKit.recordings.getOneRecording(recording_id, body)),
    );
  } catch (error) {
