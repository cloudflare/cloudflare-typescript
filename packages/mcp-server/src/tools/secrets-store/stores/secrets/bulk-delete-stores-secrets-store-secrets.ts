...
export const handler = async (client: Cloudflare, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.secretsStore.stores.secrets.bulkDelete(store_id, body).asResponse();
  try {
