...
> [!NOTE]
> Once this package is [published to npm](https://app.stainlessapi.com/docs/guides/publish), this will become: `npm install cloudflare`
...
Note that if given a `CLOUDFLARE_LOG=debug` environment variable, this library will log all requests and responses automatically.
