...
```sh
npm install git+ssh://git@gitlab.cfdata.org:cloudflare/sdks/cloudflare-typescript.git
```
...
We are keen for your feedback; please open an [issue](https://www.gitlab.cfdata.org/cloudflare/sdks/cloudflare-typescript/issues) with questions, bugs, or suggestions.
